...
FPT Storage 
  ...
  * [ ![](/img/migrated/settings-d31fa71f.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/documents/end-user-request-resource/?doc=initial-setup "Initial Setup")
  * [ ![](/img/migrated/icon-networking-2645685c.png) Hướng dẫn nhanh (Quick Starts) ](javascript: "Hướng dẫn nhanh \(Quick Starts\)")
    * [ Tạo một yêu cầu cung cấp tài nguyên ](https://fptcloud.com/documents/end-user-request-resource/?doc=create-request-resource "Tạo một yêu cầu cung cấp tài nguyên")
    * [ Xem các yêu cầu đã tạo ](https://fptcloud.com/documents/end-user-request-resource/?doc=view-request-resource "Xem các yêu cầu đã tạo")
  * [ ![](/img/migrated/suggestion-b956384e.png) Các câu hỏi thường gặp (FAQs) ](javascript: "Các câu hỏi thường gặp \(FAQs\)")
    * [ Tôi có thể tạo nhiều yêu cầu cùng 1 lúc được không? ](https://fptcloud.com/documents/end-user-request-resource/?doc=fqas-1 "Tôi có thể tạo nhiều yêu cầu cùng 1 lúc được không?")
    * [ Làm thế nào để biết FCI đã nhận được yêu cầu của tôi? ](https://fptcloud.com/documents/end-user-request-resource/?doc=fqas-2 "Làm thế nào để biết FCI đã nhận được yêu cầu của tôi?")
    * [ Tôi có thể lựa chọn VPC hoặc tạo mới VPC khi yêu cầu dịch vụ không? ](https://fptcloud.com/documents/end-user-request-resource/?doc=fqas-3 "Tôi có thể lựa chọn VPC hoặc tạo mới VPC khi yêu cầu dịch vụ không?")
    * [ Vì sao tôi không tìm thấy phần Request Resource ở thành menu? ](https://fptcloud.com/documents/end-user-request-resource/?doc=fqas-4 "Vì sao tôi không tìm thấy phần Request Resource ở thành menu?")
    * [ Vì sao tôi không thể chọn submit để gửi ticket? ](https://fptcloud.com/documents/end-user-request-resource/?doc=fqas-5 "Vì sao tôi không thể chọn submit để gửi ticket?")
