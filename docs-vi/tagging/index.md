...
FPT Storage 
  ...
  * [ ![](/img/migrated/settings-131ed42a.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/documents/tagging/?doc=initial-setup "Initial Setup")
  * [ ![](/img/migrated/icon-networking-1-2d28802b.png) Hướng dẫn nhanh (Quick Starts) ](javascript: "Hướng dẫn nhanh \(Quick Starts\)")
    * [ Khởi tạo một tag mới ](https://fptcloud.com/documents/tagging/?doc=create-tag-new "Khởi tạo một tag mới ")
    * [ Chỉnh sửa tag ](https://fptcloud.com/documents/tagging/?doc=edit-tag "Chỉnh sửa tag")
    * [ Xóa tag đã tạo ](https://fptcloud.com/documents/tagging/?doc=delete-tag "Xóa tag đã tạo")
  * [ ![](/img/migrated/icon-networking-1-2d28802b.png) Hướng dẫn chi tiết (Tutorials) ](javascript: "Hướng dẫn chi tiết \(Tutorials\)")
    * [ Manage tag to Resource ](https://fptcloud.com/documents/tagging/?doc=resource-1 "Manage tag to Resource ")
      * [ Manage tag to Instance Management ](https://fptcloud.com/documents/tagging/?doc=tags-instance "Manage tag to Instance Management")
      * [ Manage tag to Storage disk ](https://fptcloud.com/documents/tagging/?doc=tags-storage-disk "Manage tag to Storage disk")
      * [ Manage tag to Snapshot ](https://fptcloud.com/documents/tagging/?doc=tags-snapshot "Manage tag to Snapshot")
      * [ Manage tag to Custom image ](https://fptcloud.com/documents/tagging/?doc=tags-custom-image "Manage tag to Custom image")
      * [ Manage tag to Floating IP ](https://fptcloud.com/documents/tagging/?doc=tags-floating-ip "Manage tag to Floating IP")
      * [ Manage tag to Subnet ](https://fptcloud.com/documents/tagging/?doc=tags-subnet "Manage tag to Subnet")
      * [ Manage tag to Security group ](https://fptcloud.com/documents/tagging/?doc=tags-security-group "Manage tag to Security group")
      * [ Manage tag to classic load balancer ](https://fptcloud.com/documents/tagging/?doc=tagg-lb "Manage tag to classic load balancer")
    * [ Tagging Billing ](https://fptcloud.com/documents/tagging/?doc=tagging-billing "Tagging Billing")
