...
FPT Storage 
  ...
  * [ ![](/img/migrated/settings-800de3d1.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/documents/iam/?doc=Initial%20Setup "Initial Setup")
  * [ ![](/img/migrated/icon-networking-f57b0b33.png) Hướng dẫn chi tiết (Tutorials) ](javascript: "Hướng dẫn chi tiết \(Tutorials\)")
    * [ Quản lý Role ](https://fptcloud.com/documents/iam/?doc=role-management "Quản lý Role")
      * [ Role Overview ](https://fptcloud.com/documents/iam/?doc=Role-Overview "Role Overview")
      * [ Xem danh sách role ](https://fptcloud.com/documents/iam/?doc=xem%20danh%20sach%20role "Xem danh sách role")
      * [ Khởi tạo role và phân quyền cho role ](https://fptcloud.com/documents/iam/?doc=khoi%20tao%20role%20va%20phan%20quyen%20cho%20role "Khởi tạo role và phân quyền cho role")
      * [ Xem chi tiết Role ](https://fptcloud.com/documents/iam/?doc=xem%20chi%20tiet%20role "Xem chi tiết Role")
      * [ Chỉnh sửa role và permission ](https://fptcloud.com/documents/iam/?doc=chinh%20sua%20role%20va%20permission "Chỉnh sửa role và permission")
      * [ Xóa role ](https://fptcloud.com/documents/iam/?doc=xoa%20role "Xóa role")
    * [ Quản lý User Group ](https://fptcloud.com/documents/iam/?doc=user-group-management "Quản lý User Group")
      * [ User Group - Overview ](https://fptcloud.com/documents/iam/?doc=User%20Group-Overview "User Group - Overview")
      * [ Khởi tạo User Group mới ](https://fptcloud.com/documents/iam/?doc=khoi%20tao%20user%20group%20moi "Khởi tạo User Group mới")
      * [ Xem danh sách User Group ](https://fptcloud.com/documents/iam/?doc=xem%20danh%20sach%20user%20group "Xem danh sách User Group")
      * [ Xem chi tiết User Group ](https://fptcloud.com/documents/iam/?doc=xem%20chi%20tiet%20user%20group "Xem chi tiết User Group")
      * [ Chỉnh sửa User Group ](https://fptcloud.com/documents/iam/?doc=chinh%20sua%20user%20group "Chỉnh sửa User Group")
      * [ Xóa User Groups ](https://fptcloud.com/documents/iam/?doc=xoa%20user%20groups "Xóa User Groups")
    * [ Quản lý IAM User ](https://fptcloud.com/documents/iam/?doc=iam-user-management "Quản lý IAM User")
      * [ IAM User - Overview ](https://fptcloud.com/documents/iam/?doc=IAM-User-Overview "IAM User - Overview")
      * [ Invite IAM user mới ](https://fptcloud.com/documents/iam/?doc=invite%20iam%20user%20moi "Invite IAM user mới")
      * [ Khởi tạo account và truy cập vào VPC đã được mời ](https://fptcloud.com/documents/iam/?doc=khoi%20tao%20account%20va%20truy%20cap%20vao%20vpc%20da%20duoc%20moi "Khởi tạo account và truy cập vào VPC đã được mời")
      * [ Thay đổi mật khẩu ](https://fptcloud.com/documents/iam/?doc=thay%20doi%20mat%20khau "Thay đổi mật khẩu")
      * [ Cấu hình 2FA ](https://fptcloud.com/documents/iam/?doc=cau%20hinh%202fa "Cấu hình 2FA")
    * [ IP Access ](https://fptcloud.com/documents/iam/?doc=ip-access "IP Access")
      * [ IP Access Overview ](https://fptcloud.com/documents/iam/?doc=ip-access-overview "IP Access Overview")
      * [ Khởi tạo một record IP access mới ](https://fptcloud.com/documents/iam/?doc=create-ip- "Khởi tạo một record IP access mới")
      * [ Xóa record IP access ](https://fptcloud.com/documents/iam/?doc=delete-ip-access "Xóa record IP access")
      * [ Kiểm tra Activity logs ](https://fptcloud.com/documents/iam/?doc=activity-log-ip-access "Kiểm tra Activity logs")
      * [ Tải danh sách lịch sử truy cập ](https://fptcloud.com/documents/iam/?doc=download-access-log "Tải danh sách lịch sử truy cập")
...
* * *
[ Previous Xóa User Groups ](https://fptcloud.com/documents/iam/?doc=xoa%20user%20groups "Xóa User Groups") [ Next IAM User - Overview ](https://fptcloud.com/documents/iam/?doc=IAM-User-Overview "IAM User - Overview")
