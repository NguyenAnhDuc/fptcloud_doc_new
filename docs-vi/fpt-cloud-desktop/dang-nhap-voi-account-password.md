...
Đăng nhập với Account/Password
  * 
  * [ ](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ffptcloud.com%2Fdocuments%2Ffpt-cloud-desktop%2F "FPT Cloud Desktop")
...
* * *
[ Previous Truy cập qua FCDClient cũ (luồng cũ) ](https://fptcloud.com/documents/fpt-cloud-desktop/?doc=SSO-qua-FCDClient-cu "Truy cập qua FCDClient cũ \(luồng cũ\)") [ Next Truy cập qua FCDClient mới ](https://fptcloud.com/documents/fpt-cloud-desktop/?doc=accountpassword-qua-FCDClient-moi "Truy cập qua FCDClient mới")
