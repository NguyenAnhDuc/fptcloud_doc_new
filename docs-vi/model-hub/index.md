...
FPT Storage 
  ...
  * [ ![](/img/migrated/icon-networking-2-09c1ef04.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/documents/model-hub/?doc=initial-setup "Initial Setup")
  * [ ![](/img/migrated/settings-3-341b24da.png) Hướng dẫn chi tiết (Tutorials) ](javascript: "Hướng dẫn chi tiết \(Tutorials\)")
    * [ Đăng nhập vào trang Portal ](https://fptcloud.com/documents/model-hub/?doc=dang-nhap "Đăng nhập vào trang Portal")
    * [ Danh sách model ](https://fptcloud.com/documents/model-hub/?doc=danh-sach-model "Danh sách model")
    * [ Chi tiết model ](https://fptcloud.com/documents/model-hub/?doc=chi-tiet-model "Chi tiết model")
    * [ Tạo model ](https://fptcloud.com/documents/model-hub/?doc=tao-model "Tạo model")
    * [ Sửa model ](https://fptcloud.com/documents/model-hub/?doc=sua-model "Sửa model")
    * [ Xóa model ](https://fptcloud.com/documents/model-hub/?doc=xoa-model "Xóa model")
    * [ Tạo version ](https://fptcloud.com/documents/model-hub/?doc=tao-verison "Tạo version")
    * [ Update version (v1.1) ](https://fptcloud.com/documents/model-hub/?doc=update-version "Update version \(v1.1\)")
    * [ Delete version ](https://fptcloud.com/documents/model-hub/?doc=delete-version "Delete version")
    * [ Upload file / Download file ](https://fptcloud.com/documents/model-hub/ "Upload file / Download file")
      * [ Upload file ](https://fptcloud.com/documents/model-hub/?doc=upload-file "Upload file")
      * [ Download file ](https://fptcloud.com/documents/model-hub/?doc=download-file "Download file")
    * [ Delete file ](https://fptcloud.com/documents/model-hub/?doc=delete-file "Delete file")
    * [ Add share ](https://fptcloud.com/documents/model-hub/?doc=add-share "Add share")
    * [ Share detail ](https://fptcloud.com/documents/model-hub/ "Share detail")
      * [ Share detail (invited) ](https://fptcloud.com/documents/model-hub/?doc=share-detail-invited "Share detail \(invited\)")
      * [ Share detail (joined) ](https://fptcloud.com/documents/model-hub/?doc=share-detail-joined "Share detail \(joined\)")
    * [ Update share ](https://fptcloud.com/documents/model-hub/?doc=update-share "Update share")
    * [ Delete share ](https://fptcloud.com/documents/model-hub/?doc=delete-share "Delete share")
    * [ Clone model (v1.1) ](https://fptcloud.com/documents/model-hub/?doc=clone-model "Clone model \(v1.1\)")
    * [ Base model (v1.1) ](https://fptcloud.com/documents/model-hub/?doc=base-model "Base model \(v1.1\)")
    * [ Create organization (v1.1) ](https://fptcloud.com/documents/model-hub/?doc=create-organization "Create organization \(v1.1\)")
    * [ View/Update organization (v1.1) ](https://fptcloud.com/documents/model-hub/?doc=view-update-organization "View/Update organization \(v1.1\)")
    * [ Model deployment (v1.1) ](https://fptcloud.com/documents/model-hub/?doc=model-deployment "Model deployment \(v1.1\)")
    * [ Model catalog (v1.1) ](https://fptcloud.com/documents/model-hub/?doc=model-catalog "Model catalog \(v1.1\)")
      * [ Danh sách Model catalog ](https://fptcloud.com/documents/model-hub/?doc=danh-sach-model-catalog "Danh sách Model catalog")
      * [ Chi tiết Model catalog ](https://fptcloud.com/documents/model-hub/?doc=chi-tiet-model-catalog "Chi tiết Model catalog")
