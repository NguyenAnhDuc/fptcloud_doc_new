...
description: "Hướng dẫn áp dụng Policy Management trên FPT Cloud với kịch bản chặn người dùng khởi tạo rule SSH."
...
**Kịch bản:** Chặn người dùng khởi tạo rule SSH với source IP bằng All IPv4 (Any).
