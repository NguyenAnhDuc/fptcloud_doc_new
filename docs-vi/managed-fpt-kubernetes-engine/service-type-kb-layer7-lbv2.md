...
title: "Sử dụng service type Loadbalancer Layer 7 (LBv2)"
description: "FPT Cloud cung cấp cho khách hàng giải pháp sử dụng Loadbalancer Layer 7 với việc sử dụng Cert SSL của khách hàng tự cun"
