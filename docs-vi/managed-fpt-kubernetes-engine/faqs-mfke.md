...
Có nhiều cách để expose ứng dụng ra ngoài cluster cho khách hàng sử dụng. Một cách đơn giản là sử dụng [Load Balancer Services](/docs/vi/fpt-container/managed-fpt-kubernetes-engine/)/ theo hướng dẫn.
