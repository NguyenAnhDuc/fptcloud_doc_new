...
description: "Để bắt đầu sử dụng dịch vụ của **FPT Monitoring** bạn cần đăng nhập vào **FPT Portal.**"
...
Để bắt đầu sử dụng dịch vụ của **FPT Monitoring** bạn cần đăng nhập vào **FPT Portal.**
