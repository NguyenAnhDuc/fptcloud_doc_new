...
FPT Storage 
  ...
  * [ ![](/img/migrated/favicon-fptcloud-e949f73f.png) Hướng dẫn chi tiết ](javascript: "Hướng dẫn chi tiết")
    * [ Truy cập giao diện quản trị ](https://fptcloud.com/documents/trellix-customer-guide/?doc=truy-cap-giao-dien-quan-tri "Truy cập giao diện quản trị")
    * [ Tạo gói cài đặt Agent, cài đặt Agert ](https://fptcloud.com/documents/trellix-customer-guide/?doc=setting-agert "Tạo gói cài đặt Agent, cài đặt Agert")
    * [ Quản lý các tác vụ chạy trên máy chủ (Client Tasks) ](https://fptcloud.com/documents/trellix-customer-guide/?doc=client-task "Quản lý các tác vụ chạy trên máy chủ \(Client Tasks\)")
    * [ Báo cáo (Report) ](https://fptcloud.com/documents/trellix-customer-guide/?doc=report "Báo cáo \(Report\)")
    * [ Xem nhật ký (Log) ](https://fptcloud.com/documents/trellix-customer-guide/?doc=view-log "Xem nhật ký \(Log\)")
