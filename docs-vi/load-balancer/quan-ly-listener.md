...
* * *
[ Previous Tích hợp Metric/Access logs Load Balancer với FPT Monitoring (FMON) ](https://fptcloud.com/documents/load-balancer/?doc=tich-hop-fmon "Tích hợp Metric/Access logs Load Balancer với FPT Monitoring \(FMON\)") [ Next Khởi tạo Listener ](https://fptcloud.com/documents/load-balancer/?doc=khoi-tao-listener "Khởi tạo Listener")
