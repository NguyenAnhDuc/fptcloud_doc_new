...
description: "Bucket ACL là một cơ chế quản lý quyền truy cập cho các bucket. Cho phép bạn kiểm soát ai có quyền xem, viết, hoặc quản "
sidebar_label: "Cấu hình Bucket Policy"
sidebar_position: 6
---
