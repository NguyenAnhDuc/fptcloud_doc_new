...
FPT Storage 
  ...
  * [ ![](/img/migrated/settings-800de3d1.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/documents/object-storage/?doc=initial-setup "Initial Setup")
  * [ ![](/img/migrated/icon-networking-f57b0b33.png) Hướng dẫn chi tiết (Tutorials) ](javascript: "Hướng dẫn chi tiết \(Tutorials\)")
    * [ Sử dụng Object Storage trên FPT Portal ](https://fptcloud.com/documents/object-storage/?doc=tutorials-su-dung-object-storage-tren-fpt-portal "Sử dụng Object Storage trên FPT Portal")
      * [ Bucket ](https://fptcloud.com/documents/object-storage/?doc=tutorials-bucket "Bucket")
      * [ Object ](https://fptcloud.com/documents/object-storage/?doc=tutorials-object "Object")
      * [ Permissions ](https://fptcloud.com/documents/object-storage/?doc=tutorials-permissions "Permissions")
      * [ Bucket Config ](https://fptcloud.com/documents/object-storage/?doc=tutorials-bucket-config "Bucket Config")
      * [ Encryption ](https://fptcloud.com/documents/object-storage/?doc=tutorials-encryption "Encryption")
    * [ Quản lý Access Key ](https://fptcloud.com/documents/object-storage/?doc=tutorials-quan-ly-access-key-cua-object-storage-tren-fpt-portal "Quản lý Access Key")
    * [ Quản lý SubUser ](https://fptcloud.com/documents/object-storage/?doc=tutorials-quan-ly-subuser "Quản lý SubUser")
    * [ Sử dụng Object Storage trên S3 Browser ](https://fptcloud.com/documents/object-storage/?doc=tutorials-su-dung-object-storage-tren-s3-client "Sử dụng Object Storage trên S3 Browser")
    * [ Tích hợp FPT Object Storage với các S3-Client ](https://fptcloud.com/documents/object-storage/?doc=tutorials-tich-hop-fpt-object-storage-voi-cac-s3-client "Tích hợp FPT Object Storage với các S3-Client")
    * [ SDK API Reference ](https://fptcloud.com/documents/object-storage/?doc=SDK-API-Reference "SDK API Reference")
    * [ Migrate bucket data ](https://fptcloud.com/documents/object-storage/?doc=migrate-bucket-data "Migrate bucket data")
  ...
  * [ ![](/img/migrated/suggestion-74a9dc8f.png) Một số gợi ý mẫu (Samples) ](javascript: "Một số gợi ý mẫu \(Samples\)")
    * [ Sử dụng FPT Object Storage làm media server ](https://fptcloud.com/documents/object-storage/?doc=su-dung-fpt-object-storage-lam-media-server-luu-tru-va-phan-phoi-media-file-cho-websiteweb-application "Sử dụng FPT Object Storage làm media server")
    * [ Xây dựng một website tĩnh bằng FPT Object Storage ](https://fptcloud.com/documents/object-storage/?doc=xay-dung-mot-website-tinh-bang-fpt-object-storage "Xây dựng một website tĩnh bằng FPT Object Storage")
    * [ Mount bucket thành ổ đĩa trên máy local ](https://fptcloud.com/documents/object-storage/?doc=mount-bucket-thanh-o-dia-tren-may-local "Mount bucket thành ổ đĩa trên máy local")
    * [ Clone dữ liệu giữa hai bucket khác nhau ](https://fptcloud.com/documents/object-storage/?doc=clone-du-lieu-giua-hai-bucket-khac-nhau "Clone dữ liệu giữa hai bucket khác nhau")
    * [ Phân quyền sử dụng bucket cho các subuser ](https://fptcloud.com/documents/object-storage/?doc=phan-quyen-su-dung-bucket-cho-cac-subuser "Phân quyền sử dụng bucket cho các subuser")
  * Release note
    * [Object Storage version 2.6...](https://fptcloud.com#release_notes_0 "Object Storage version 2.6...")
    * [Object Storage version 2.5...](https://fptcloud.com#release_notes_1 "Object Storage version 2.5...")
...
Sử dụng Object Storage trên FPT Portal
  * 
  * [ ](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ffptcloud.com%2Fdocuments%2Fobject-storage%2F "FPT Object Storage")
  * [ ](https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ffptcloud.com%2Fdocuments%2Fobject-storage%2F "FPT Object Storage")
  * [ ](https://twitter.com/share?text=&url=https%3A%2F%2Ffptcloud.com%2Fdocuments%2Fobject-storage%2F "FPT Object Storage")

* * *
[ Next Bucket ](https://fptcloud.com/documents/object-storage/?doc=tutorials-bucket "Bucket")
