...
FPT Storage 
  ...
  * [ ![](/img/migrated/settings-131ed42a.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/documents/allow-address-pair/?doc=initial-setup "Initial Setup")
  * [ ![](/img/migrated/icon-networking-1-2d28802b.png) Hướng dẫn nhanh (Quick Starts) ](javascript: "Hướng dẫn nhanh \(Quick Starts\)")
    * [ Khởi tạo Address pair ](https://fptcloud.com/documents/allow-address-pair/?doc=create-address-pair "Khởi tạo Address pair")
    * [ Khởi tạo Address pair trong quản lý Instance ](https://fptcloud.com/documents/allow-address-pair/?doc=create-address-pair-on-instance-management "Khởi tạo Address pair trong quản lý Instance")
    * [ Xóa Address pair ](https://fptcloud.com/documents/allow-address-pair/?doc=delete-address-pair "Xóa Address pair")
    * [ Kiểm tra hoạt động - Activity Logs ](https://fptcloud.com/documents/allow-address-pair/?doc=activity-log "Kiểm tra hoạt động  - Activity Logs")
  * [ ![](/img/migrated/question-94737ec1.png) FAQs ](javascript: "FAQs")
    * [ Tôi có thể hiệu chỉnh các address pair đã khởi tạo không? ](https://fptcloud.com/documents/allow-address-pair/?doc=question-1 "Tôi có thể hiệu chỉnh các address pair đã khởi tạo không?")
