...
Để bắt đầu sử dụng dịch vụ FPT Cloud, bạn cần đăng nhập vào FPT Portal. Hãy truy cập [https://console.fptcloud.com](https://console.fptcloud.com/) và đăng nhập bằng tài khoản/mật khẩu FPT Cloud đã được cấp. Chọn đúng Tenant, Region, VPC cần sử dụng dịch vụ.
