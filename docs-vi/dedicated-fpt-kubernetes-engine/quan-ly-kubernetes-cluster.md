...
FPT Storage 
  ...
  * [ ![](/img/migrated/settings-800de3d1.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=Initial-Setup "Initial Setup")
  * [ ![](/img/migrated/icon-networking-f57b0b33.png) Hướng dẫn chi tiết (Tutorials) ](javascript: "Hướng dẫn chi tiết \(Tutorials\)")
    * [ Quản lý Kubernetes cluster ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=quan-ly-kubernetes-cluster "Quản lý Kubernetes cluster")
      * [ Khởi tạo Kubernetes Cluster mới ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=khoi-tao-kubernetes-cluster-moi "Khởi tạo Kubernetes Cluster mới")
      * [ Xem danh sách Kubernetes Cluster đã tạo ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=xem-danh-sach-kubernetes-cluster-da-tao "Xem danh sách Kubernetes Cluster đã tạo")
      * [ Truy cập thông tin chi tiết của Cluster ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=truy-cap-thong-tin-chi-tiet-cua-cluster "Truy cập thông tin chi tiết của Cluster")
      * [ Lấy thông tin truy cập Cluster ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=lay-thong-tin-truy-cap-cluster "Lấy thông tin truy cập Cluster")
      * [ Xóa Kubernetes Cluster ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=xoa-kubernetes-cluster "Xóa Kubernetes Cluster")
      * [ Stop Kubernetes Cluster ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=stop-kubernetes-cluster "Stop Kubernetes Cluster")
      * [ Start Kubernetes Cluster ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=start-kubernetes-cluster "Start Kubernetes Cluster")
    * [ Thay đổi cấu hình K8s Cluster ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=thay-doi-cau-hinh-k8s-cluster "Thay đổi cấu hình K8s Cluster")
      * [ Scale worker nodes ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=scale-worker-nodes "Scale worker nodes")
      * [ Thay đổi Flavor (cấu hình) Nodes ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=thay-doi-flavor-cau-hinh-nodes "Thay đổi Flavor \(cấu hình\) Nodes")
      * [ Thay đổi Flavor (cấu hình) NFS Server ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=thay-doi-flavor-cau-hinh-nfs "Thay đổi Flavor \(cấu hình\) NFS Server")
      * [ Tăng Storage size của các Nodes ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=tang-storage-size-cua-nodes "Tăng Storage size của các Nodes")
      * [ Tăng Storage size của NFS Server ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=tang-storage-size-cua-nfs "Tăng Storage size của NFS Server")
      * [ Nâng cấp K8s version ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=nang-cap-k8s-version "Nâng cấp K8s version")
      * [ Thêm NFS Persistent Storage ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=them-nfs-persistent-storage "Thêm NFS Persistent Storage")
    * [ Automatic Scaling ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=AutoScale "Automatic Scaling")
    * [ Manual Scaling ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=manual-scale "Manual Scaling")
    * [ Best Practice Manual Scaling ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=best-practice-manual-scaling "Best Practice Manual Scaling")
    * [ Persistent Storage ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=persistent-storage "Persistent Storage")
    * [ Service Type Load-Balancer ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=service-type-load-balancer "Service Type Load-Balancer")
    * [ Advanced Firewall ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=dfke-advanced-firewall "Advanced Firewall")
    * [ Backup & Restore Cluster ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=backup-and-restore-cluster "Backup & Restore Cluster")
    * [ Best Practice Upgrade FKE Cluster Version ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=best-practice-upgrade-fke-cluster-version "Best Practice Upgrade FKE Cluster Version")
    * [ Auto repair nodes ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=auto-repair-nodes "Auto repair nodes")
    * [ Retry – Timeout Rule ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=retry-timeout-rule "Retry – Timeout Rule")
  * [ ![](/img/migrated/Group-749ce1fb.png) Các lưu ý khi sử dụng FKE ](javascript: "Các lưu ý khi sử dụng FKE")
    * [ Các lưu ý khi sử dụng FKE ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=cac-luu-y-khi-su-dung-fke "Các lưu ý khi sử dụng FKE")
  * [ ![](/img/migrated/question-45cd06af.png) Các câu hỏi thường gặp (FAQs) ](javascript: "Các câu hỏi thường gặp \(FAQs\)")
    * [ FAQs ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=dfke-faqs "FAQs")
  * [ ![](/img/migrated/suggestion-74a9dc8f.png) Một số gợi ý mẫu (Samples) ](javascript: "Một số gợi ý mẫu \(Samples\)")
  * Release note
    * [Những cập nhật tính nă...](https://fptcloud.com#release_notes_0 "Những cập nhật tính nă...")
    * [...](https://fptcloud.com#release_notes_1 "...")
    * [...](https://fptcloud.com#release_notes_2 "...")
    * [Thay đổi Flavor (cấu hìn...](https://fptcloud.com#release_notes_3 "Thay đổi Flavor \(cấu hìn...")
    * [Tăng Storage size của NFS S...](https://fptcloud.com#release_notes_4 "Tăng Storage size của NFS S...")
...
Quản lý Kubernetes cluster
  * 
  * [ ](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ffptcloud.com%2Fdocuments%2Fdedicated-fpt-kubernetes-engine%2F "Dedicated – FPT Kubernetes Engine")
  * [ ](https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ffptcloud.com%2Fdocuments%2Fdedicated-fpt-kubernetes-engine%2F "Dedicated – FPT Kubernetes Engine")
  * [ ](https://twitter.com/share?text=&url=https%3A%2F%2Ffptcloud.com%2Fdocuments%2Fdedicated-fpt-kubernetes-engine%2F "Dedicated – FPT Kubernetes Engine")

* * *
[ Next Khởi tạo Kubernetes Cluster mới ](https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=khoi-tao-kubernetes-cluster-moi "Khởi tạo Kubernetes Cluster mới")
