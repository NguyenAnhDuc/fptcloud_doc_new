...
description: "Hướng dẫn bật hoặc tắt quyền truy cập ẩn danh vào ArgoCD"
...
Người dùng có thể bật/tắt quyền truy cập ẩn danh vào ArgoCD qua giao diện Portal. Anonymous user có quyền mặc định `readonly`. Mặc định, ArgoCD tắt truy cập ẩn danh.

## A. Enable anonymous user

1. Tại màn hình **Essential Properties**, nhấn **Enable Anonymous User**.
...
Sau khi enable, có thể xem thông tin ArgoCD mà không cần đăng nhập:

[![](/img/migrated/Picture16-5-e4b4859f.png)](/img/migrated/Picture16-5-e4b4859f.png)

## B. Disable anonymous user

1. Tại màn hình **Essential Properties**, nhấn **Disable Anonymous User**.
...
Sau khi disable, ArgoCD yêu cầu đăng nhập trước khi xem thông tin:
