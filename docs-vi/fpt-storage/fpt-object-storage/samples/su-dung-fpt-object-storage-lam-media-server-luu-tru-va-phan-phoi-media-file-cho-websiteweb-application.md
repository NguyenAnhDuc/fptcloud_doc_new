...
**Bước 2:** Chọn Create Bucket và nhập tên Bucket cần tạo. [**Hướng dẫn thao tác trên FPT Portal.**](/docs/vi/fpt-storage/fpt-object-storage/)/  
[**Hướng dẫn thao tác trên S3 Client.**](/docs/vi/fpt-storage/fpt-object-storage/)/
