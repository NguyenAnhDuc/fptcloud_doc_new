...
Để bắt đầu, hãy xem [Quick Start](/docs/vi/fpt-ai-factory/model-testing-interactive-sessions/quick-start) hoặc làm theo hướng dẫn [Step By Step](/docs/vi/fpt-ai-factory/model-testing-interactive-sessions/step-by-step).
