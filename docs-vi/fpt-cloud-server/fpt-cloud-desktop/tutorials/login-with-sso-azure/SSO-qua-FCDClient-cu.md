...
![file](/img/migrated/docs-vi-fpt-cloud-desktop/SSO-qua-FCDClient-cu/img-001.png)
...
Nếu người dùng **truy cập bằng URL đã chứa authentication code hợp lệ** (ví dụ URL chứa code hợp lệ: pil783454741.pilotfcd.online)
  ...
  * Chỉ cần đăng nhập bằng tài khoản SSO tương ứng (ví dụ Đăng nhập bằng tài khoản Microsoft), nhập OTP tương ứng theo SSO => Đăng nhập Authenticator (Server) thành công ![file](/img/migrated/docs-vi-fpt-cloud-desktop/SSO-qua-FCDClient-cu/img-002.png)
...
![file](/img/migrated/docs-vi-fpt-cloud-desktop/SSO-qua-FCDClient-cu/img-003.png)

  * Đăng nhập bằng tài khoản SSO tương ứng (ví dụ Đăng nhập bằng tài khoản Microsoft), nhập OTP tương ứng theo SSO => Đăng nhập Authenticator (Server) thành công ![file](/img/migrated/docs-vi-fpt-cloud-desktop/SSO-qua-FCDClient-cu/img-004.png)
...
![file](/img/migrated/docs-vi-fpt-cloud-desktop/SSO-qua-FCDClient-cu/img-005.png)
...
![file](/img/migrated/docs-vi-fpt-cloud-desktop/SSO-qua-FCDClient-cu/img-006.png)

Mở ứng dụng Authenticator và thực hiện quét (scan) QR Code

![file](/img/migrated/docs-vi-fpt-cloud-desktop/SSO-qua-FCDClient-cu/img-007.png)
...
![file](/img/migrated/docs-vi-fpt-cloud-desktop/SSO-qua-FCDClient-cu/img-008.png)
