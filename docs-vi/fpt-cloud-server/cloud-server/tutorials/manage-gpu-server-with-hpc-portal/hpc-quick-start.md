...
![P3UAVy+4k08NAAAAAElFTkSuQmCC](/img/migrated/docs-vi-cloud-server/hpc-quick-start/img-001.png)

**Bước 2**: Tạo image

Truy cập Hosts > Create image để thực hiện tạo image máy GPU mới

![](/img/migrated/docs-vi-cloud-server/hpc-quick-start/img-002.png)
...
![](/img/migrated/docs-vi-cloud-server/hpc-quick-start/img-003.png)
...
![wFsj+JD2bOR9gAAAABJRU5ErkJggg==](/img/migrated/docs-vi-cloud-server/hpc-quick-start/img-004.png)
...
![Aa4Ery4edUEoAAAAAElFTkSuQmCC](/img/migrated/docs-vi-cloud-server/hpc-quick-start/img-005.png)
...
![2023 04 05 Remote window](/img/migrated/docs-vi-cloud-server/hpc-quick-start/img-006.jpg)
...
![](/img/migrated/docs-vi-cloud-server/hpc-quick-start/img-007.png)
