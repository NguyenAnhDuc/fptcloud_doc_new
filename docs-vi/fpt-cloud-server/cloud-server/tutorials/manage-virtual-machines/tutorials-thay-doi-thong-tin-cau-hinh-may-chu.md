...
![Userguide FPT Cloud Server 2022 41](/img/migrated/docs-vi-cloud-server/tutorials-thay-doi-thong-tin-cau-hinh-may-chu/img-001.png)

**Bước 2**: Chọn kích thước mới cho máy ảo, có thể chọn theo template có sẵn hoặc tự chọn cấu hình riêng ở phần **Custom**.

![Userguide FPT Cloud Server 2022 42](/img/migrated/docs-vi-cloud-server/tutorials-thay-doi-thong-tin-cau-hinh-may-chu/img-002.png)
...
![Userguide FPT Cloud Server 2022 43](/img/migrated/docs-vi-cloud-server/tutorials-thay-doi-thong-tin-cau-hinh-may-chu/img-003.png)

**Bước 2:** Nhập tên mới cho máy ảo và chọn **Rename.**

![Userguide FPT Cloud Server 2022 44](/img/migrated/docs-vi-cloud-server/tutorials-thay-doi-thong-tin-cau-hinh-may-chu/img-004.png)
...
![Userguide FPT Cloud Server 2022 45](/img/migrated/docs-vi-cloud-server/tutorials-thay-doi-thong-tin-cau-hinh-may-chu/img-005.png)
