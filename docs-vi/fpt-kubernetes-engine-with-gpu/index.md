...
FPT Storage 
  ...
  * [ ![](/img/migrated/icon-networking-2-09c1ef04.png) Hướng dẫn sử dụng ](javascript: "Hướng dẫn sử dụng")
    * [ Tổng quan dịch vụ GPU trên Kubernetes FPT Cloud ](https://fptcloud.com/documents/fpt-kubernetes-engine-with-gpu/?doc=tong-quan-dich-vu-GPU "Tổng quan dịch vụ GPU trên Kubernetes FPT Cloud ")
    * [ Cài đặt và khởi tạo Cluster Kubernetes sử dụng GPU ](https://fptcloud.com/documents/fpt-kubernetes-engine-with-gpu/?doc=cai-dat-cluster-kubernetes-su-dung-gpu "Cài đặt và khởi tạo Cluster Kubernetes sử dụng GPU")
    * [ Thay đổi Worker Group sử dụng GPU ](https://fptcloud.com/documents/fpt-kubernetes-engine-with-gpu/?doc=thay-doi-worker-group-su-sung-gpu "Thay đổi Worker Group sử dụng GPU ")
    * [ Triển khai ứng dụng sử dụng GPU trên Kubernetes ](https://fptcloud.com/documents/fpt-kubernetes-engine-with-gpu/?doc=trien-khai-ung-dung-su-dung-gpu-tren-kubernetes "Triển khai ứng dụng sử dụng GPU trên Kubernetes")
    * [ Hướng dẫn sử dụng GPU Telemetry ](https://fptcloud.com/documents/fpt-kubernetes-engine-with-gpu/?doc=huong-dan-su-dung-gpu-telemetry "Hướng dẫn sử dụng GPU Telemetry")
    * [ Hướng dẫn sử dụng Autoscaler với GPU ](https://fptcloud.com/documents/fpt-kubernetes-engine-with-gpu/?doc=huong-dan-su-dung-autoscaler-voi-gpu "Hướng dẫn sử dụng Autoscaler với GPU")
    * [ Hướng dẫn sử dụng các chế độ GPU sharing ](https://fptcloud.com/documents/fpt-kubernetes-engine-with-gpu/?doc=huong-dan-su-dung-cac-che-do-gpu-sharing "Hướng dẫn sử dụng các chế độ GPU sharing ")
    * [ Tăng thêm Worker Group sử dụng GPU ](https://fptcloud.com/documents/fpt-kubernetes-engine-with-gpu/?doc=tang-them-worker-group-su-dung-gpu "Tăng thêm Worker Group sử dụng GPU")
    * [ Hướng dẫn cài đặt GPU Driver trên Kubernetes ](https://fptcloud.com/documents/fpt-kubernetes-engine-with-gpu/?doc=driver-installation-self-install "Hướng dẫn cài đặt GPU Driver trên Kubernetes")
    * [ Hướng dẫn cấu hình Auto Scale sử dụng GPU Custom Metric ](https://fptcloud.com/documents/fpt-kubernetes-engine-with-gpu/?doc=huong-dan-cau-hinh-auto-scale-su-dung-gpu-custom-metric "Hướng dẫn cấu hình Auto Scale sử dụng GPU Custom Metric")
    * [ Hướng dẫn cấu hình Auto Scale sử dụng KEDA và Prometheus ](https://fptcloud.com/documents/fpt-kubernetes-engine-with-gpu/?doc=huong-dan-cau-hinh-auto-scale-su-dung-keda-va-prometheus "Hướng dẫn cấu hình Auto Scale sử dụng KEDA và Prometheus")
