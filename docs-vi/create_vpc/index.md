...
FPT Storage 
  ...
  * [ ![](/img/migrated/settings-131ed42a.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/documents/create_vpc/?doc=initial-setup "Initial Setup")
  * [ ![](/img/migrated/icon-networking-419c349e.png) Hướng dẫn nhanh (Quick Starts) ](javascript: "Hướng dẫn nhanh \(Quick Starts\)")
    * [ Khởi tạo VPC ](https://fptcloud.com/documents/create_vpc/?doc=create-vpc "Khởi tạo VPC")
    * [ Rename VPC ](https://fptcloud.com/documents/create_vpc/?doc=rename-vpc "Rename VPC")
    * [ Ghi nhận Activity log và Recent task status ](https://fptcloud.com/documents/create_vpc/?doc=activitylog-bell "Ghi nhận Activity log và Recent task status")
