...
FPT Storage 
  ...
  * [ ![](/img/migrated/settings-800de3d1.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/documents/fpt-va/?doc=Initial%20Setup "Initial Setup")
  * [ ![](/img/migrated/icon-networking-f57b0b33.png) Hướng dẫn chi tiết (Tutorials) ](javascript: "Hướng dẫn chi tiết \(Tutorials\)")
    * [ Quản lý Target ](https://fptcloud.com/documents/fpt-va/?doc=quan-ly-target "Quản lý Target")
      * [ 1. Tạo một Target mới ](https://fptcloud.com/documents/fpt-va/?doc=tao-target "1. Tạo một Target mới")
      * [ 2 Kiểm tra trạng thái scan của Target ](https://fptcloud.com/documents/fpt-va/?doc=kiem-tra-trang-thai-target "2 Kiểm tra trạng thái scan của Target")
      * [ 3 Chỉnh sửa cấu hình scan Target ](https://fptcloud.com/documents/fpt-va/?doc=update-target "3 Chỉnh sửa cấu hình scan Target")
      * [ 4 Scan Now ](https://fptcloud.com/documents/fpt-va/?doc=scan-now "4 Scan Now")
      * [ 5 Xóa Target ](https://fptcloud.com/documents/fpt-va/?doc=xoa-target "5 Xóa Target")
      * [ 6 Hướng dẫn lấy Header trang web khi tạo mục tiêu quét ](https://fptcloud.com/documents/fpt-va/?doc=lay-header "6 Hướng dẫn lấy Header trang web khi tạo mục tiêu quét")
      * [ 7 Hướng dẫn lấy Cookie trang web khi tạo mục tiêu quét ](https://fptcloud.com/documents/fpt-va/?doc=lay-cookie "7 Hướng dẫn lấy Cookie trang web khi tạo mục tiêu quét")
      * [ 8. Mở Remote Registry trên Windows để sử dụng SMB ](https://fptcloud.com/documents/fpt-va/?doc=mo-remote-registry-window "8. Mở Remote Registry trên Windows để sử dụng SMB")
    * [ Xem kết quả quét ](https://fptcloud.com/documents/fpt-va/?doc=xem-ket-qua-quet "Xem kết quả quét")
      * [ 1. Truy cập Dashboard kết quả quét ](https://fptcloud.com/documents/fpt-va/?doc=dashboard-ket-qua-quet "1. Truy cập Dashboard kết quả quét")
      * [ 2. Xem chi tiết kết quả quét ](https://fptcloud.com/documents/fpt-va/?doc=xem-chi-tiet-ket-qua-quet "2. Xem chi tiết kết quả quét")
      * [ 3. Xem kết quả lịch sử quét ](https://fptcloud.com/documents/fpt-va/?doc=xem-ket-qua-quet-cu "3. Xem kết quả lịch sử quét")
    * [ Xuất báo cáo ](https://fptcloud.com/documents/fpt-va/?doc=xuat-bao-cao "Xuất báo cáo")
...
Xem kết quả quét
  * 
  * [ ](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ffptcloud.com%2Fdocuments%2Ffpt-va%2F "FPT Cloud VA")
...
* * *
[ Previous 8. Mở Remote Registry trên Windows để sử dụng SMB ](https://fptcloud.com/documents/fpt-va/?doc=mo-remote-registry-window "8. Mở Remote Registry trên Windows để sử dụng SMB") [ Next 1. Truy cập Dashboard kết quả quét ](https://fptcloud.com/documents/fpt-va/?doc=dashboard-ket-qua-quet "1. Truy cập Dashboard kết quả quét")
