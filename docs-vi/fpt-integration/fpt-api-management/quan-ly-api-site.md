...
![Userguide FPT API Management 16](/img/migrated/docs-vi-fpt-api-management/quan-ly-api-site/img-001.png)
...
![Userguide FPT API Management 17](/img/migrated/docs-vi-fpt-api-management/quan-ly-api-site/img-002.png)

**Bước 3**: Chọn **OK** để tiến hành tạo **Site**.

![Userguide FPT API Management 18](/img/migrated/docs-vi-fpt-api-management/quan-ly-api-site/img-003.png)
...
![Userguide FPT API Management 47](/img/migrated/docs-vi-fpt-api-management/quan-ly-api-site/img-004.png)

**Bước 3:** Nhập các thông tin mới và chọn **OK**.

![Userguide FPT API Management 48](/img/migrated/docs-vi-fpt-api-management/quan-ly-api-site/img-005.png)
...
![Userguide FPT API Management 19](/img/migrated/docs-vi-fpt-api-management/quan-ly-api-site/img-006.png)

**Bước 2:** Chọn **Staging to New site**.

![Userguide FPT API Management 20](/img/migrated/docs-vi-fpt-api-management/quan-ly-api-site/img-007.png)
...
![Userguide FPT API Management 21](/img/migrated/docs-vi-fpt-api-management/quan-ly-api-site/img-008.png)

**Bước 4:** Chọn **OK**.

![Userguide FPT API Management 22](/img/migrated/docs-vi-fpt-api-management/quan-ly-api-site/img-009.png)
...
![Userguide FPT API Management 49](/img/migrated/docs-vi-fpt-api-management/quan-ly-api-site/img-010.png)
...
![Userguide FPT API Management 50](/img/migrated/docs-vi-fpt-api-management/quan-ly-api-site/img-011.png)
...
![Userguide FPT API Management 51](/img/migrated/docs-vi-fpt-api-management/quan-ly-api-site/img-012.png)

**Bước 2:** Chọn **Product** cần lấy thông tin **>** Chọn **Manage Api.**

![Userguide FPT API Management 52](/img/migrated/docs-vi-fpt-api-management/quan-ly-api-site/img-013.png)

**Bước 3:** Thông tin cần lấy sẽ nằm ở cột **API EndPoint.**

![Userguide FPT API Management 53](/img/migrated/docs-vi-fpt-api-management/quan-ly-api-site/img-014.png)
...
![PybQsyRHfYQdAAAAAElFTkSuQmCC](/img/migrated/docs-vi-fpt-api-management/quan-ly-api-site/img-015.png)


Bước 2: Sau khi truy cập link đó sẽ dẫn đến trang có giao diện như sau:


![](/img/migrated/docs-vi-fpt-api-management/quan-ly-api-site/img-016.png)
...
![](/img/migrated/docs-vi-fpt-api-management/quan-ly-api-site/img-017.png)

Bước 2: Chọn API Browser, trong details tích chọn Enable IP Limitation.


![](/img/migrated/docs-vi-fpt-api-management/quan-ly-api-site/img-018.png)
...
![0L+8P1vSrnc3CgBYH8pbd269XkPQNauXZuhoaHGHBy46gFIPazbHYAsWLAg3d3djaVPTQACAAAAL0wCEIDnjyGwAAAAAACAgkn+Hzty+ksupAM1AAAAAElFTkSuQmCC](/img/migrated/docs-vi-fpt-api-management/quan-ly-api-site/img-019.png)
