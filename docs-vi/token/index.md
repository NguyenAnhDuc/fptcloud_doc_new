...
FPT Storage 
  ...
  * [ ![](/img/migrated/tai-xuong-3-9da28e90.png) Overviews ](javascript: "Overviews")
    * [ Giới thiệu ](https://fptcloud.com/documents/token/?doc=overview "Giới thiệu")
  * [ ![](/img/migrated/image-5-1-88ed95d0.png) Hướng dẫn nhanh (Quick start) ](javascript: "Hướng dẫn nhanh \(Quick start\)")
    * [ Create Token ](https://fptcloud.com/documents/token/?doc=create-token "Create Token")
    * [ Revoke token đã khởi tạo ](https://fptcloud.com/documents/token/?doc=revoke-token "Revoke token đã khởi tạo")
  * [ ![](/img/migrated/tai-xuong-4-0b9b0b67.png) FAQs ](javascript: "FAQs")
    * [ FQAs ](https://fptcloud.com/documents/token/?doc=fqas "FQAs")
