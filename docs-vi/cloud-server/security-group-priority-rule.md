...
title: "Giới thiệu"
description: "**Lưu ý:** Tính năng này chỉ dành riêng cho một số Tenant có cấu hình đặc biêt, vui lòng liên hệ để được hỗ trợ."
...
**Bước 2:** Mở danh sách Rules [![](/img/migrated/list-SG-1024x558-dd791842.png)](/img/migrated/list-SG-1024x558-dd791842.png) [![](/img/migrated/not-select-1024x513-cdee0131.png)](/img/migrated/not-select-1024x513-cdee0131.png)
...
**Bước 3:** Thay đổi Priority [![](/img/migrated/selected-1024x511-b2d3b2a0.png)](/img/migrated/selected-1024x511-b2d3b2a0.png)
