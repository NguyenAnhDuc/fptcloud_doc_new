...
FPT Storage 
  ...
  * [ ![](/img/migrated/settings-d31fa71f.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/documents/app-catalogs/?doc=initial-setup "Initial Setup")
  * [ ![](/img/migrated/icon-networking-2645685c.png) Hướng dẫn chi tiết (Tutorials) ](javascript: "Hướng dẫn chi tiết \(Tutorials\)")
    * [ Tạo mới một FPT App Catalogs ](https://fptcloud.com/documents/app-catalogs/?doc=tao-moi-app-catalogs "Tạo mới một  FPT App Catalogs")
    * [ Xem thông tin chi tiết App Catalog ](https://fptcloud.com/documents/app-catalogs/?doc=xem-thong-tin-chi-tiet-app-catalog "Xem thông tin chi tiết App Catalog")
    * [ Kết nối K8S cluster tới App Catalogs Management đã được khởi tạo ](https://fptcloud.com/documents/app-catalogs/?doc=ket-noi-cluster-toi-app-catalog-management "Kết nối K8S cluster tới App Catalogs Management đã được khởi tạo")
    * [ Quản lý App Catalogs ](https://fptcloud.com/documents/app-catalogs/?doc=quan-ly-app-catalogs "Quản lý App Catalogs")
      * [ Search app catalogs trong repository ](https://fptcloud.com/documents/app-catalogs/?doc=search-app-catalogs-trong-repository "Search app catalogs trong repository")
      * [ Deploy App Catalogs tới Cluster ](https://fptcloud.com/documents/app-catalogs/?doc=deploy-app-catalogs-toi-cluster "Deploy App Catalogs tới Cluster")
    * [ Quản lý applications đã được deploy tới cluster ](https://fptcloud.com/documents/app-catalogs/?doc=quan-ly-applications-da-duoc-deploy "Quản lý applications đã được deploy tới cluster")
      * [ Filter các Apps đã được deploy theo cluster ](https://fptcloud.com/documents/app-catalogs/?doc=filter-apps-da-duoc-deploy-theo-cluster "Filter các Apps đã được deploy theo cluster")
      * [ Xem chi tiết một App đã được deploy ](https://fptcloud.com/documents/app-catalogs/?doc=xem-chi-tiet-app-da-deploy "Xem chi tiết một App đã được deploy")
      * [ Thực hiện thay đổi cấu hình của applications ](https://fptcloud.com/documents/app-catalogs/?doc=thay-doi-cau-hinh-cua-applications "Thực hiện thay đổi cấu hình của applications")
      * [ Thực hiện rollback app về cấu hình cũ ](https://fptcloud.com/documents/app-catalogs/?doc=rollback-app-ve-cau-hinh-cu "Thực hiện rollback app về cấu hình cũ")
      * [ Upgrade applications tới version mới nhất ](https://fptcloud.com/documents/app-catalogs/?doc=upgrade-applications-toi-version-moi-nhat "Upgrade applications tới version mới nhất")
      * [ Thực hiện uninstall applications nếu muốn xoá bỏ ](https://fptcloud.com/documents/app-catalogs/?doc=uninstall-applications-neu-muon-xoa-bo "Thực hiện uninstall applications nếu muốn xoá bỏ")
    * [ Xoá App Catalog Management ](https://fptcloud.com/documents/app-catalogs/?doc=xoa-app-catalog-management "Xoá App Catalog Management")
