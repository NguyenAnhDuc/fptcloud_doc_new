...
title: "Deploy app Catalogs toi Cluster"
description: "Sau khi tìm kiếm chart mong muốn thực hiện deploy app tới k8s cluster như sau:"
sidebar_label: "Deploy app Catalogs toi Cluster"
sidebar_position: 8
---

# Deploy App Catalogs Toi Cluster
