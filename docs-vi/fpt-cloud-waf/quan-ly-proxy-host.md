...
FPT Storage 
  ...
  * [ ![](/img/migrated/icon-networking-f57b0b33.png) Hướng dẫn chi tiết (Tutorials) ](javascript: "Hướng dẫn chi tiết \(Tutorials\)")
    ...
    * [ Quản trị máy chủ WAF với WAF Dashboard ](https://fptcloud.com/documents/fpt-cloud-waf/?doc=quan-ly-proxy-host "Quản trị máy chủ WAF với WAF Dashboard")
  ...
  * Release note
    * [Ra mắt dịch vụ tường ...](https://fptcloud.com#release_notes_0 "Ra mắt dịch vụ tường ...")
...
* * *
[ Previous Monitor WAF với Dashboard Overview ](https://fptcloud.com/documents/fpt-cloud-waf/?doc=monitor-waf-voi-dashboard-overview "Monitor WAF với Dashboard Overview") [ Next Tạo mới Proxy Host ](https://fptcloud.com/documents/fpt-cloud-waf/?doc=tao-moi-proxy-host "Tạo mới Proxy Host")
