...
**Bước 3:** Tại màn detail **CDC service** > Chọn tab **Connectors** > nhấn **Create a connector** ![image-1](images/iceberg-sink-connector/img-001.png)
 ...
 * **Database** (required): chọn **Iceberg** ![image-2](images/iceberg-sink-connector/img-002.png)
 ...
 * **Topics** (required): lựa chọn các topic dữ liệu được gửi từ source connector ![image-3](images/iceberg-sink-connector/img-003.png)
 ...
 * **All**: Các message lỗi sẽ được gửi vào topic được nhập ![image-4](images/iceberg-sink-connector/img-004.png)

**Bước 7:** Nhấn **Next** để chuyển qua màn **Review** ![image-5](images/iceberg-sink-connector/img-005.png)
