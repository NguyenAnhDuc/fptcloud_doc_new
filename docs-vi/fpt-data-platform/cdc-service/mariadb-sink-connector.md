...
**Bước 3:** Tại màn detail **CDC service** > Chọn tab **Connectors** > nhấn **Create a connector** ![image-1](images/mariadb-sink-connector/img-001.png)
 ...
 * **Database** (required): chọn **MariaDB** ![image-2](images/mariadb-sink-connector/img-002.png)
 ...
 * **Topics** (required): Danh sách các topics Connector sẽ consume và sink dữ liệu vào database đích, và được ngăn cách bởi dấu "," ![image-3](images/mariadb-sink-connector/img-003.png)
 ...
 * **Topics** (required): Danh sách các topics Connector sẽ consume và sink dữ liệu vào database đích, và được ngăn cách bởi dấu "," ![image-4](images/mariadb-sink-connector/img-004.png)
 ...
 * **All**: Các message lỗi sẽ được gửi vào topic được nhập ![image-5](images/mariadb-sink-connector/img-005.png)

**Bước 7.** Nhấn **Next** để chuyển qua màn **Review** ![image-6](images/mariadb-sink-connector/img-006.png)
