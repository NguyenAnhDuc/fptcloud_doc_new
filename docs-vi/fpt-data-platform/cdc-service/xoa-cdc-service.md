 ...
 * **Bước 3:** Tại màn **Detail CDC service** > chọn **CDC service name** > chọn **Action** > nhấn **Delete** ![image-1](images/xoa-cdc-service/img-001.png)

 * **Bước 4:** Hiển thị hộp thoại **Delete Application**

→ Nhập **delete** > nhấn **Confirm** để xóa dịch vụ khỏi workspace

→ Chọn **Cancel** để hủy bỏ thao tác ![image-2](images/xoa-cdc-service/img-002.png)
