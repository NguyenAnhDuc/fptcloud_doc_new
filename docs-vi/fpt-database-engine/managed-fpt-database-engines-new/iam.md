...
Để cấu hình quyền truy cập và khai báo nhóm người dùng, vui lòng tham khảo chi tiết tại mục [Quản lý Role](/docs/vi/fpt-database-engine/managed-fpt-database-engines-new/)/ và [Quản lý User Group](/docs/vi/fpt-database-engine/managed-fpt-database-engines-new/)/.
