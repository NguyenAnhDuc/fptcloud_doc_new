...
**Bài viết này hướng dẫn build thiết bị Router để đấu nối VPN_S2S với dịch vụ VPN Site-to-Site của FPT Smart Cloud.**
  ...
  * [Bước 2: Cấu hình IPsec cho Palo Alto](/docs/vi/fpt-network/vpn-site-to-site/)/
  * [Bước 3: Cấu hình firewall và routing cho Palo Alto](/docs/vi/fpt-network/vpn-site-to-site/)/
