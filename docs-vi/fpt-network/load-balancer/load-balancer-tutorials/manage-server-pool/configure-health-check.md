...
Health check is configured when creating or updating a Server Pool. See [Create a Server Pool](/docs/vi/fpt-network/load-balancer/load-balancer-tutorials/manage-server-pool/create-server-pool) for the full configuration reference.
