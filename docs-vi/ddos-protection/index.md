...
FPT Storage 
  ...
  * [ ![](/img/migrated/settings-f58a338e.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/documents/ddos-protection/?doc=initial-setup "Initial Setup")
  * [ ![](/img/migrated/quick-start-aa7e143d.png) Hướng dẫn nhanh (Quick Starts) ](javascript: "Hướng dẫn nhanh \(Quick Starts\)")
    * [ Khởi tạo DDoS Protection ](https://fptcloud.com/documents/ddos-protection/?doc=create-ddos "Khởi tạo DDoS Protection")
    * [ Monitor các IP đang được bảo vệ ](https://fptcloud.com/documents/ddos-protection/?doc=monitor-ip "Monitor các IP đang được bảo vệ")
