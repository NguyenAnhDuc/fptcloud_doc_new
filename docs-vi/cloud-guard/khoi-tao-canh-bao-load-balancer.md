...
description: "Để thực hiện tạo cảnh báo cho dịch vụ Load balancer đang sử dụng, chọn **Type** là **Load Balancer** [![file"
sidebar_label: "Khởi tạo cảnh báo cho Load Balancer"
sidebar_position: 6
---

# Khoi Tao Canh Bao Load Balancer
