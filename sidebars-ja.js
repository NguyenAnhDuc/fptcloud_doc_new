          ...
          items:  [
            ...
            },
            {
              ...
              items:  [
                ...
                {
                  type:  "category",
                  label:  "Instance Group (Affinity & Anti-Affinity)の管理",
                  collapsed:  true,
                  items:  [
                    {
                      type:  "doc",
              ...
              items:  [
                {
                  ...
                  items:  [
                    ...
                    },
                    {
                      ...
                      label:  "Kubernetes cluster の削除"
                    }
                  ]
                },
                {
                  type:  "category",
                  label:  "K8s Cluster Configurationの変更",
                  collapsed:  true,
                  items:  [
                    {
                      type:  "doc",
                  ...
                  items:  [
                    {
                      ...
                      label:  "K8s FPT 上での PVC のスナップショットとリストア"
                    },
                    {
                      type:  "doc",
      ...
      items:  [
        ...
        },
        {
          ...
          items:  [
            ...
            {
              type:  "category",
              label:  "Managed GPU ClusterへのGPUワークロードのデプロイ",
              collapsed:  true,
              items:  [
                {
                  type:  "doc",
