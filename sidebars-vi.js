// Auto-generated from crawled menu structure — synced with EN sidebar order
module.exports = {
  tutorialSidebar: [
  'intro',
  {
        ...
        items: [
          {
            ...
            label: 'Đăng ký tài khoản trên hệ thống.'
          },
          {
            type: 'doc',
          ...
          },
          {
            ...
            label: 'Mua storage disk (ổ đĩa rời)'
          },
          {
            type: 'doc',
            ...
            items: [
              {
                ...
                label: 'Truy cập qua FCDClient mới'
              },
              {
                type: 'doc',
                id: 'fpt-cloud-desktop/SSO-qua-web-browser',
                label: 'Truy cập qua Web browser'
              },
              {
                type: 'doc',
                id: 'fpt-cloud-desktop/SSO-qua-FCDClient-cu',
                label: 'Truy cập qua FCDClient cũ (luồng cũ)'
              }
            ]
          },
          {
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Attach Policy vào Group'
              },
              {
                type: 'doc',
                id: 'fpt-autoscale/detach-policy-khoi-group',
                label: 'Detach Policy khỏi Group'
              },
              {
                type: 'doc',
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Tra cứu thông tin, thông số kỹ thuật của máy ảo đã tạo'
              },
              {
                type: 'doc',
                id: 'cloud-server/tutorials-thay-doi-thong-tin-cau-hinh-may-chu',
                label: 'Thay đổi thông tin, cấu hình máy chủ'
              },
              {
                type: 'doc',
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Quản lý GPU với Console Portal áp dụng cho loại dịch vụ Specific'
              }
            ]
          },
          {
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Revoke token đã khởi tạo'
              },
              {
                type: 'doc',
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Quản lý template được tạo từ máy ảo trên trang Custom Images'
              },
              {
                type: 'doc',
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Khởi tạo card Network Interface Card - Primary'
              },
              {
                type: 'doc',
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Manage Priority Rule of Security Group'
              }
            ]
          },
          {
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Khởi tạo một Instance Group mới'
              },
              {
                type: 'doc',
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Chọn Project khi tạo VPC'
              },
              {
                type: 'doc',
                id: 'cloud-server/header-project',
                label: 'Thay đổi giao diện header'
              }
            ]
          },
          {
            ...
            label: 'Sử dụng dịch vụ tính tiền theo phương thức PAYG'
          },
          {
            type: 'category',
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Instance Schedule Overview'
              },
              {
                type: 'doc',
              ...
              },
              {
                ...
                label: 'Gắn một hoặc nhiều máy ảo vào instance schedule'
              },
              {
                type: 'doc',
                id: 'cloud-server/detach-schedule-to-instance',
                label: 'Gỡ một hoặc nhiều máy ảo vào instance schedule'
              },
              {
                type: 'doc',
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Xem chi tiết lịch snapshot máy ảo'
              },
              {
                type: 'doc',
                id: 'cloud-server/editschedule-snapshotVM',
                label: 'Chỉnh sửa lịch snapshot máy ảo'
              },
              {
                type: 'doc',
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Xem chi tiết lịch snapshot ổ đĩa'
              },
              {
                type: 'doc',
                id: 'cloud-server/editschedule-snapshotstorage',
                label: 'Chỉnh sửa lịch snapshot ổ đĩa'
              },
              {
                type: 'doc',
          ...
          },
          {
            ...
            label: 'Tôi có thể tùy chỉnh toàn bộ rule trong các security group không?'
          },
          {
            type: 'doc',
            id: 'cloud-server/question-1',
            label: 'Tôi có thể hiệu chỉnh các address pair đã khởi tạo không?'
          }
        ]
      }
    ]
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Audit Logs - Managed Kubernetes Cluster'
              }
            ]
          },
          {
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Cấu hình lập lịch chạy Retention Rule'
              },
              {
                type: 'doc',
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Disable Robot Account đang sử dụng'
              },
              {
                type: 'doc',
                id: 'fpt-container-registry/enable-robot-account',
                label: 'Enable Robot Account'
              },
              {
                type: 'doc',
                id: 'fpt-container-registry/xoa-mot-robot-account',
                label: 'Xoá một Robot Account'
              },
              {
                type: 'doc',
              ...
              },
              {
                ...
                label: 'Hướng dẫn sử dụng Robot Account'
              }
            ]
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Hướng dẫn nâng gói dịch vụ đang sử dụng'
              }
            ]
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Quản lý kết quả Scan images'
              }
            ]
          }
        ]
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            label: 'Best Practice Manual Scaling'
          },
          {
            type: 'doc',
    ...
    items: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            label: 'Download Config VPN Site-to-Site'
          },
          {
            type: 'doc',
          ...
          },
          {
            ...
            label: 'Kiểm tra hoạt động VPN-Activity'
          },
          {
            type: 'doc',
            id: 'vpn-site-to-site/authenticate-certificate-mode',
            label: 'Authenticate-Certificate mode'
          },
          {
            type: 'category',
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Cấu hình kết nối VPN Site-to-Site giữa FCI Cloud và AWS (Virtual private gateways)'
              },
              {
                type: 'doc',
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Theo dõi dịch vụ thông qua tính năng monitoring'
              }
            ]
          },
          {
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              {
                type: 'doc',
                id: 'load-balancer/quan-ly-load-balancer',
                label: 'Quản lý Load Balancer'
              },
              {
                type: 'doc',
              ...
              },
              {
                ...
                label: 'Resize cho Load Balancer'
              },
              {
                type: 'doc',
                id: 'load-balancer/access-logs',
                label: 'Access logs cho Load balancer'
              },
              {
                type: 'doc',
          ...
          },
          {
            ...
            items: [
              {
                type: 'doc',
                id: 'load-balancer/quan-ly-listener',
                label: 'Quản lý Listener'
              },
              {
                type: 'doc',
          ...
          },
          {
            ...
            items: [
              {
                type: 'doc',
                id: 'load-balancer/quan-ly-server-pool',
                label: 'Quản lý Server Pool'
              },
              {
                type: 'doc',
          ...
          },
          {
            ...
            items: [
              {
                type: 'doc',
                id: 'load-balancer/manage-load-balancer',
                label: 'Quản lý Load Balancer'
              },
              {
                type: 'doc',
    ...
    items: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            label: 'ClickHouse - High Availability (HA)'
          }
        ]
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                type: 'doc',
                id: 'fpt-api-management/quan-ly-rest-apis',
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Xem và cập nhật giá trị Secret'
              },
              {
                type: 'doc',
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            label: 'Tạo mới một  FPT ArgoCD'
          },
          {
            type: 'doc',
            id: 'fpt-argocd/xem-thong-tin-chi-tiet-argocd',
            label: 'Xem thông tin chi tiết và đăng nhập ArgoCD instance'
          },
          {
            type: 'doc',
            id: 'fpt-argocd/add-cluster-toi-argocd',
            label: 'Add cluster tới ArgoCD instance đã được khởi tạo'
          },
          {
            type: 'category',
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Enable/disable ArgoCD images updater'
              },
              {
                type: 'doc',
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Add mới một Webhook Secret'
              },
              {
                type: 'doc',
          ...
          },
          {
            ...
            label: 'Cấu hình Build Options cho Kustomize'
          },
          {
            type: 'doc',
          ...
          },
          {
            ...
            label: 'Nâng gói dịch vụ đang sử dụng'
          },
          {
            type: 'doc',
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Tạo mới account trên portal'
              },
              {
                type: 'doc',
          ...
          },
          {
            ...
            items: [
              ...
              {
                type: 'doc',
                id: 'fpt-argocd/enable-disable-chuc-nang-cau-hinh-oidc',
                label: 'Enable/disable chức năng cấu hình OIDC'
              },
              {
                type: 'doc',
              ...
              },
              {
                ...
                label: 'Update cấu hình OIDC'
              },
              {
                type: 'doc',
                id: 'fpt-argocd/delete-oidc-da-cau-hinh',
                label: 'Delete OIDC đã cấu hình'
              }
            ]
          },
          {
            ...
            label: 'Cho phép enable Applications Set'
          },
          {
            type: 'category',
            ...
            items: [
              ...
              {
                type: 'doc',
                id: 'fpt-argocd/enable-disable-notificaions',
                label: 'Enable/disable Notificaions'
              },
              {
                type: 'doc',
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            label: '4. Monitor Infrastructure & Platform'
          },
          {
            type: 'doc',
            id: 'fpt-cloud-monitoring/monitor-applications',
            label: '5. Monitor Applications'
          },
          {
            type: 'doc',
            id: 'fpt-cloud-monitoring/monitor-public-endpoints',
            label: '6. Monitor public endpoints'
          },
          {
            type: 'category',
            ...
            items: [
              ...
              },
              {
                ...
                label: '7.2. FPT Cloud Monitoring dashboard template (build-in)'
              }
            ]
          },
          {
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Khởi tạo cảnh báo cho VPN site-to-site'
              },
              {
                type: 'doc',
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Invite IAM user mới'
              },
              {
                type: 'doc',
                id: 'iam/khoi tao account va truy cap vao vpc da duoc moi',
                label: 'Khởi tạo account và truy cập vào VPC đã được mời'
              },
              {
                type: 'doc',
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                type: 'doc',
                id: 'iam/create-ip',
                label: 'Khởi tạo một record IP access mới'
              },
              {
                type: 'doc',
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Monitor WAF với Dashboard Overview'
              }
            ]
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Xem thông tin chi tiết Proxy Host'
              },
              {
                type: 'doc',
                id: 'fpt-cloud-waf/cap-nhat-thong-tin-cho-proxy-host',
                label: 'Cập nhật thông tin cho Proxy Host'
              },
              {
                type: 'doc',
          ...
          },
          {
            ...
            label: 'Quản lý người dùng của WAF Dashboard'
          }
        ]
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            label: 'Monitor các IP đang được bảo vệ'
          }
        ]
      },
      {
        ...
        items: [
          {
            ...
            label: 'Cost explorer theo dịch vụ'
          },
          {
            type: 'doc',
            id: 'cost-explorer/cost-explorer-dimension-resource-type',
            label: 'Cost explorer theo loại tài nguyên'
          },
          {
            type: 'doc',
            id: 'cost-explorer/question-1',
            label: 'Vì sao tôi không xem được phần Cost Explore?'
          },
          {
            type: 'doc',
            id: 'cost-explorer/fqas-2',
            label: 'Tôi muốn xem Cost Explorer của 1 vài Instance hoặc Security Group nhưng Customize Filter không cho phép chọn ?'
          }
        ]
      },
      {
        ...
        items: [
          {
            ...
            label: 'Khởi tạo Bugdet Alert'
          },
          {
            type: 'doc',
            id: 'budget-alert/Xem thông tin cost và lịch sử cảnh báo',
            label: 'Xem thông tin cost và lịch sử cảnh báo'
          },
          {
            type: 'doc',
            id: 'budget-alert/Tạm dừng cảnh báo của 1 Budget Alert',
            label: 'Tạm dừng cảnh báo của 1 Budget Alert'
          },
          {
            type: 'doc',
          ...
          },
          {
            ...
            label: 'Cài đặt ngăn chặn tạo resource Compute/Network mới khi đã đạt ngưỡng ngân sách'
          }
        ]
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            label: 'Tạo gói cài đặt Agent, cài đặt Agert'
          },
          {
            type: 'doc',
            id: 'trellix-customer-guide/client-task',
            label: 'Quản lý các tác vụ chạy trên máy chủ (Client Tasks)'
          },
          {
            type: 'doc',
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            label: 'Tại sao đôi lúc tôi thấy số lượng Restore Point trên hệ thống nhiều hơn số lượng Lastest backup to keep đã khai báo?'
          },
          {
            type: 'doc',
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: 'Hướng dẫn thực hiện các thao tác cơ bản với Source Code anagement asset (repo/project)'
              },
              {
                type: 'doc',
