...
**手順4** : VPCを選択後、Robot Accountをお持ちの場合は **Robot Account Name** を入力します。Robot Accountをお持ちでない場合は、[こちら](/ja/docs/fpt-container/fpt-container-registry/)/のガイドをご参照ください。
...
[GitHub連携の無効化](/ja/docs/fpt-appsec/tutorials/integration-management/guide-github/)ガイドと同様です。
