...
FPT Database Engineサービスを管理するには、[FPT Database Engineの有効化](/ja/docs/fpt-database-engine/managed-fpt-database-engines-new/)/および[FPT Database Engineの無効化](/ja/docs/fpt-database-engine/managed-fpt-database-engines-new/)/セクションの詳細な手順をご参照ください。
