...
ユーザーはバックアップサービスの有効化時にPostgreSQLのPITR機能を有効にすること（詳細は[バックアップサービスの有効化](/ja/docs/fpt-database-engine/managed-fpt-database-engines-new/)/を参照）、またはバックアップサービスが有効化された後に以下の手順で有効にすることができます。
