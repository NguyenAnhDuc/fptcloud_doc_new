...
使用済みの time series/logs の量を確認するには、**[7. コンソールポータルで usage（timeseries、log、trace）の状態を確認する方法](/ja/docs/fpt-monitoring/fpt-cloud-monitoring/huong-dan-su-dung-grafana/)/** をご参照ください。
