...
3. 詳細なガイドは[こちら](/ja/docs/fpt-ai-factory/ai-notebook/lauch-jp)をご覧ください。
...
2. 詳細なガイドは[こちら](/ja/docs/fpt-ai-factory/ai-notebook/create-jp)をご覧ください。
...
3. 詳細なガイドは[こちら](/ja/docs/fpt-ai-factory/ai-notebook/switch)をご覧ください。

### ステップ7: カーネルをシャットダウンする

1. **実行中のカーネル/ノートブック**（ナビゲーションバー上から2番目のアイコン）に移動します。
2. 詳細なガイドは[こちら](/ja/docs/fpt-ai-factory/ai-notebook/shut-down-jp)をご覧ください。
