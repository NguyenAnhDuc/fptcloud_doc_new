...
![P3UAVy+4k08NAAAAAElFTkSuQmCC](/img/migrated/docs-ja-cloud-server/hpc-quick-start/img-001.png)

**ステップ 2**: イメージの作成

Hosts > Create image に移動して、新しいGPUマシンのイメージを作成します。

![](/img/migrated/docs-ja-cloud-server/hpc-quick-start/img-002.png)

次に、使用したいサーバー構成を選択し、名前を入力し、WindowsまたはLinuxのOSを選択してから、**Continue** > **Create Image** をクリックします。

![](/img/migrated/docs-ja-cloud-server/hpc-quick-start/img-003.png)
...
![wFsj+JD2bOR9gAAAABJRU5ErkJggg==](/img/migrated/docs-ja-cloud-server/hpc-quick-start/img-004.png)
...
![Aa4Ery4edUEoAAAAAElFTkSuQmCC](/img/migrated/docs-ja-cloud-server/hpc-quick-start/img-005.png)
...
![2023 04 05 Remote window](/img/migrated/docs-ja-cloud-server/hpc-quick-start/img-006.jpg)
...
![](/img/migrated/docs-ja-cloud-server/hpc-quick-start/img-007.png)
