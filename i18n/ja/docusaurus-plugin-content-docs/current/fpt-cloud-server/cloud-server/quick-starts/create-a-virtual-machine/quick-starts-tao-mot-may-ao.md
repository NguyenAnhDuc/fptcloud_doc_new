...
![file](/img/migrated/docs-ja-cloud-server/quick-starts-tao-mot-may-ao/img-001.png)

新しいダイアログボックスが表示され、次のステップをガイドします。

![Userguide FPT Cloud Server 2022 18](/img/migrated/docs-ja-cloud-server/quick-starts-tao-mot-may-ao/img-002.png)
...
![file](/img/migrated/docs-ja-cloud-server/quick-starts-tao-mot-may-ao/img-003.png)
...
![file](/img/migrated/docs-ja-cloud-server/quick-starts-tao-mot-may-ao/img-004.png)

  * Imageから仮想マシンを作成する場合: カスタムイメージまたはISOイメージを選択できます（注意事項の詳細: Link）


![file](/img/migrated/docs-ja-cloud-server/quick-starts-tao-mot-may-ao/img-005.png)

  * Snapshot/NAT Instanceから仮想マシンを作成する場合


![file](/img/migrated/docs-ja-cloud-server/quick-starts-tao-mot-may-ao/img-006.png)

![file](/img/migrated/docs-ja-cloud-server/quick-starts-tao-mot-may-ao/img-007.png)

**specific の場合**

![file](/img/migrated/docs-ja-cloud-server/quick-starts-tao-mot-may-ao/img-008.png)

**Resource type**: マシンタイプごとにCPUとRAMの設定が異なります。カスタム設定を作成することもできます。

![file](/img/migrated/docs-ja-cloud-server/quick-starts-tao-mot-may-ao/img-009.png)
...
![file](/img/migrated/docs-ja-cloud-server/quick-starts-tao-mot-may-ao/img-010.png)
...
![file](/img/migrated/docs-ja-cloud-server/quick-starts-tao-mot-may-ao/img-011.png)
...
![file](/img/migrated/docs-ja-cloud-server/quick-starts-tao-mot-may-ao/img-012.png)

  * Standardメソッドを使用する場合、ユーザーはパスワードを安全な場所に記憶・保管してください。


![file](/img/migrated/docs-ja-cloud-server/quick-starts-tao-mot-may-ao/img-013.png)

### Advanced 情報
![file](/img/migrated/docs-ja-cloud-server/quick-starts-tao-mot-may-ao/img-014.png)
...
![file](/img/migrated/docs-ja-cloud-server/quick-starts-tao-mot-may-ao/img-015.png)

初期化が成功すると、新しく作成した仮想マシンを確認し、管理ダッシュボードで情報を確認できます。各仮想マシンには名前、設定（RAM、CPU、Storage）、IPアドレス、動作状態（オフ/オン/Suspended）が一覧に表示されます。

**![Userguide FPT Cloud Server 2022 21](/img/migrated/docs-ja-cloud-server/quick-starts-tao-mot-may-ao/img-016.png)**
