...
**参照:** [FPT Cloud Managed Kubernetes Autoscaler](/ja/docs/fpt-container/managed-fpt-kubernetes-engine/tutorials/modify-k8s-cluster-configuration/cluster-autoscale)
