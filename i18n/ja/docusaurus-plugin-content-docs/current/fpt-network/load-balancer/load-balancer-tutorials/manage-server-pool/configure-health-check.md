...
ヘルスチェックはサーバープールの作成または更新時に設定します。完全な設定リファレンスは[サーバープールの作成](/ja/docs/fpt-network/load-balancer/load-balancer-tutorials/manage-server-pool/create-server-pool)を参照してください。
