...
description: "Hướng dẫn tích hợp và huỷ tích hợp giám sát Database với FPT Monitoring để thu thập metrics và logs."
sidebar_label: "Tích hợp Database"
sidebar_position: 14
---
...
- Sau đó tích hợp các dashboard template tương ứng, tham khảo hướng dẫn tại mục [**3.1. Tích hợp Dashboard Template**](/vi/docs/fpt-monitoring/fpt-cloud-monitoring/huong-dan-su-dung-grafana/)/
