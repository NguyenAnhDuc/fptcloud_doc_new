...
Xem [Thiết lập ban đầu](/vi/docs/fpt-monitoring/fpt-cloud-guard/Initial-Setup) để tạo tài khoản FPT Cloud và đăng nhập FPT Portal trước khi tạo Alert đầu tiên.
