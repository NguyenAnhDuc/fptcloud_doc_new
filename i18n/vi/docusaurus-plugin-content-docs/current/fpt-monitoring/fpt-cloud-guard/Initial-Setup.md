...
description: "Nếu đây là lần đầu tiên bạn sử dụng **FPT Cloud Guard – Alert** , trước tiên hãy kiểm tra và hoàn thành các công việc sa"
...
Nếu đây là lần đầu tiên bạn sử dụng **FPT Cloud Guard – Alert** , trước tiên hãy kiểm tra và hoàn thành các công việc sau:
  * [Tạo tài khoản FPT Cloud và đăng nhập vào FPT Portal](/vi/docs/fpt-monitoring/fpt-cloud-guard/tutorials/cloud-guard/)/
