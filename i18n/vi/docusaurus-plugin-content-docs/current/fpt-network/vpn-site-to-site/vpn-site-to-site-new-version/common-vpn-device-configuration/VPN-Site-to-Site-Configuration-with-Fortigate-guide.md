...
Bài viết này hướng dẫn build thiết bị Router để đấu nối VPN Site-to-Site của FPT Smart Cloud. 
  ...
  * [Bước 2: Cấu hình IPsec cho Fortigate](/vi/docs/fpt-network/vpn-site-to-site/)/
  * [Bước 3: Cấu hình firewall và routing cho Fortigate](/vi/docs/fpt-network/vpn-site-to-site/)/
