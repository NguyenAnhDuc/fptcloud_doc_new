...
Bài viết này hướng dẫn build thiết bị Router để đấu nối VPN_S2S với dịch vụ VPN Site-to-site của FPT Smart Cloud. 
  * [Bước 1: Build strongSwan](/vi/docs/fpt-network/vpn-site-to-site/)/
  * [Bước 2: Cấu hình cho VPN_AAS](/vi/docs/fpt-network/vpn-site-to-site/)/
  * [Bước 3: Cấu hình cho StrongSwan](/vi/docs/fpt-network/vpn-site-to-site/)/
