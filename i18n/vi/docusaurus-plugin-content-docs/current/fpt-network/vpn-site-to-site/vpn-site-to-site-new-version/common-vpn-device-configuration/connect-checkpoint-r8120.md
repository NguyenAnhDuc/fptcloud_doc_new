...
**Bài viết này hướng dẫn build thiết bị Router để đấu nối VPN_S2S với dịch vụ VPN Site-to-Site của FPT Smart Cloud.**
  * [Bước 1: Build CheckPoint for Cloud](/vi/docs/fpt-network/vpn-site-to-site/)/
  * [Bước 2: Cấu hình cho VPN Site-to-Site](/vi/docs/fpt-network/vpn-site-to-site/)/
  * [Bước 3: Cấu hình cho CheckPoint](/vi/docs/fpt-network/vpn-site-to-site/)/
  * [Bước 4: Debug- Tracert](/vi/docs/fpt-network/vpn-site-to-site/)/
