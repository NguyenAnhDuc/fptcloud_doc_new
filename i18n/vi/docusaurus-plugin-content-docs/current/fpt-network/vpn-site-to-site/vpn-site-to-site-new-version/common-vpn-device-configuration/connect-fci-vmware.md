...
Bài viết này hướng dẫn kết nối VPNaaS của 2 nền tảng VMW và OPS trên Unify portal 
  * [Bước 1: Cấu hình VPN_AAS trên Openstack](/vi/docs/fpt-network/vpn-site-to-site/)/
  * [Bước 2: Cấu hình VPN_AAS trên VMWare Cloud](/vi/docs/fpt-network/vpn-site-to-site/)/
  * [Bước 3: Kiểm tra kết nối](/vi/docs/fpt-network/vpn-site-to-site/)/
