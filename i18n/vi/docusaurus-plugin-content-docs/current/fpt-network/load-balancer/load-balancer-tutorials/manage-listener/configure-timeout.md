...
Timeout is configured when creating or updating a Listener. See [Create a Listener](/vi/docs/fpt-network/load-balancer/load-balancer-tutorials/manage-listener/create-listener) for details.
