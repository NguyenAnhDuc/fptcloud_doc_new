...
- **SNI SSL/TLS certificate**: One or more SNI certificates. If no certificates are available, import them using [Import SSL certificate](/vi/docs/fpt-network/load-balancer/load-balancer-tutorials/manage-ssl-certificate/import-ssl-certificate).
