...
Health check is configured when creating or updating a Server Pool. See [Create a Server Pool](/vi/docs/fpt-network/load-balancer/load-balancer-tutorials/manage-server-pool/create-server-pool) for the full configuration reference.
