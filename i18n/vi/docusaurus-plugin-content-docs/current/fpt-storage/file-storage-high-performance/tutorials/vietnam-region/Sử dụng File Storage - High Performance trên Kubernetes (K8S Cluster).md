...
# Sử dụng File Storage - High Performance trên Kubernetes (K8S Cluster)
  ...
  * [ ![](/img/migrated/icon-networking-b1e86145.png) Hướng dẫn chi tiết (Tutorials) ](javascript: "Hướng dẫn chi tiết \(Tutorials\)")
      * [ Sử dụng File Storage - High Performance trên Kubernetes (K8S Cluster) ](/vi/docs/fpt-storage/file-storage-high-performance/)/ "Sử dụng File Storage - High Performance trên Kubernetes \(K8S Cluster\)")
