...
**Bước 2:** Chọn Create Bucket và nhập tên Bucket cần tạo. [**Hướng dẫn thao tác trên FPT Portal.**](/vi/docs/fpt-storage/fpt-object-storage/)/  
[**Hướng dẫn thao tác trên S3 Client.**](/vi/docs/fpt-storage/fpt-object-storage/)/
