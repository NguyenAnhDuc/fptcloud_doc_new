...
Để quản lý dịch vụ FPT Database Engine, vui lòng tham khảo hướng dẫn chi tiết tại các mục [Kích hoạt FPT Database Engine](/vi/docs/fpt-database-engine/managed-fpt-database-engines-new/)/ và [Huỷ kích hoạt FPT Database Engine](/vi/docs/fpt-database-engine/managed-fpt-database-engines-new/)/.
