...
Để cấu hình quyền truy cập và khai báo nhóm người dùng, vui lòng tham khảo chi tiết tại mục [Quản lý Role](/vi/docs/fpt-database-engine/managed-fpt-database-engines-new/)/ và [Quản lý User Group](/vi/docs/fpt-database-engine/managed-fpt-database-engines-new/)/.
