...
## Danh mục lỗi
[1. Backup Error: "Please run OPTIMIZE TABLE on all listed tables…](/vi/docs/fpt-database-engine/managed-fpt-database-engines-new/)/
[2. Server Crash: Lỗi crash MySQL khi sử dụng combo index trên cột JSON](/vi/docs/fpt-database-engine/managed-fpt-database-engines-new/)/
