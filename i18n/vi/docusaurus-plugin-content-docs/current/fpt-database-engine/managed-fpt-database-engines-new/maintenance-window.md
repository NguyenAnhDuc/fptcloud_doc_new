...
#### Thao tác thực hiện:
Khi tạo mới cluster, người dùng có thể chọn maintenance window tại bước cấu hình **Additional Service** (chi tiết xem tại mục [Khởi tạo cơ sở dữ liệu](/vi/docs/fpt-database-engine/managed-fpt-database-engines-new/)/) và hệ thống sẽ áp dụng cấu hình ngay từ lần vận hành đầu tiên.
