...
### 1. Bật PITR
Người dùng có thể bật chức năng PITR cho PostgreSQL ngay khi kích hoạt dịch vụ Backup (tham khảo chi tiết tại mục [Kích hoạt dịch vụ Backup](/vi/docs/fpt-database-engine/managed-fpt-database-engines-new/)/) hoặc bật sau khi dịch vụ Backup đã được kích hoạt theo hướng dẫn bên dưới.
