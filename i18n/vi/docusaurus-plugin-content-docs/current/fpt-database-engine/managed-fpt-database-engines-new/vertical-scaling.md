...
Nhấn **Go to Notification** để chuyển đến tab **Notification** và thực hiện cấu hình theo hướng dẫn tại mục [Notification](/vi/docs/fpt-database-engine/managed-fpt-database-engines-new/)/.
