...
2. Chọn **Create Bucket**. Chi tiết xem tại [Tạo bucket](/vi/docs/fpt-storage/fpt-object-storage/tutorials/use-object-storage-on-fpt-portal/tutorials-bucket).
3. Upload dữ liệu vào bucket. Chi tiết xem tại [Upload objects](/vi/docs/fpt-storage/fpt-object-storage/tutorials/use-object-storage-on-fpt-portal/tutorials-object).
