...
Xem thêm thông tin về mô hình thanh toán tại [Payment Model](/vi/docs/gpu-container/payment-model/) và [Billing Overview](/vi/docs/gpu-container/billing-overview/).
