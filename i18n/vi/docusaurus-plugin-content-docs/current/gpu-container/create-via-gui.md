...
Mục này bao gồm:
- **Persistent Disk:** Chỉ định dung lượng lưu trữ để lưu trữ trọng số huấn luyện, model, v.v. Đọc thêm về Storage [tại đây](/vi/docs/gpu-container/)/.
...
### 8. Nạp tiền
Trong trường hợp số dư không đủ để tạo container mới, làm theo hướng dẫn tại: [Nạp tiền](/vi/docs/gpu-container/add-credit/).
