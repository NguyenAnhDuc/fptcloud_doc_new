...
Ở phần detail bạn sẽ được cung cấp access key để có thể tích hợp CI/CD Pipeline. Hướng dẫn tích hợp [tại đây](/vi/docs/fpt-appsec/tutorials/integration-management/cicd-guideline/)
