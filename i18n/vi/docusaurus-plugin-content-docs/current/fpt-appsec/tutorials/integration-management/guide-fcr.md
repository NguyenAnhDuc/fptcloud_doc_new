...
description: "Chỉ **Org Admin** và **Team Manager** có quyền chỉnh sửa tích hợp FPT Container Registry (FCR)"
...
**Bước 4** : Sau khi chọn VPC, nếu bạn đã có Robot Account, điền **Robot Account Name** , nếu bạn chưa có Robot Account, hãy xem phần hướng dẫn [tại đây](/vi/docs/fpt-container/fpt-container-registry/)/.
