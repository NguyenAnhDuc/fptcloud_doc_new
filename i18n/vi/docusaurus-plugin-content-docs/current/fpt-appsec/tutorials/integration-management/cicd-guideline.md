...
| Tên  | Loại  | Bắt buộc  | Mô tả  |  
| --- | --- | --- | --- |  
| team_code  | string  | Có  | Mã của nhóm FSEC, cách lấy team_code [tại đây](/vi/docs/fpt-appsec/tutorials/team-management/cai-dat-team/)  |  
| git_repo_url  | string  | Có  | URL kho lưu trữ Git (ví dụ: GitHub hoặc GitLab)  |  
| access_key  | string  | Có  | Khóa truy cập do FSEC cấp để truy cập kho lưu trữ, lấy access_key tại màn hình Integration detail[tại đây](/vi/docs/fpt-appsec/tutorials/integration-management/guide-gitlabserver/), tương tự với các loại tích hợp khác  |  
...
| team_code  | string  | Có  | Mã của nhóm FSEC, cách lấy team_code [tại đây](/vi/docs/fpt-appsec/tutorials/team-management/cai-dat-team/)  |  
| git_repo_url  | string  | Có  | URL kho lưu trữ Git (ví dụ: GitHub hoặc GitLab)  |  
| access_key  | string  | Có  | Khóa truy cập do FSEC cấp để truy cập kho lưu trữ, cách lấy access_key của GitLab server [tại đây](/vi/docs/fpt-appsec/tutorials/integration-management/guide-gitlabserver/), tương tự với các loại tích hợp khác  |  
| branch  | string  | Có  | Tên nhánh cần quét  |  
...
| --- | --- | --- | --- |  
| team_code  | string  | Có  | Mã của nhóm FSEC, cách lấy team_code [tại đây](/vi/docs/fpt-appsec/tutorials/team-management/cai-dat-team/)  |  
| access_key  | string  | Có  | Khóa truy cập do FSEC cấp cho registry image, cách lấy access_key của GitLab server [tại đây](/vi/docs/fpt-appsec/tutorials/integration-management/guide-gitlabserver/), tương tự với các loại tích hợp khác  |  
...
| access_key  | string  | Có  | Khóa truy cập do FSEC cấp, cách lấy access_key của GitLab server [tại đây](/vi/docs/fpt-appsec/tutorials/integration-management/guide-gitlabserver/), tương tự với các loại tích hợp khác  |  
**Ví dụ**
