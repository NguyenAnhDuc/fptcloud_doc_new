...
:::note
Để xem đối soát, bạn cần đăng nhập với role Tenant Owner hoặc role có quyền **view billing**. Chi tiết hướng dẫn phân quyền tại [Phân quyền xem billing](/vi/docs/billing/bills/quick-starts/billing-permission/).
:::
...
3. Chọn tab [Charges by service](/vi/docs/billing/bills/quick-starts/view-bill-charges-by-service/) để xem chi tiết đối soát theo dịch vụ, hoặc tab [Charges by resource](/vi/docs/billing/bills/quick-starts/view-bill-charges-by-resource/) để xem theo tài nguyên sử dụng.
