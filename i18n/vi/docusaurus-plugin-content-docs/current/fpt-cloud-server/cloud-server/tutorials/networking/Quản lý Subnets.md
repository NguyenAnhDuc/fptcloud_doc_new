...
![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-001.png)
...
![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-002.png)
...
![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-003.png)

## Xem chi tiết Subnet
![](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-004.png)
...
![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-005.png)

**Bước 2**: Modal **Rename subnet** hiện lên, người dùng tiến hàng đổi tên và nhấn **Rename subnet** để lưu thay đổi

![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-006.png)
...
![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-007.png)

**Bước 2**: Một hộp thoại hiện lên, người dùng xác nhận và nhấn **Change to routed** để thực hiện thay đổi

![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-008.png)
...
![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-009.png)
...
![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-010.png)

**Bước 2**: Nhập thông tin DNS server cần đổi và nhấn **Edit DNS** để cập nhật

![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-011.png)

## Manage tags cho Subnet
**Bước 1**: Ở menu chọn **Subnets** , tại subnet gắn tag, chọn **Actions** > Chọn **Manage tags**.

![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-012.png)

**Bước 2**: Chọn tag trong danh sách và nhấn **Save** để cập nhật

![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-013.png)
...
![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-014.png)

**Bước 2**: Người dùng nhấn vào chi tiết của một subnet. Nhấn vào **Create private IP**

![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-015.png)
...
![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-016.png)
...
![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-017.png)
...
![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-018.png)
...
![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-019.png)
...
![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-020.png)
...
![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-021.png)
...
![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-022.png)
...
![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-023.png)
...
![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-024.png)

__

_Hình 172.26.166.145 đang được gắn vào allow address pair_

![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-025.png)
...
![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-026.png)

**Bước 2**: Hệ thống sẽ hiển thị popup xác nhận thông tin. Để đồng ý xóa, chọn **Delete network**.

![file](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-027.png)
...
![](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-028.png)
...
![](/img/migrated/docs-vi-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-029.png)
