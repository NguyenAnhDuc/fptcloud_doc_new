...
4. Card được xóa thành công và Instance sẽ không thể kết nối qua card này. Để đảm bảo thông tin đồng bộ, bạn cần cập nhật thông tin network trong file config của hệ điều hành. Xem hướng dẫn: [How to change Config file](/vi/docs/fpt-cloud-server/cloud-server/tutorials/change-network-config/)/.
