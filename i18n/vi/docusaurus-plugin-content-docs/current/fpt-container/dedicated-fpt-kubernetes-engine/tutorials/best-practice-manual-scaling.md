...
✨ Hướng dẫn manual scale in/scale out trên portal console: tham khảo user guide [tại đây](/vi/docs/fpt-container/dedicated-fpt-kubernetes-engine/)/
...
3️⃣ **Khi tiến trình bị timeout**
  * Có thể nhấn action retry để thực hiện quá trình lại một lần nữa. Chi tiết có hướng dẫn [tại đây](/vi/docs/fpt-container/dedicated-fpt-kubernetes-engine/)/
