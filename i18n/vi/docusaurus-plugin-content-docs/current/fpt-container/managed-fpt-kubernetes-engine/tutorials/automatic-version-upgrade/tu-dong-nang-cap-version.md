...
- [Tổng quan quy trình quản lý phiên bản Kubernetes trên FPTCloud](/vi/docs/fpt-container/managed-fpt-kubernetes-engine/tutorials/automatic-version-upgrade/gioi-thieu-chung-ve-quy-trinh-quan-ly-version)
- [Hướng dẫn chi tiết sử dụng tính năng auto upgrade version](/vi/docs/fpt-container/managed-fpt-kubernetes-engine/tutorials/automatic-version-upgrade/huong-dan-chi-tiet-su-dung-auto-upgrade)
