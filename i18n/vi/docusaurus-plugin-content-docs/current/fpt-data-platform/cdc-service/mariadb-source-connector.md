...
**Bước 3:** Tại màn detail **CDC service** > Chọn tab **Connectors** > nhấn **Create** a connector ![image-1](images/mariadb-source-connector/img-001.png)
 ...
 * **Database (required):** chọn **SQLserver** ![image-2](images/mariadb-source-connector/img-002.png)
 ...
 * **Topics (required):** Danh sách các topics Connector sẽ consume và sink dữ liệu vào database đích, và được ngăn cách bởi dấu "," ![image-3](images/mariadb-source-connector/img-003.png)
 ...
 * **Topics (required):** Danh sách các topics Connector sẽ consume và sink dữ liệu vào database đích, và được ngăn cách bởi dấu "," ![image-4](images/mariadb-source-connector/img-004.png)
 ...
 * **Column (optional):** tên một cột dữ liệu muốn lấy ra trong table ![image-5](images/mariadb-source-connector/img-005.png)

**Bước 7:** Nhấn **Next** để chuyển sang màn **Review** ![image-6](images/mariadb-source-connector/img-006.png)
