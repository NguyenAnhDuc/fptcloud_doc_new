...
FPT Storage 
  ...
  * [ ![](/img/migrated/initial-setup-714537aa.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/documents/auto-schedule-to-on-off-instance/?doc=initial-setup "Initial Setup")
  * [ ![](/img/migrated/quick-starts-c3998e52.png) Hướng dẫn nhanh (Quick Starts) ](javascript: "Hướng dẫn nhanh \(Quick Starts\)")
    * [ Quản lý instance schedules ](https://fptcloud.com/documents/auto-schedule-to-on-off-instance/?doc=manage-version-schedules "Quản lý instance schedules")
      * [ Tạo một instance schedule mới ](https://fptcloud.com/documents/auto-schedule-to-on-off-instance/?doc=create-new-instance "Tạo một instance schedule mới")
      * [ Xem chi tiết một instance schedule ](https://fptcloud.com/documents/auto-schedule-to-on-off-instance/?doc=view-detail-instance "Xem chi tiết một instance schedule")
      * [ Xóa một instance schedule ](https://fptcloud.com/documents/auto-schedule-to-on-off-instance/?doc=delete-instance-schedule "Xóa một instance schedule")
    * [ Sử dụng instance schedules cho các máy ảo ](https://fptcloud.com/documents/auto-schedule-to-on-off-instance/?doc=use-instance-schedules-for-virtual-machines "Sử dụng instance schedules cho các máy ảo")
      * [ Gắn một hoặc nhiều máy ảo vào instance schedule ](https://fptcloud.com/documents/auto-schedule-to-on-off-instance/?doc=attach-schedule-to-instance "Gắn một hoặc nhiều máy ảo vào instance schedule")
      * [ Gỡ một hoặc nhiều máy ảo ra khỏi instance schedule ](https://fptcloud.com/documents/auto-schedule-to-on-off-instance/?doc=detach-schedule-to-instance "Gỡ một hoặc nhiều máy ảo ra khỏi instance schedule")
...
Sử dụng instance schedules cho các máy ảo
  * 
  * [ ](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ffptcloud.com%2Fdocuments%2Fauto-schedule-to-on-off-instance%2F "Auto Schedule To On-Off Instance")
...
* * *
[ Previous Xóa một instance schedule ](https://fptcloud.com/documents/auto-schedule-to-on-off-instance/?doc=delete-instance-schedule "Xóa một instance schedule") [ Next Gắn một hoặc nhiều máy ảo vào instance schedule ](https://fptcloud.com/documents/auto-schedule-to-on-off-instance/?doc=attach-schedule-to-instance "Gắn một hoặc nhiều máy ảo vào instance schedule")
