...
FPT Storage 
  ...
  * [ ![](/img/migrated/settings-d31fa71f.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/documents/affinity-anti-affinity/?doc=initial-setup "Initial Setup")
  * [ ![](/img/migrated/icon-networking-2645685c.png) Hướng dẫn nhanh (Quick Starts) ](javascript: "Hướng dẫn nhanh \(Quick Starts\)")
    * [ Khởi tạo một Instance Group mới ](https://fptcloud.com/documents/affinity-anti-affinity/?doc=create-instance-group "Khởi tạo một Instance Group mới")
    * [ Xóa một Instance Group ](https://fptcloud.com/documents/affinity-anti-affinity/?doc=delete-instance-group "Xóa một Instance Group")
    * [ Gắn máy ảo vào Instance Group ](https://fptcloud.com/documents/affinity-anti-affinity/?doc=add-instance-instance-group "Gắn máy ảo vào Instance Group")
