...
**ステップ 1** : Ở menu chọn **Compute Engine** > **Instance Group** , chọn **Create instance Group**.
[![file](/img/migrated/image-1705024581953-a55d4346.png)](/img/migrated/image-1705024581953-a55d4346.png)
**ステップ 2** : Nhập các thông tin theo yêu cầu của hệ thống:
...
**ステップ 3** : **Create instance group**. Hệ thống sẽ tiến hành khởi tạo và thông báo kết quả. Nếu thành công, instance group mới sẽ được hiển thị ở trang **Instance Group Management**. [![file](/img/migrated/image-1705024897223-9b650495.png)](/img/migrated/image-1705024897223-9b650495.png)
