...
Portal Console でのアップグレード手順: <https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=nang-cap-k8s-version>
...
- アップグレード前に cluster の master をバックアップします: <https://fptcloud.com/documents/dedicated-fpt-kubernetes-engine/?doc=backup-and-restore-cluster>
