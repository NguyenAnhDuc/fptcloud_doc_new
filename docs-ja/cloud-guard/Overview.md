...
FPT Storage 
  ...
  * [ ![](/img/migrated/icon-glossary-46e0a6e7.png) Overview ](javascript: "Overview")
    * [ Cloud Guard ](https://fptcloud.com/documents/cloud-guard/?doc=Overview "Cloud Guard")
  * [ ![](/img/migrated/settings-800de3d1.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/documents/cloud-guard/?doc=Initial-Setup "Initial Setup")
  * [ ![](/img/migrated/icon-networking-f57b0b33.png) Hướng dẫn chi tiết (Tutorials) ](javascript: "Hướng dẫn chi tiết \(Tutorials\)")
    * [ Quản lý Alert ](https://fptcloud.com/documents/cloud-guard/?doc=Overview "Quản lý Alert")
      * [ Khởi tạo cảnh báo cho Virtual Machine (VM) ](https://fptcloud.com/documents/cloud-guard/?doc=khoi-tao-canh-bao-virtual-machine "Khởi tạo cảnh báo cho Virtual Machine \(VM\)")
      * [ Khởi tạo cảnh báo cho Object Storage ](https://fptcloud.com/documents/cloud-guard/?doc=khoi-tao-canh-bao-object-storage "Khởi tạo cảnh báo cho Object Storage")
      * [ Khởi tạo cảnh báo cho Load Balancer ](https://fptcloud.com/documents/cloud-guard/?doc=khoi-tao-canh-bao-load-balancer "Khởi tạo cảnh báo cho Load Balancer")
      * [ Khởi tạo cảnh báo cho VPN site-to-site ](https://fptcloud.com/documents/cloud-guard/?doc=khoi-tao-canh-bao-vpn "Khởi tạo cảnh báo cho VPN site-to-site")
      * [ Khởi tạo một Activity Alert mới ](https://fptcloud.com/documents/cloud-guard/?doc=khoi-tao-mot-alert-moi-activity-alert "Khởi tạo một Activity Alert mới")
      * [ Khởi tạo một Threat Alert mới ](https://fptcloud.com/documents/cloud-guard/?doc=khoi-tao-mot-alert-moi-threat-alert "Khởi tạo một Threat Alert mới")
      * [ Kiểm tra trạng thái của Alert ](https://fptcloud.com/documents/cloud-guard/?doc=kiem-tra-trang-thai-cua-alert "Kiểm tra trạng thái của Alert")
      * [ Bật/Tắt Alert ](https://fptcloud.com/documents/cloud-guard/?doc=bat-tat-alert "Bật/Tắt Alert")
      * [ Chỉnh sửa Alert ](https://fptcloud.com/documents/cloud-guard/?doc=chinh-sua-alert "Chỉnh sửa Alert")
      * [ Xóa Alert ](https://fptcloud.com/documents/cloud-guard/?doc=xoa-alert "Xóa Alert")
    * [ Quản lý Recipient ](https://fptcloud.com/documents/cloud-guard/?doc=Overview "Quản lý Recipient")
      * [ Recipient là gì? ](https://fptcloud.com/documents/cloud-guard/?doc=Recipient-la-gi "Recipient là gì?")
      * [ Tạo mới Recipient ](https://fptcloud.com/documents/cloud-guard/?doc=tao-moi-recipient "Tạo mới Recipient")
      * [ Tạo mới người nhận qua MSTeams ](https://fptcloud.com/documents/cloud-guard/?doc=recipient-teams "Tạo mới người nhận qua MSTeams")
      * [ Chỉnh sửa Recipient ](https://fptcloud.com/documents/cloud-guard/?doc=chinh-sua-recipient "Chỉnh sửa Recipient")
      * [ Xóa Recipient ](https://fptcloud.com/documents/cloud-guard/?doc=xoa-recipient "Xóa Recipient")
  ...
  * Release note
    * [FPT Cloud Guard (Alert 2.0) �...](https://fptcloud.com#release_notes_0 "FPT Cloud Guard \(Alert 2.0\) �...")
    * [FPT Cloud Guard (Alert 2.1) ra...](https://fptcloud.com#release_notes_1 "FPT Cloud Guard \(Alert 2.1\) ra...")
    * [FPT Cloud Guard hỗ trợ c�...](https://fptcloud.com#release_notes_2 "FPT Cloud Guard hỗ trợ c�...")
...
Cloud Guard
  * 
  * [ ](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ffptcloud.com%2Fdocuments%2Fcloud-guard%2F "FPT Cloud Guard")
  * [ ](https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ffptcloud.com%2Fdocuments%2Fcloud-guard%2F "FPT Cloud Guard")
  * [ ](https://twitter.com/share?text=&url=https%3A%2F%2Ffptcloud.com%2Fdocuments%2Fcloud-guard%2F "FPT Cloud Guard")
