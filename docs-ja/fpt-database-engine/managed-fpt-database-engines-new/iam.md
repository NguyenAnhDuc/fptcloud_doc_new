...
アクセス権限の設定とユーザーグループの宣言については、[ロール管理](/docs/ja/fpt-database-engine/managed-fpt-database-engines-new/)/および[ユーザーグループ管理](/docs/ja/fpt-database-engine/managed-fpt-database-engines-new/)/セクションの詳細をご参照ください。
