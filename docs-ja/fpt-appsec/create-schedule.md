...
**ステップ1:** Mở màn hình tạo 
Vào menu **Schedule** , hệ thống điều hướng sang màn hình **Schedule Management**. **Create Schedule** : 
...
**ステップ2:** Nhập các trường thông tin chung
...
**ステップ3:** Nhập thông tin về phạm vi (scope) chạy schedule 
...
**ステップ5:** Kiểm tra lại tất cả trường bắt buộc đã điền. **Create** để lưu schedule. 
