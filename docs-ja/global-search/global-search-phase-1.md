...
**ステップ 1.** Nhập từ khoá vào ô tìm kiếm ở phía trên cùng của giao diện FPT Cloud. 
[![](/img/migrated/gsdb-1024x535-32afb917.png)](/img/migrated/gsdb-1024x535-32afb917.png)
**ステップ 2.** Chọn một trong các tab Instances, IP Addresses, Subnets, Security Groups, Database để xem kết quả gom nhóm theo từng loại tài nguyên.
  ...
  * Bấm vào từng kết quả sẽ đến giao diện thông tin chi tiết của tài nguyên đó. (注意: Nếu tài nguyên không có giao diện thông tin chi tiết, hệ thống sẽ dẫn đến màn hình danh sách của loại tài nguyên đó)

**ステップ 3.** Nếu muốn xem toàn bộ kết quả, bấm **View all result**
**ステップ 4.** Hệ thống sẽ mở ra màn hình với toàn bộ kết quả tìm kiếm được 
...
**ステップ 5.** Giới hạn lại kết quả tìm bằng bộ lọc VPC, Region hoặc ô tìm kiếm "Search by resource name"
**ステップ 6.** Bấm **Download** để tải xuống file danh sách kết quả theo các kết quả mà hệ thống hiển thị trên màn hình
