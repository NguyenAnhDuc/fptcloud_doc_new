...
FPT Storage 
  ...
  * [ ![](/img/migrated/settings-d31fa71f.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=initial-setup "Initial Setup")
  * [ ![](/img/migrated/icon-networking-2645685c.png) Hướng dẫn chi tiết ](javascript: "Hướng dẫn chi tiết")
    * [ 1. Kích hoạch dịch vụ FPT Cloud Monitoring ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=kich-hoat-dich-vu-fcmon "1. Kích hoạch dịch vụ FPT Cloud Monitoring")
    * [ 2. Xem danh sách Workspaces ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=xem-danh-sach-workspaces "2. Xem danh sách Workspaces")
    * [ 3. Quản lý một Workspace ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=quan-ly-workspace "3. Quản lý một Workspace")
      * [ 3.1. Xem chi tiết một Workspace ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=xem-chi-tiet-workspace "3.1. Xem chi tiết một Workspace")
      * [ 3.2. Configuration Tab ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=configuration-tab "3.2. Configuration Tab")
      * [ 3.3. Add data Tab ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=add-data-tab "3.3. Add data Tab")
      * [ 3.4. User Management Tab ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=user-management-tab "3.4. User Management Tab")
      * [ 3.5. Quota and Package Tab ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=quota-and-package-tab "3.5. Quota and Package Tab")
      * [ 3.6. User guide Tab ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=user-guide-tab "3.6. User guide Tab")
    * [ 4. Monitor Infrastructure & Platform ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=monitor-infrastructure-platform "4. Monitor Infrastructure & Platform")
    * [ 5. Monitor Applications ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=monitor-applications "5. Monitor Applications")
    * [ 6. Monitor public endpoints ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=monitor-public-endpoints "6. Monitor public endpoints")
    * [ 7. Trực quan hóa dữ liệu ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=truc-quan-hoa-du-lieu "7. Trực quan hóa dữ liệu")
      * [ 7.1. Truy cập vào dashboard ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=truy-cap-vao-dashboard "7.1. Truy cập vào dashboard")
      * [ 7.2. FPT Cloud Monitoring dashboard template (build-in) ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=fcmon-dashboard-template "7.2. FPT Cloud Monitoring dashboard template \(build-in\)")
    * [ 8. Quản trị Cảnh báo (Alerting) ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=alerting "8. Quản trị Cảnh báo \(Alerting\)")
    * [ 9. Khám phá dữ liệu (Explore data) ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=explore-data "9. Khám phá dữ liệu \(Explore data\)")
    * [ 10. Quản trị User ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=quan-tri-user "10. Quản trị User")
...
3. Quản lý một Workspace
  * 
  * [ ](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ffptcloud.com%2Fdocuments%2Ffpt-cloud-monitoring%2F "FPT Cloud Monitoring")
...
* * *
[ Previous 2. Xem danh sách Workspaces ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=xem-danh-sach-workspaces "2. Xem danh sách Workspaces") [ Next 3.1. Xem chi tiết một Workspace ](https://fptcloud.com/documents/fpt-cloud-monitoring/?doc=xem-chi-tiet-workspace "3.1. Xem chi tiết một Workspace")
