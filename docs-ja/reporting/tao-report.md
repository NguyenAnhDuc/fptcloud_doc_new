...
**ステップ 1** : Click **Home** > **Apps** > **Reporting** > **Create a new report**
**ステップ 2** : Chọn thông tin phần **Select Dashboard**
  * **Source dashboard** (required) 
  * **Time Range** (optional): Phạm vi thời gian mà report sẽ lấy dữ liệu. 
...
**ステップ 4** : Cung cấp thông tin phần **Format report**
...
**注意: Nếu không chọn thiết lập nâng cao, hệ thống sẽ tự động gửi báo cáo hàng ngày (daily) theo lịch trình đã thiết lập.**
...
Cách thiết lập: 
1, **Refresh Frequency** là **Monthly**
2, Nhập **End date**
3, **Repeating Cycle**
