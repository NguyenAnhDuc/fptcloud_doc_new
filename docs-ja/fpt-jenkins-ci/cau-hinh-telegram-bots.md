...
title: "Telegram Bot の設定"
sidebar_label: "Telegram Bot の設定"
sidebar_position: 17
...
FPT Cloud では、Portal インターフェースを通じてユーザーへの通知送信のために Jenkins に Telegram Bot を設定できます。

### Telegram Bot 設定の編集

**ステップ 1:** FPT Portal メニュー > **Jenkins CI** > **Detail Cluster** > **Configurations** > **Telegram Bot** > **Edit** を選択します。

[![](/img/migrated/Picture84-ace31d4a.png)](/img/migrated/Picture84-ace31d4a.png)

**ステップ 2:** Telegram Bot の設定を行います。
