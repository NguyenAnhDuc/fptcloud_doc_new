---
id: "tutorials-add-waf-server"
title: "WAFサーバーの追加"
description: "FPT Cloud PortalでWAFサーバーを追加するステップバイステップのチュートリアルです。"
...
3. **Create WAF**をクリックして、選択した構成でサーバーを作成します。処理の進捗は**Cloud Web Application Firewall Management**画面の**Status**フィールドで確認できます。

   [![WAFサーバー作成の進捗](/img/migrated/Userguide-FPT-WAF-2022-10-1024x538-aa8602dd.png)](/img/migrated/Userguide-FPT-WAF-2022-10-1024x538-aa8602dd.png)

:::note
WAFサーバーが正常に作成されると、WAF Dashboardへのログインに使用するユーザー名とパスワードが記載されたメールが届きます。受信箱でこれらの認証情報を確認してください。
:::
