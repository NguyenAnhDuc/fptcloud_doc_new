...
FPT Storage 
  ...
  * [ ![](/img/migrated/icon-glossary-46e0a6e7.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/documents/backup/?doc=Backup-Initial-Setup "Initial Setup")
  * [ ![](/img/migrated/icon-networking-0257e14b.png) Hướng dẫn chi tiết (Tutorials) ](javascript: "Hướng dẫn chi tiết \(Tutorials\)")
    * [ Quản lý Backup job ](https://fptcloud.com/documents/backup/?doc=quan-ly-backup-job "Quản lý Backup job")
    * [ Restore lại VM từ các Restore Point ](https://fptcloud.com/documents/backup/?doc=restore-lai-vm-tu-cac-restore-point "Restore lại VM từ các Restore Point ")
    * [ Tạo VM mới từ các Restore Point ](https://fptcloud.com/documents/backup/?doc=clone-vm-tu-cac-restore-point "Tạo VM mới từ các Restore Point")
    * [ Xem lịch sử Backup & Recovery ](https://fptcloud.com/documents/backup/?doc=xem-lich-su-backup-and-recovery "Xem lịch sử Backup & Recovery ")
    * [ Kiểm tra thông tin backup và restore của VM. ](https://fptcloud.com/documents/backup/?doc=kiem-tra-thong-tin-backup-va-restore-cua-vm "Kiểm tra thông tin backup và restore của VM.")
    * [ Report ](https://fptcloud.com/documents/backup/?doc=backup-report "Report")
    * [ Backup Volume ](https://fptcloud.com/documents/backup/?doc=backup-volume "Backup Volume")
  * [ ![](/img/migrated/question-45cd06af.png) Các câu hỏi thường gặp (FAQs) ](javascript: "Các câu hỏi thường gặp \(FAQs\)")
    * [ Tôi được hỗ trợ những gì khi thuê máy chủ và dùng dịch vụ Backup trên FPT Cloud? ](https://fptcloud.com/documents/backup/?doc=toi-duoc-ho-tro-nhung-gi-khi-thue-may-chu-va-dung-dich-vu-backup-tren-fpt-cloud "Tôi được hỗ trợ những gì khi thuê máy chủ và dùng dịch vụ Backup trên FPT Cloud?")
    * [ Incremental backup là gì và lợi ích khi sử dụng? ](https://fptcloud.com/documents/backup/?doc=incremental-backup-la-gi-va-loi-ich-khi-su-dung "Incremental backup là gì và lợi ích khi sử dụng?")
    * [ Tại sao đôi lúc tôi thấy số lượng Restore Point trên hệ thống nhiều hơn số lượng Lastest backup to keep đã khai báo? ](https://fptcloud.com/documents/backup/?doc=tai-sao-djoi-luc-toi-thay-so-luong-restore-point-tren-he-thong-nhieu-hon-so-luong-lastest-backup-to-keep-dja-khai-bao "Tại sao đôi lúc tôi thấy số lượng Restore Point trên hệ thống nhiều hơn số lượng Lastest backup to keep đã khai báo?")
    * [ Tôi muốn tìm hiểu về Backup, FPT Cloud có chính sách dùng thử không? ](https://fptcloud.com/documents/backup/?doc=toi-muon-tim-hieu-ve-backup-fpt-cloud-co-chinh-sach-dung-thu-khong "Tôi muốn tìm hiểu về Backup, FPT Cloud có chính sách dùng thử không?")
