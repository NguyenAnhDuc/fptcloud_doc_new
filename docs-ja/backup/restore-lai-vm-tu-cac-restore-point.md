...
**ステップ1:** Ở menu chọn **Backup & Recovery** > **Backup & Recovery Management**. Mở tab **Restore**. Ở đây sẽ hiển thị các VM đang được bảo vệ và số lượng Restore Point が正常に作成されました trước đấy.
