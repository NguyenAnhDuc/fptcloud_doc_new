...
### **ステップ1: Mở màn hình tạo Backup Job**
Trên FPT Cloud Portal, truy cập Backup & Recovery ⇒ Create Backup Job
### **ステップ2: Cấu hình thông tin Backup Job**
...
### **ステップ3: Tạo Backup Job**
**Create** để khởi tạo Backup Job mới.
Hệ thống sẽ:
  * Kiểm tra tài nguyên
...
Cách thực hiện:
**ステップ1:** Vào **Backup → Backup Management**
**ステップ2:** Tại dòng Backup Job cần chạy, trong cột **Action** , chọn **Start**
**ステップ3:** Một hộp thoại xác nhận sẽ hiển thị. **Start** để tiến hành chạy job.
...
### Cách xóa Backup Job
**ステップ1:** Vào **Backup → Backup Management**
**ステップ2:** Tại job cần xóa, trong cột **Action** , chọn **Delete**
**ステップ3:** Một hộp thoại cảnh báo sẽ xuất hiện, yêu cầu xác nhận. **Delete** để xóa hoàn toàn Backup Job.
