...
**ステップ 1** : Chọn card NIC cần chuyển sang Primary. Đối với card đã là Primary, chức năng này sẽ bị disable. Đối với card thông thường, Unify Portal hỗ trợ chuyển đổi dễ dàng và nhanh chóng.
...
**ステップ 2:** Xác nhận chuyển card thường sang card Primary. 
...
**ステップ 4:** Card bình thường sẽ được chuyển sang Primary, card Primary sẽ chuyển về card thường. Instance có thể kết nối mạng qua card này.
