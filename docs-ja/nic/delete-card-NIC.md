...
**ステップ 1** : Chọn Card NIC cần xóa. Đối với card Primary, chức năng này sẽ bị disable. Đối với card thông thường, Unify Portal hỗ trợ xóa khi không có nhu cầu sử dụng.
...
**ステップ 4:** Card được xóa thành công và Instance sẽ không thể kết nối qua card này. Để đảm bảo thông tin đồng bộ, các bạn cần thay đổi thông tin về network trong file config của hệ điều hành. Link hướng dẫn nhanh tại: [**How to change Config file**](../change-network-config/index.md).
