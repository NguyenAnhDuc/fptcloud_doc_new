...
**ステップ2:** Vào file ifcfg-eth0, và sửa thông số: 
...
**ステップ4:** Restart Networking service bằng lệnh: 
...
**ステップ5:** Kiểm tra lại cấu hình vào ping test 
