...
**ステップ 2:** Vào file ifcfg-eth0, và sửa thông số: 
...
**ステップ 4** : Restart Networking service bằng lệnh: 
...
**ステップ 5** : Kiểm tra lại cấu hình vào ping test 
