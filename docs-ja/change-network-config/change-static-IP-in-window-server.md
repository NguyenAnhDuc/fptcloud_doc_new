...
**ステップ1:** Kiểm tra tình trạng hiện tại 
...
**ステップ3:** Phải chuột vào card mạng cần thay đổi Config, chọn propertise 
...
**ステップ4:** Thay đổi các thông số theo cấu hình mới – OK 
...
**ステップ5:** Kiểm tra lại các thay đổi và ping thử 
