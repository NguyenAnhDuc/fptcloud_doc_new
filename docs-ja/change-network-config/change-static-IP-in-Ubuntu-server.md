...
**ステップ2:** Mở file 00-installer-config.yaml 
...
**ステップ3:** Sửa lại các thông số cần thiết. 
...
**ステップ4:** Nhâp lệnh sau đây để cập nhật thay đổi: 
  * Sudo netplan apply
...
**ステップ5:** Check lại địa chỉ IP đã thay bằng lệnh ifconfig 
