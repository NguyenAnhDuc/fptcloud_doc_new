...
**ステップ 2:** Mở file 00-installer-config.yaml 
...
**ステップ 3:** Sửa lại các thông số cần thiết. 
...
**ステップ 4:** Nhâp lệnh sau đây để cập nhật thay đổi: 
  * Sudo netplan apply
...
**ステップ 5** : Check lại địa chỉ IP đã thay bằng lệnh ifconfig 
