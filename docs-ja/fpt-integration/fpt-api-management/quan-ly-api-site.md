...
![Userguide FPT API Management 16](/img/migrated/docs-ja-fpt-api-management/quan-ly-api-site/img-001.png)
...
![Userguide FPT API Management 17](/img/migrated/docs-ja-fpt-api-management/quan-ly-api-site/img-002.png)

**ステップ3**：**OK**をクリックして**Site**を作成します。

![Userguide FPT API Management 18](/img/migrated/docs-ja-fpt-api-management/quan-ly-api-site/img-003.png)
...
![Userguide FPT API Management 47](/img/migrated/docs-ja-fpt-api-management/quan-ly-api-site/img-004.png)

**ステップ3：** 新しい情報を入力し、**OK**をクリックします。

![Userguide FPT API Management 48](/img/migrated/docs-ja-fpt-api-management/quan-ly-api-site/img-005.png)
...
![Userguide FPT API Management 19](/img/migrated/docs-ja-fpt-api-management/quan-ly-api-site/img-006.png)

**ステップ2：** **Staging to New site**をクリックします。

![Userguide FPT API Management 20](/img/migrated/docs-ja-fpt-api-management/quan-ly-api-site/img-007.png)
...
![Userguide FPT API Management 21](/img/migrated/docs-ja-fpt-api-management/quan-ly-api-site/img-008.png)

**ステップ4：** **OK**をクリックします。

![Userguide FPT API Management 22](/img/migrated/docs-ja-fpt-api-management/quan-ly-api-site/img-009.png)
...
![Userguide FPT API Management 49](/img/migrated/docs-ja-fpt-api-management/quan-ly-api-site/img-010.png)
...
![Userguide FPT API Management 50](/img/migrated/docs-ja-fpt-api-management/quan-ly-api-site/img-011.png)
...
![Userguide FPT API Management 51](/img/migrated/docs-ja-fpt-api-management/quan-ly-api-site/img-012.png)

**ステップ2：** **Product**を選択し、**Manage Api**をクリックします。

![Userguide FPT API Management 52](/img/migrated/docs-ja-fpt-api-management/quan-ly-api-site/img-013.png)

**ステップ3：** Endpoint情報は**API EndPoint**列に表示されます。

![Userguide FPT API Management 53](/img/migrated/docs-ja-fpt-api-management/quan-ly-api-site/img-014.png)
...
![PybQsyRHfYQdAAAAAElFTkSuQmCC](/img/migrated/docs-ja-fpt-api-management/quan-ly-api-site/img-015.png)


ステップ2：そのリンクにアクセスすると、以下のインターフェースのページが表示されます。


![](/img/migrated/docs-ja-fpt-api-management/quan-ly-api-site/img-016.png)
...
![](/img/migrated/docs-ja-fpt-api-management/quan-ly-api-site/img-017.png)

ステップ2：**API Browser**をクリックし、詳細パネルで**Enable IP Limitation**にチェックを入れます。


![](/img/migrated/docs-ja-fpt-api-management/quan-ly-api-site/img-018.png)
...
![0L+8P1vSrnc3CgBYH8pbd269XkPQNauXZuhoaHGHBy46gFIPazbHYAsWLAg3d3djaVPTQACAAAAL0wCEIDnjyGwAAAAAACAgkn+Hzty+ksupAM1AAAAAElFTkSuQmCC](/img/migrated/docs-ja-fpt-api-management/quan-ly-api-site/img-019.png)
