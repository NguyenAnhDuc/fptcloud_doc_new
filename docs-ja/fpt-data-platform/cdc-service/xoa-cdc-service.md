 ...
 * **ステップ 3:** **Detail CDC service** 画面で **CDC service name** を選択 > **Action** を選択 > **Delete** をクリックします ![image-1](images/xoa-cdc-service/img-001.png)

 * **ステップ 4:** **Delete Application** ダイアログが表示されます

→ **delete** と入力 > **Confirm** をクリックしてワークスペースからサービスを削除します

→ **Cancel** をクリックして操作をキャンセルします ![image-2](images/xoa-cdc-service/img-002.png)
