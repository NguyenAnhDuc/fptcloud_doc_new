...
**ステップ1:** Ở menu chọn **AI Infrastructure** > **Managed GPU Cluster** , hệ thống sẽ hiển thị trang **GPU Cluster Management**. Chọn Cluster muốn lấy thông tin truy cập Cluster.
[![](/img/migrated/12-7952cac6.png)](/img/migrated/12-7952cac6.png)
**ステップ2:** Ở mục **Essential Properties** > Cluster Information > Configuration, có thể download file kubeconfig để đăng nhập Cluster thông qua kubectl hoặc các công cụ khác.
