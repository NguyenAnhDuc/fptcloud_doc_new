...
**ステップ3:** にアクセスします open-webui trên trình duyệt tại port đã được forward, ví dụ: _<http://localhost:52433>_. Với lần đầu tiên cài đặt và sử dụng OpenWebUI, người dùng sẽ cần cấu hình các thông tin: tên, email, mật khẩu.
