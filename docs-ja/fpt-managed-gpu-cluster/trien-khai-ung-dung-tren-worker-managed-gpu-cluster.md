...
**ステップ1:** Clone mã nguồn và script đã có của Open-WebUI
...
**ステップ2:** Chạy các script để triển khai ollama và open-webui. Bên trong thư mục đã bao gồm tất cả các file cần thiết để triển khai như **namespace** , **ollama statefulSet** , **ollama service** , **open-webui deployment** và **open-webui service**.
...
**ステップ3:** Truy cập vào open-webui trên trình duyệt tại port đã được forward, ví dụ: _<http://localhost:52433>_. Với lần đầu tiên cài đặt và sử dụng OpenWebUI, người dùng sẽ cần cấu hình các thông tin: tên, email, mật khẩu.
[![](/img/migrated/36-bb032555.png)](/img/migrated/36-bb032555.png)
**ステップ4:** Sau khi cài đặt xong, người dùng lựa chọn model để sử dụng. Ví dụ ở đây, ta sẽ cài đặt mô hình DeepSeek-R1, phiên bản **1.5b**.
[![](/img/migrated/37-51db1bb9.png)](/img/migrated/37-51db1bb9.png)
**ステップ5:** Sau khi mô hình đã được tải và chạy, người dùng có thể tương tác với mô hình rất đơn giản và trực quan thông qua giao diện.
