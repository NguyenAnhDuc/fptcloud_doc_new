...
# 表示 Danh Sach Managed Gpu Cluster
...
Trên **FPT Portal** , ở menu chọn **AI Infrastructure** > **Managed GPU Cluster**. システムが表示します danh sách Cluster đã tạo với các thông tin quan trọng như : **Name** , **Version** , **Worker Group** , **Status** , **Created At** , **Actions**.
[![](/img/migrated/8-1-75374b83.png)](/img/migrated/8-1-75374b83.png)
**Truy cập thông tin chi tiết của cụm cluster**
**ステップ1:** Ở menu chọn **Managed GPU Cluster** , hệ thống sẽ hiển thị trang **Managed GPU Management**. Chọn Cluster muốn xem thông tin chi tiết.
[![](/img/migrated/9-1-1670bae1.png)](/img/migrated/9-1-1670bae1.png)
**ステップ2:** Tab **Essential Properties** sẽ hiển thị các thông tin của Cluster.
...
**ステップ3:** Tab **Node Pools** sẽ hiển thị toàn bộ Worker Group thuộc cụm Cluster và thông tin cấu hình của từng Worker Group.
