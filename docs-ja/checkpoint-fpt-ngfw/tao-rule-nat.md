...
**ステップ1:** Trên **Object Pane** (**F11**) > tìm Object cần SNAT > chuột phải chọn **Edit.**
...
**ステップ2:** Trên Menu chọn **NAT** > tích **Add automatic address translation rules** > tích **Hide behind IP address** > điền IP muốn SNAT > chọn gateway để apply
...
**ステップ3:** Trên Menu chọn **Security Policies** (**Ctrl + 2**) > chọn **Access Control** > chọn **NAT** > Kiểm tra rule đã được tạo.
...
**ステップ1:** Trên Menu chọn **Security Policies** (**Ctrl + 2**) > chọn **Access Control** > chọn **NAT.**
...
**ステップ2:** **Add rule above/ to top/ to bottom** để thêm rule vào vị trí phù hợp.
...
**ステップ4:** Tạo Firewall rule cho phép kết nối DNAT đã tạo.
