...
**ステップ1：** メニューから **Network Management** > **Network Interfaces** > **Add** を選択します。
...
**ステップ3：** ネットワーク設計に従ってインターフェースを設定します。
...
**ステップ1：** メニューから **Network Management** > **Network Interfaces** を選択します。
...
**ステップ2：** 編集するインターフェースを選択し、**Edit** をクリックします。
...
**ステップ3：** 新しい情報を入力し、**OK** をクリックして保存します。
...
**ステップ2：** 削除するインターフェースを選択し、**Delete** > **OK** をクリックして削除を確認します。
