...
**ステップ1:** Trên **Menu** chọn **Gateway and Servers**(**Ctrl + 1**) > chọn **Gateway** > chọn **Edit.**
...
**ステップ2:** Trên **Menu** chọn **General Properties** > Tích chọn các Blade muốn bật > chọn **OK.**
...
**ステップ1:** Các Blade thuộc **Network Security** (Mobile Access, Application Control, URL Filtering, Monitoring,…)
...
**注意:** Có những Blade cần cấu hình tích hợp thêm để sử dụng khi bật, ví dụ Mobile Access.
**ステップ2:** Trên **Menu** chọn **Security Policies** (**Ctrl + 2**) > chọn **New Tab** > chọn **Manage policies and layers.**
...
**ステップ3:** **Policy** đang sử dụng > chọn **Edit** > ở layer **Access Control** > chọn **Edit Layer.**
...
**ステップ4:** Tích chọn các Blade đã bật ở **Bước 1** > chọn **OK.**
...
**ステップ5:** Tạo **Rule/ Access** sử dụng các Blades mới:
...
**ステップ6:** Install Policy.
**ステップ1:** Các Blade thuộc Threat Prevention (IPS, Anti-Bot, Anti-Virus, Threat Emulation, Threat Extraction)
...
**ステップ2:** Trên Menu chọn **Security Policies** (Ctrl + 2) > chọn **Threat Prevention** > chọn **Policy**.  
...
**ステップ2:** Bỏ tích các Blade không sử dụng.
