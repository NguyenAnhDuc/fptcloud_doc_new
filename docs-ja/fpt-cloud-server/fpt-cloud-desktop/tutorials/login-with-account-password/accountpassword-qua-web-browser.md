...
![file](/img/migrated/docs-ja-fpt-cloud-desktop/accountpassword-qua-web-browser/img-001.png)
...
![file](/img/migrated/docs-ja-fpt-cloud-desktop/accountpassword-qua-web-browser/img-002.png)
...
![file](/img/migrated/docs-ja-fpt-cloud-desktop/accountpassword-qua-web-browser/img-003.png)

  * ログインしたい Server に対応するアカウント情報を入力します。


![file](/img/migrated/docs-ja-fpt-cloud-desktop/accountpassword-qua-web-browser/img-004.png)

:::note
二要素認証の QR コードが表示された場合: Apple Store または Google Play からスマートフォンに **Microsoft Authenticator** アプリをダウンロードしてインストールしてください。
:::

![file](/img/migrated/docs-ja-fpt-cloud-desktop/accountpassword-qua-web-browser/img-005.png)

Authenticator アプリを開き、QR コードをスキャンします。

![file](/img/migrated/docs-ja-fpt-cloud-desktop/accountpassword-qua-web-browser/img-006.png)
...
![file](/img/migrated/docs-ja-fpt-cloud-desktop/accountpassword-qua-web-browser/img-007.png)
