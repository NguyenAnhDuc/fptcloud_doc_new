...
title: "OIDC設定の更新"
description: "ArgoCDで作成済みのOIDC設定を編集するガイド"
sidebar_label: "OIDC設定の更新"
sidebar_position: 3
---

# OIDC設定の更新

1. **Security & Access** > **OIDC Scope** 画面で、更新するOIDC設定の **Edit** をクリックします。

[![](/img/migrated/Picture27-4-addb0284.png)](/img/migrated/Picture27-4-addb0284.png)

2. 変更したいOIDC情報（**Name**、**Issuer**、**ClientID**、**Client Secret**）を更新します。
