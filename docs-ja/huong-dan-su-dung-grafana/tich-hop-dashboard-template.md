...
**ステップ1:** Open menu ở góc trái màn hình

[![Alt text](/img/migrated/Picture3-a5fead32.png)](/img/migrated/Picture3-a5fead32.png)

**ステップ2:** **App** >> **Fmon – Templates** >> chọn tab **Dashboard Template**
...
**ステップ3:** **Topic** tương ứng (ví dụ: Kubernetes)
...
**ステップ4:** Click **Integrate** để tích hợp Dashboard
...
**ステップ5:** Sau khi tích hợp thành công, refresh lại Grafana → mở menu → chọn **Dashboard**
