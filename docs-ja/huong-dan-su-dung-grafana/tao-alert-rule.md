...
## ステップ2: Định nghĩa query và điều kiện
...
## ステップ3: Cấu hình hành vi đánh giá alert (Alert evaluation behavior)
...
## ステップ5: Labels and notifications

## ステップ6: Lưu Alert Rule
