...
外部からのアクセスを管理するために、nginx-ingress などの Ingress Controller を使用します。[Service Type Load-Balancer](/docs/ja/fpt-container/managed-fpt-kubernetes-engine/tutorials/service-type-load-balancer) を参照してください。
...
- [Service Type Load-Balancer](/docs/ja/fpt-container/managed-fpt-kubernetes-engine/tutorials/service-type-load-balancer)
- [Persistent Storage](/docs/ja/fpt-container/managed-fpt-kubernetes-engine/tutorials/persistent-storage)
