...
**参照:** [FPT Cloud Managed Kubernetes Autoscaler](/docs/ja/fpt-container/managed-fpt-kubernetes-engine/tutorials/modify-k8s-cluster-configuration/cluster-autoscale)
