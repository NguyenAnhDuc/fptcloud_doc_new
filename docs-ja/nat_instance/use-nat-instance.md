...
Tính năng chỉ áp dụng cho người dùng mua dich vụ loại General 
• Người dùng chọn mode isolated trong quá trình khởi tạo subnet. システムが表示します thông tin hướng dẫn cách cấu hình Nat instance giúp các instance thuộc isolated network có thể ra ngoài nternet
