...
FPT Storage 
  ...
  * [ ![](/img/migrated/tai-xuong-2-25c50a7f.png) Overviews ](javascript: "Overviews")
    * [ Giới thiệu ](https://fptcloud.com/documents/nat_instance/?doc=overview-nat-instance "Giới thiệu")
  * [ ![](/img/migrated/settings-3-e684e7b5.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/documents/nat_instance/?doc=Initial-Setup "Initial Setup")
  * [ ![](/img/migrated/icon-networking-2-24c3615d.png) Hướng dẫn nhanh (Quick Starts) ](javascript: "Hướng dẫn nhanh \(Quick Starts\)")
    * [ Hướng dẫn về sử dụng Nat instance ](https://fptcloud.com/documents/nat_instance/?doc=use-nat-instance "Hướng dẫn về sử dụng Nat instance")
    * [ Cài đặt Nat instance ](https://fptcloud.com/documents/nat_instance/?doc=setting-nat-instance "Cài đặt Nat instance")
  * [ ![](/img/migrated/tai-xuong-1-1d131978.png) FQAs ](javascript: "FQAs")
    * [ Nat Instance có thể được sử dụng như 1 instance thông thường không? ](https://fptcloud.com/documents/nat_instance/?doc=question- "Nat Instance có thể được sử dụng như 1 instance thông thường không?")
