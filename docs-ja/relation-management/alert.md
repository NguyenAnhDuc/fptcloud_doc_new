...
**ステップ1:** Vào Home >> Alerting >> Alert rules >> Click New alert rule
[![Alt text](/img/migrated/Picture37-ffd11132.png)](/img/migrated/Picture37-ffd11132.png)
**ステップ2:** Người dùng config các thông tin alert
...
**ステップ3:** Sau khi config các thông tin xong, bạn cần Save rule để bảo toàn thông tin.
