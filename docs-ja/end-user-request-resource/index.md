...
# Yêu cầu tài nguyên
  ...
  * [ ![](/img/migrated/icon-networking-2645685c.png) クイックスタート (Quick Starts) ](javascript: "クイックスタート \(Quick Starts\)")
...
Request Resource
## 概要 (Overview) 
**1. 紹介 về Yêu cầu cung cấp tài nguyên**
