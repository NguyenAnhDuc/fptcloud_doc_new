...
**ステップ 1** : Ở menu chọn **Policy Management**. Tại policy cần edit, chọn **Actions** > **Edit policy**
[![file](/img/migrated/image-1719821730021-76297cd9.png)](/img/migrated/image-1719821730021-76297cd9.png)
**ステップ 2** : Chỉnh sửa thông tin policy. **Edit policy** để lưu lại thông tin thay đổi.
