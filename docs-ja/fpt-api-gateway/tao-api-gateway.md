...
**ステップ 2:** **Create an API Gateway cluster** > hiển thị màn hình **Create API Gateway**
**ステップ 3:** Trong form tạo **API Gateway,** nhập thông tin màn **Basic Information** : 
...
**ステップ 4:** **Next Step** để chuyển sang màn nhập thông tin **Details**
Nhập thông tin sau: 
...
**ステップ 5:** **Next Step** để chuyển sang màn **Service Configuration**
...
**ステップ 6:** **Next Step** để chuyển sang màn **Review and Create**
...
**ステップ 7** : Kiểm tra thông tin nhập sau đó nhấn **Create** để hoàn thành việc khởi tạo **API Gateway**
