...
**ステップ 1:** Tại menu tab bar, chọn Billing > Bills > lần lượt chọn kỳ hóa đơn (period), chọn contract và invoice cần xem. 
...
**ステップ 2:** Tại màn hình xem đối soát, người dùng có thể tra cứu các thông tin bao gồm: 
...
**ステップ 3:** Người dùng có thể xem chi tiết đối soát theo dịch vụ tại tab [Charges by service](../billing/index.md) hoặc theo tài nguyên sử dụng tại tab [Charges by resource](../billing/index.md).
