...
**ステップ 1:** Trên server linux gõ lệnh veeam để khởi mở giao diện quản trị backup.
...
**ステップ 3:** Cấu hình lại network nếu cần
...
**ステップ 4:** Nhấn phím I để mount phân vùng chưa dữ liệu cần restore vào server. Dữ liệu sẽ được mount vào đường dẫn /mnt/backup
[![file](/img/migrated/image-1695293662668-59e66199.png)](/img/migrated/image-1695293662668-59e66199.png)
**ステップ 5:** Vào thư mục /mnt/backup
...
**ステップ 6:** Sau khi đã toàn thành việc restore file hoặc folder
