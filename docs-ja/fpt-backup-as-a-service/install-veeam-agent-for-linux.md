...
**ステップ1:** Trên server cần backup, login vào trang portal với account của bạn:
...
**ステップ2:** Vào mục **Managed Computers** chọn **Download Agent** sau đó chọn **Linux**.
...
**ステップ3:** Sau khi download thành công file LinuxAgentPackages.sh bạn cần copy vào trong server và tiến hành cài đặt.
Chạy lệnh sau:
...
**ステップ4:** Veeam sẽ tự động cài đặt Veeam Agent sau khi script chạy thành công.
...
**ステップ5:** Kiểm tra quá trình cài đặt thành công
