...
**ステップ 1:** Đăng nhập vào giao diện quản trị của Fortigate NGFW thông qua địa chỉ IP và user/password đã cấu hình.  
...
**ステップ 2:** Sau khi đăng nhập thành công màn hình Dashboard hiển thị các thông số của hệ thống bao gồm: **Serial Number** , **Licenses** , **CPU** , **Memory** …  
