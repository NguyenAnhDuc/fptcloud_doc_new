...
**ステップ 1:** Sau khi đã cấu hình Interface quản trị (Port 1) trên CLI và đã truy cập giao diện web thành công. Dưới đây là hướng dẫn cấu hình một Interface đóng vai trò LAN.  
...
**ステップ 2:** Cấu hình Interface đóng vai trò WAN (Port 2).  
