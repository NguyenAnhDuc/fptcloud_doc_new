...
FPT Storage 
  ...
  * [ ![](/img/migrated/settings-db5eccfa.webp) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/documents/fpt-monitoring-ip-access-control/?doc=initial-setup "Initial Setup")
      * [ Tạo tài khoản FPT Cloud và đăng nhập vào FPT Portal ](https://fptcloud.com/documents/fpt-monitoring-ip-access-control/?doc=tao-tai%20khoan-fpt-cloud-va-dang-nhap-vao-fpt-portal "Tạo tài khoản FPT Cloud và đăng nhập vào FPT Portal")
  * [ ![](/img/migrated/quick-starts-efcbe2f9.webp) Hướng dẫn chi tiết (Tutorials) ](javascript: "Hướng dẫn chi tiết \(Tutorials\)")
    * [ Giới thiệu chung ](https://fptcloud.com/documents/fpt-monitoring-ip-access-control/?doc=gioi-thieu-chung "Giới thiệu chung")
    * [ Truy cập tính năng và kiểm tra trạng thái bật/tắt ](https://fptcloud.com/documents/fpt-monitoring-ip-access-control/?doc=truy-cap-tinh-nang "Truy cập tính năng và kiểm tra trạng thái bật/tắt")
    * [ Quản lý danh sách whitelisted IP ](https://fptcloud.com/documents/fpt-monitoring-ip-access-control/?doc=quan-li-danh-sach-whitelisted-ip "Quản lý danh sách whitelisted IP")
      * [ Xem danh sách whitelisted IP/dải IP ](https://fptcloud.com/documents/fpt-monitoring-ip-access-control/?doc=xem-danh-sach-whitelisted-ip "Xem danh sách whitelisted IP/dải IP")
      * [ Thêm mới whitelisted IP/dải IP ](https://fptcloud.com/documents/fpt-monitoring-ip-access-control/?doc=them-moi-whitelisted-ip "Thêm mới whitelisted IP/dải IP")
      * [ Xóa bỏ whitelisted IP/dải IP ](https://fptcloud.com/documents/fpt-monitoring-ip-access-control/?doc=xoa-whitelisted-ip "Xóa bỏ whitelisted IP/dải IP")
      * [ Retry IP/dải IP đã thêm/xóa thất bại ](https://fptcloud.com/documents/fpt-monitoring-ip-access-control/?doc=retry-ip "Retry IP/dải IP đã thêm/xóa thất bại")
    * [ Quy tắc hệ thống ](https://fptcloud.com/documents/fpt-monitoring-ip-access-control/?doc=quy-tac-he-thong "Quy tắc hệ thống")
    * [ Liên hệ hỗ trợ ](https://fptcloud.com/documents/fpt-monitoring-ip-access-control/?doc=lien-he-ho-tro "Liên hệ hỗ trợ")
