...
| Healthcheck configuration | Configure how the Load Balancer health-checks its members. Default settings are applied automatically; adjust only if custom health check behaviour is needed. |
