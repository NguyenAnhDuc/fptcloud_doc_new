...
FPT Storage 
  ...
  * [ ![](/img/migrated/overview-292f8f1a.png) Overviews ](javascript: "Overviews")
    * [ Overview ](https://fptcloud.com/documents/sso-single-sign-on/?doc=overview "Overview")
  * [ ![](/img/migrated/quick-start-aa7e143d.png) Hướng dẫn nhanh (Quick Starts) ](javascript: "Hướng dẫn nhanh \(Quick Starts\)")
    * [ Cấu hình SSO ](https://fptcloud.com/documents/sso-single-sign-on/?doc=config-sso "Cấu hình SSO")
    * [ Sử dụng tính năng SSO ](https://fptcloud.com/documents/sso-single-sign-on/?doc=use-sso "Sử dụng tính năng SSO")
