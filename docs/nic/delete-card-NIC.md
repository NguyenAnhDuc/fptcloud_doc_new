...
**Step 1** : Chọn Card NIC cần xóa. Đối with card Primary, chức năng this will bị disable. Đối with card thông thường, Unify Portal hỗ trợ xóa when không có nhu cầu sử dụng.
...
**Step 4:** Card is xóa successfully and Instance will cannot kết nối qua card this. Để đảm bảo thông tin đồng bộ, the you cần thay đổi thông tin về network in file config of hệ điều hành. Link hướng dẫn nhanh tại: [**How to change Config file**](../change-network-config/index.md).
