...
FPT Container 
  ...
  * [ ![](/img/migrated/icon-glossary-89f97805.webp) Overview ](javascript: "Overview")
    * [ Overview ](https://fptcloud.com/en/documents/65101/?doc=Overview "Overview")
  * [ ![](/img/migrated/settings-db5eccfa.webp) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/en/documents/65101/?doc=Initial%20Setup "Initial Setup")
  * [ ![](/img/migrated/quick-starts-efcbe2f9.webp) Load Balancer (Tutorials) ](javascript: "Load Balancer \(Tutorials\)")
    * [ Manage Load balancer ](https://fptcloud.com/en/documents/65101/?doc=manage-load-balancer "Manage Load balancer")
      * [ Create Load Balancer ](https://fptcloud.com/en/documents/65101/?doc=create-load-balancer "Create Load Balancer")
      * [ Update Load Balancer ](https://fptcloud.com/en/documents/65101/?doc=update-load-balancer "Update Load Balancer")
      * [ Monitor Load Balancer metrics ](https://fptcloud.com/en/documents/65101/?doc=monitor-metrics "Monitor Load Balancer metrics")
      * [ Add external member to Load Balancer ](https://fptcloud.com/en/documents/65101/?doc=add-external-member "Add external member to Load Balancer")
      * [ Resize Load Balancer ](https://fptcloud.com/en/documents/65101/?doc=resize-load-balancer "Resize Load Balancer")
      * [ Monitor Load Balancer access logs ](https://fptcloud.com/en/documents/65101/?doc=access-logs "Monitor Load Balancer access logs")
    * [ Manage Listener ](https://fptcloud.com/en/documents/65101/?doc=manage-listener "Manage Listener")
      * [ Create Listener ](https://fptcloud.com/en/documents/65101/?doc=create-listener "Create Listener")
      * [ Configure timeout ](https://fptcloud.com/en/documents/65101/?doc=Configure-timeout "Configure timeout")
      * [ Configure L7 policy ](https://fptcloud.com/en/documents/65101/?doc=Configure-l7-policy "Configure L7 policy")
      * [ Configure redirect from HTTP requests to HTTPS ](https://fptcloud.com/en/documents/65101/?doc=redirect-http-to-https "Configure redirect from HTTP requests to HTTPS")
      * [ Redirect prefix ](https://fptcloud.com/en/documents/65101/?doc=redirect-prefix "Redirect prefix")
      * [ Enable HSTS to HTTPS Listener ](https://fptcloud.com/en/documents/65101/?doc=enable-hsts-to-http-listener "Enable HSTS to HTTPS Listener")
      * [ Configure allow IP/CIDR ](https://fptcloud.com/en/documents/65101/?doc=Allow-IP-CIDR "Configure allow IP/CIDR")
      * [ Configure SNI for Load balancer ](https://fptcloud.com/en/documents/65101/?doc=SNI-load-balancer "Configure SNI for Load balancer")
    * [ Manage Server pool ](https://fptcloud.com/en/documents/65101/?doc=manage-server-pool "Manage Server pool")
      * [ Create Server Pool ](https://fptcloud.com/en/documents/65101/?doc=create-server-pool "Create Server Pool")
      * [ Add/Remove member to/from Server Pool ](https://fptcloud.com/en/documents/65101/?doc=add/remove-member "Add/Remove member to/from Server Pool")
      * [ Update health check configuration ](https://fptcloud.com/en/documents/65101/?doc=Update-health-check-configuration "Update health check configuration")
    * [ Manage SSL Certificate ](https://fptcloud.com/en/documents/65101/?doc=manage-ssl-certificate "Manage SSL Certificate")
      * [ Import SSL Certificate ](https://fptcloud.com/en/documents/65101/?doc=import-ssl-certificate "Import SSL Certificate")
      * [ Delete SSL Certificate ](https://fptcloud.com/en/documents/65101/?doc=delete-ssl-certificate "Delete SSL Certificate")
...
Manage Server pool
  * 
  * [ ](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ffptcloud.com%2Fen%2Fdocuments%2F65101%2F "Load Balancer")
  * [ ](https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ffptcloud.com%2Fen%2Fdocuments%2F65101%2F "Load Balancer")
  * [ ](https://twitter.com/share?text=&url=https%3A%2F%2Ffptcloud.com%2Fen%2Fdocuments%2F65101%2F "Load Balancer")

* * *
[ Previous Configure allow IP/CIDR ](https://fptcloud.com/en/documents/65101/?doc=Allow-IP-CIDR "Configure allow IP/CIDR") [ Next Create Server Pool ](https://fptcloud.com/en/documents/65101/?doc=create-server-pool "Create Server Pool")
