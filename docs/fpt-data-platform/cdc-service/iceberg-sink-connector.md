...
**Create a connector with Type: sink, Database: Iceberg**
...
**Step 3:** On the **CDC service** detail screen > Select the **Connectors** tab > click **Create a connector** ![image-1](images/iceberg-sink-connector/img-001.png)
...
Note: The connector name may contain lowercase letters a-z or digits 0-9. Spaces are not allowed; use "-" as a separator instead.
  ...
  * **Database** (required): select **Iceberg** ![image-2](images/iceberg-sink-connector/img-002.png)
...
Enter the following information:
  ...
  * **Topics** (required): select the topics whose data is sent from the source connector ![image-3](images/iceberg-sink-connector/img-003.png)
...
Enter the following information:
  ...
  * **Mode**: Connector behavior when a message cannot be processed
    ...
    * **None**: The Connector will skip messages that cannot be sinked into Iceberg

    * **All**: Error messages will be sent to the specified topic ![image-4](images/iceberg-sink-connector/img-004.png)

**Step 7:** Click **Next** to proceed to the **Review** screen ![image-5](images/iceberg-sink-connector/img-005.png)
