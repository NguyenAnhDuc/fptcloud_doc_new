...
**Create a connector with Type: sink, Database: MariaDB**
...
**Step 3:** On the **CDC service** detail screen > Select the **Connectors** tab > click **Create a connector** ![image-1](images/mariadb-sink-connector/img-001.png)
...
Note: The connector name may contain lowercase letters a-z or digits 0-9. Spaces are not allowed; use "-" as a separator instead.
  ...
  * **Database** (required): select **MariaDB** ![image-2](images/mariadb-sink-connector/img-002.png)
...
Fill in the **Properties** screen information
  ...
  * When **Manual configuration** is selected — fill in:
    ...
    * **Topics** (required): List of topics the Connector will consume and sink data into the target database, separated by "," ![image-3](images/mariadb-sink-connector/img-003.png)
  ...
  * When **From Database Engine** is selected — fill in:
    ...
    * **Topics** (required): List of topics the Connector will consume and sink data into the target database, separated by "," ![image-4](images/mariadb-sink-connector/img-004.png)
...
**Step 6:** Click **Next** to proceed to the **Additional Properties** screen
  ...
  * Enter the following information:
    ...
    * **All**: Error messages will be sent to the specified topic ![image-5](images/mariadb-sink-connector/img-005.png)

**Step 7**: Click **Next** to proceed to the **Review** screen ![image-6](images/mariadb-sink-connector/img-006.png)
