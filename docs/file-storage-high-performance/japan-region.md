...
FPT Container 
  ...
  * [ ![](/img/migrated/settings-131ed42a.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/en/documents/file-storage-high-performance-2/?doc=initial-setup "Initial Setup")
  * [ ![](/img/migrated/icon-networking-419c349e.png) Tutorials ](javascript: "Tutorials")
    * [ Vietnam Region ](https://fptcloud.com/en/documents/file-storage-high-performance-2/?doc=vietnam-region "Vietnam Region")
      * [ MountPoint Management ](https://fptcloud.com/en/documents/file-storage-high-performance-2/?doc=mountpoint-management "MountPoint Management")
      * [ Using File Storage – High Performance on Baremetal (GPU Server) ](https://fptcloud.com/en/documents/file-storage-high-performance-2/?doc=vn-using-file-storage-high-performance-on-baremetal-gpu-server "Using File Storage – High Performance on Baremetal \(GPU Server\)")
      * [ Using File Storage – High Performance on Kubernetes (K8S Cluster) ](https://fptcloud.com/en/documents/file-storage-high-performance-2/?doc=using-file-storage-high-performance-on-kubernetes-k8s-cluster "Using File Storage – High Performance on Kubernetes \(K8S Cluster\)")
    * [ Japan Region ](https://fptcloud.com/en/documents/file-storage-high-performance-2/?doc=japan-region "Japan Region")
      * [ Using File Storage – High Performance on Baremetal (GPU Server) ](https://fptcloud.com/en/documents/file-storage-high-performance-2/?doc=japan-using-file-storage-high-performance-on-baremetal-gpu-server "Using File Storage – High Performance on Baremetal \(GPU Server\)")
...
Japan Region
  * 
  * [ ](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ffptcloud.com%2Fen%2Fdocuments%2Ffile-storage-high-performance-2%2F "File Storage – High Performance")
  * [ ](https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ffptcloud.com%2Fen%2Fdocuments%2Ffile-storage-high-performance-2%2F "File Storage – High Performance")
  * [ ](https://twitter.com/share?text=&url=https%3A%2F%2Ffptcloud.com%2Fen%2Fdocuments%2Ffile-storage-high-performance-2%2F "File Storage – High Performance")

* * *
[ Previous Using File Storage – High Performance on Kubernetes (K8S Cluster) ](https://fptcloud.com/en/documents/file-storage-high-performance-2/?doc=using-file-storage-high-performance-on-kubernetes-k8s-cluster "Using File Storage – High Performance on Kubernetes \(K8S Cluster\)") [ Next Using File Storage – High Performance on Baremetal (GPU Server) ](https://fptcloud.com/en/documents/file-storage-high-performance-2/?doc=japan-using-file-storage-high-performance-on-baremetal-gpu-server "Using File Storage – High Performance on Baremetal \(GPU Server\)")
