...
# DdoS Protection
  ...
  * [ ![](/img/migrated/quick-start-aa7e143d.png) Quick start (Quick Starts) ](javascript: "Quick start \(Quick Starts\)")
DdoS Protection
...
DdoS Protection
##  Introduction 
Tính năng DDoS Protection giúp hệ thống phát hiện, ngăn chặn and phản ứng tự động with the cuộc tấn công from chối service phân tán (DDoS), nhằm đảm bảo service luôn sẵn sàng and ổn định.
  * Monitor thời gian thực: Tự động theo dõi lưu lượng and hành vi bất thường trên hệ thống network.
  * Activate tự động công cụ phòng thủ: Tự động kích hoạt cơ chế lọc lưu lượng and chống DDoS when có hành vi tấn công
  * Báo cáo minh bạch: Cung cấp report theo thời gian thực and định kỳ for khách hàng.
