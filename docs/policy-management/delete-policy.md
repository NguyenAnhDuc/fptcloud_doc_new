...
**Step 1** : Ở menu chọn **Policy Management** , sau đó chọn **Actions** > chọn **Delete policy**
[![file](/img/migrated/image-1719821755207-81a8dba8.png)](/img/migrated/image-1719821755207-81a8dba8.png)
**Step 2** : Một hộp thoại cảnh báo xuất hiện nhằm xác nhận lại hành động. Người dùng xác nhận bằng cách nhấn vào nút **Delete policy**.
