...
**Step 1** : Ở menu chọn **Security Group** , sau đó chọn **Create security group**
...
**Step 3** : Fill in các thông tin tương ứng của rule. 
  * **Type** : SSH
  * **Sources** : All IPv4

[![file](/img/migrated/image-1719821264190-f0a280a9.png)](/img/migrated/image-1719821264190-f0a280a9.png)
**Step 4** : Nhấn Create security group. Hệ thống sẽ báo lỗi: hành động bị cấm bởi policy
