...
**Step 2** : Nhập các thông tin yêu cầu của hệ thống:
...
**Step 3** : Select **Create policy**. Hệ thống sẽ tiến hành khởi tạo Policy mới sẽ được hiển thị ở trang **Policy Management**.
