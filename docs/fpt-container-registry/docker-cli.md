...
FPT Container 
  ...
  * [ ![](/img/migrated/settings-3-361d08a2.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/en/documents/fpt-container-registry/?doc=initial-setup "Initial Setup")
  * [ ![](/img/migrated/icon-networking-2-7937c00e.png) Tutorials ](javascript: "Tutorials")
    * [ Enabling FPT Container Registry Service ](https://fptcloud.com/en/documents/fpt-container-registry/?doc=enabling-fpt-container-registry-service "Enabling FPT Container Registry Service")
    * [ Docker CLI ](https://fptcloud.com/en/documents/fpt-container-registry/?doc=docker-cli "Docker CLI")
      * [ Docker Login ](https://fptcloud.com/en/documents/fpt-container-registry/?doc=docker-login "Docker Login")
      * [ Tagging and Pushing Images to FPT Container Registry ](https://fptcloud.com/en/documents/fpt-container-registry/?doc=tagging-and-pushing-images-to-fpt-container-registry "Tagging and Pushing Images to FPT Container Registry")
      * [ Pulling Docker Image from FPT Container Registry to local ](https://fptcloud.com/en/documents/fpt-container-registry/?doc=pulling-docker-image-from-fpt-container-registry-to-local "Pulling Docker Image from FPT Container Registry to local")
    * [ Managing Repositories on the FPT Cloud Portal ](https://fptcloud.com/en/documents/fpt-container-registry/?doc=managing-repositories-on-the-fpt-cloud-portal "Managing Repositories on the FPT Cloud Portal")
      * [ View Repositories List ](https://fptcloud.com/en/documents/fpt-container-registry/?doc=view-repositories-list "View Repositories List")
      * [ Deleting an Image or Artifact in a Repository ](https://fptcloud.com/en/documents/fpt-container-registry/?doc=deleting-an-image-or-artifact-in-a-repository "Deleting an Image or Artifact in a Repository")
...
Docker CLI
  * 
  * [ ](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ffptcloud.com%2Fen%2Fdocuments%2Ffpt-container-registry%2F "FPT Container Registry")
  * [ ](https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ffptcloud.com%2Fen%2Fdocuments%2Ffpt-container-registry%2F "FPT Container Registry")
  * [ ](https://twitter.com/share?text=&url=https%3A%2F%2Ffptcloud.com%2Fen%2Fdocuments%2Ffpt-container-registry%2F "FPT Container Registry")

* * *
[ Previous Enabling FPT Container Registry Service ](https://fptcloud.com/en/documents/fpt-container-registry/?doc=enabling-fpt-container-registry-service "Enabling FPT Container Registry Service") [ Next Docker Login ](https://fptcloud.com/en/documents/fpt-container-registry/?doc=docker-login "Docker Login")
