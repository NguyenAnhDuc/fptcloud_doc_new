...
FPT Container 
  ...
  * [ ![](/img/migrated/tai-xuong-dde62ca2.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/en/documents/create-vpc/?doc=initial-setup-en "Initial Setup")
  * [ ![](/img/migrated/Favicon@2x-8-1561f749.png) Quick Starts ](javascript: "Quick Starts")
    * [ ](../create-vpc/index.md)
    * [ Rename VPC ](https://fptcloud.com/en/documents/create-vpc/?doc=rename-vpc-en "Rename VPC")
    * [ Record Activity log and Recent task status ](https://fptcloud.com/en/documents/create-vpc/?doc=view-activity-en "Record Activity log and Recent task status")
...
Create VPC
The VPC initialization function allows users to actively initialize a VPC on the Unify Portal
01Initial Setup 
  * [ Initial Setup ](https://fptcloud.com/en/documents/create-vpc/?doc=initial-setup-en "Initial Setup")
