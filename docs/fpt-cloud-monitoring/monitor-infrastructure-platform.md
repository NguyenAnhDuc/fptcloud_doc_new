...
**Step 4** : Trong tab **Infrastructure services** , hiển thị danh sách các dịch vụ infrastructure đang sẵn có, click vào một dịch vụ bạn muốn monitor.
[![Alt text](/img/migrated/Picture8-2-102fff27.png)](/img/migrated/Picture8-2-102fff27.png)
**Step 5**. Click **Manual** và sau đó làm theo hướng dẫn.
...
**Step 2** : Click **Auto**. Tại đây, hiển thị bảng danh sách các cụm cluster **Dedicated** và **Managed**. 
