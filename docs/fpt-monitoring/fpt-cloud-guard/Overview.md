...
See [Initial setup](/docs/fpt-monitoring/fpt-cloud-guard/Initial-Setup) to create your FPT Cloud account and log in to FPT Portal before creating your first alert.
