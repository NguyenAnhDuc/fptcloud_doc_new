...
description: "You can create a new incident in two ways, either directly from the system through the **Declare Incident** feature, or "
...
**Step 3** : Set up **Incoming webhook** as mentioned [here](/docs/en/fpt-monitoring/incident-management/incoming-webhook)
