...
- Then integrate the corresponding dashboard templates — see [3.1. Integrate dashboard template](/docs/fpt-monitoring/fpt-cloud-monitoring/huong-dan-su-dung-grafana/tich-hop-dashboard-template).
