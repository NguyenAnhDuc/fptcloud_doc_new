...
### **Step 2: Cấu hình thông tin Backup Job**
...
**Step 2:** Tại dòng Backup Job cần chạy, trong cột **Action** , chọn **Start**
**Step 3:** Một hộp thoại xác nhận sẽ hiển thị. Chọn **Start** để tiến hành chạy job.
...
### Cách xóa Backup Job
**Step 1:** Vào **Backup → Backup Management**
**Step 2:** Tại job cần xóa, trong cột **Action** , chọn **Delete**
**Step 3:** Một hộp thoại cảnh báo sẽ xuất hiện, yêu cầu xác nhận. Chọn **Delete** để xóa hoàn toàn Backup Job.
