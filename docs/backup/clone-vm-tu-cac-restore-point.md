...
### **Step 1: Mở Quản Lý Backup & Recovery**
  1. Access interface quản trị of **FPT Backup**.
  2. Chọn menu **Backup & Recovery** > **Backup & Recovery Management**.
  3. Mở tab **Restore** to xem list the VM is is bảo vệ and số lượng Restore Point has been tạo successfully.

### **Step 2: Chọn VM need to Clone**
  1. Xác định VM need to thực hiện clone from list has been displayed.
...
### **Step 3: Create VM Mới from Restore Point**
  ...
  2. Follow these steps: 
     ...
     * Click the button **Restore New Instance** to create VM mới.

### **Step 4: Xác Nhận and Tiến Hành Clone**
  1. Một hộp thoại xác nhận will hiện lên, yêu cầu you kiểm tra lại information.
  2. Select **Restore Instance** to confirm and bắt đầu quá trình tạo VM.

## **Save Ý Quan Trọng**
  * **Configure VM mới:** Sau when tạo, you can tùy chỉnh RAM, CPU and Network of VM mới theo nhu cầu.
  * **Thời gian hoàn thành:** Quá trình tạo VM from Restore Point thường mất andi phút đến andi giờ, tùy thuộc ando dung lượng dữ liệu.
