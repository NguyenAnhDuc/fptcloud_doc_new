...
Sau khi tạo thành công, role mới sẽ xuất hiện trong danh sách quản lý với trạng thái **Active** và sẵn sàng để cấp quyền cho người dùng. Hướng dẫn cấp quyền vui lòng tham khảo tại mục [Quản lý User Group](/docs/fpt-database-engine/managed-fpt-database-engines-new/)/.
