...
To manage the FPT Database Engine service, please refer to the detailed instructions in the [Activate FPT Database Engine](/docs/fpt-database-engine/managed-fpt-database-engines-new/)/ and [Deactivate FPT Database Engine](/docs/fpt-database-engine/managed-fpt-database-engines-new/)/ sections.
