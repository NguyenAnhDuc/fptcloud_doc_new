...
**Step 1** : Truy cập portal FPT Cloud [console.fptcloud.com](https://console.fptcloud.com/), chọn mục Kubernetes, bấm vào cluster cần thay đổi, mục Node Pools, bấm vào biểu tượng "Edit Workers”. 
[![](/img/migrated/Picture8-2-eb37b7ec.png)](/img/migrated/Picture8-2-eb37b7ec.png)
**Step 2** : Ngoài các thông tin cấu hình cho Worker Group thông thường, cần chọn cấu hình cho GPU: 
...
**Step 3** : Kiểm tra lại các thông tin khởi tạo và Ấn Save. 
**Step 4** : Theo dõi trạng thái khởi tạo thêm Worker Group vào cụm Kubernetes. Sau khi trạng thái Successed (Running) thì tiến hành sử dụng, triển khai ứng dụng.
