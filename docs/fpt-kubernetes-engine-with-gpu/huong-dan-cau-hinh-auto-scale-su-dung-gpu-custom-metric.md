...
### Step 1: Cài đặt the gói kube-prometheus-stack and prometheus-adapter
  * Sử dụng service FPT App Catalog 
    * Sử dụng service FPT App Catalog, tạo App Catalog sau that chọn mục Connect Cluster to connect đến Cluster GPU.
...
```
  ...
  * Sau when deploy xong gói kube-prometheus-stack, ta tiếp tục deploy prometheus- adapter, tuy nhiên ta need to thay đổi values of gói to trỏ đúng prometheus service of kube-prometheus-stack. Ví dụ with namespace of kube-prometheus-stack ta đặt là prometheus thì values ta need to điền ando là:
...
Tham khảo thêm document of NVIDA về the DCGM metric [link](https://docs.nvidia.com/datacenter/dcgm/1.6/dcgm-api/group__dcgmFieldIdentifiers.html)
