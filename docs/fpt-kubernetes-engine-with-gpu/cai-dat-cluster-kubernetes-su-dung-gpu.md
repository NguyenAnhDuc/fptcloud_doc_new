...
**Step 2:** Nhập thông tin cơ bản của cụm cluster sau đó click button 
...
⚠️ Note: Nếu cần bảo mật cao, khách hàng nên hạn chế CIDR chỉ cho phép các dải IP nội bộ thay vì 0.0.0.0/0. 
**Step 3** : Nhập vào thông tin cụm Kubernetes cần khởi tạo. Ngoài các thông tin khởi tạo cho Kubernetes thông thường, cần chọn cấu hình cho GPU trong Worker Group: 
...
**Step 4** : Ấn Create và kiểm tra lại các thông tin khởi tạo. 
**Step 5** : Theo dõi trạng thái khởi tạo cụm Kubernetes. Sau khi trạng thái Successed (Running) thì tiến hành sử dụng, triển khai ứng dụng.
2️⃣ **GPU H100 SXM5**
**Step 1:** Trên menu của FPT Portal chọn **Containers** >**Kubernetes** > **Create a Kubernetes Engine**.
...
**Step 3:** Cấu hình Nodes Pool theo nhu cầu sử dụng sau đó click button 
