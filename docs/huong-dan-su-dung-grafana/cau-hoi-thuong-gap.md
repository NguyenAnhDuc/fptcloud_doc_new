...
### 1. Sau when tích hợp dashboard template, if quay lại màn Dashboard nhưng chưa thấy displayed template has been tích hợp?

Vui lòng thử refresh lại trang.

### 2. Hướng dẫn kiểm tra when gặp trường hợp sau a thời gian sử dụng Monitoring, metric/logs không displayed trên Grafana Dashboard
