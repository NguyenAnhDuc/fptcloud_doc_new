...
**Step 1:** Truy cập ando console portal, trên menu chọn service Monitoring

**Step 2:** Vào trang chi tiết workspace that, chọn tab Quota and Package

**Step 3:** Check thông tin usage time series/log/trace

_Interface displayed as follows_
...
- **Trường hợp 1:** Workspace has been sử dụng hết quota for phép of gói hiện tại. Khi that, metric/logs will cannot tiếp tục is đẩy về Grafana Dashboard.
  Bạn cần upgrade gói service to tiếp tục sử dụng Monitoring.
