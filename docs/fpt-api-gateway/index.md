...
FPT Storage 
  ...
  * [ ![](/img/migrated/initial-setup-714537aa.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/documents/fpt-api-gateway/?doc=initial-setup "Initial Setup")
  * [ ![](/img/migrated/icon-networking-2-09c1ef04.png) Hướng dẫn chi tiết (Tutorial)  ](javascript: "Hướng dẫn chi tiết \(Tutorial\) ")
    * [ Tạo API Gateway ](https://fptcloud.com/documents/fpt-api-gateway/?doc=tao-api-gateway "Tạo API Gateway")
    * [ Xem thông tin API Gateway ](https://fptcloud.com/documents/fpt-api-gateway/?doc=xem-thong-tin-api-gateway "Xem thông tin API Gateway")
    * [ Xóa API Gateway ](https://fptcloud.com/documents/fpt-api-gateway/?doc=xoa-api-gateway "Xóa API Gateway")
