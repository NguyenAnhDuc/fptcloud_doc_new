...
**Step 3:** Trong form tạo **API Gateway,** nhập thông tin màn **Basic Information** : 
...
Enter thông tin sau: 
  * **Launch Configuration**
    ...
    * **Worker nodes** (required): Enter số lượng nodes (from 1 to 10). 
[![Hình ảnh](/img/migrated/SCR-20250924-nnrh-2a698b21.png)](/img/migrated/SCR-20250924-nnrh-2a698b21.png)
  * **Autoscaling configuration:**
    * **Enabled (required)** : Bật/tắt feature autoscaling for API Gateway cluster. 
      * Default: **Enabled**. 
      * Nếu **Disabled** → the trường cấu hình from _Minimum Nodes_ to _Memory scale-out threshold_ will không displayed. 
    ...
    * **CPU scale-out threshold (%)**(required): Ngưỡng phần trăm sử dụng CPU trung bình of node. 
      * Default: 80%. 
      * Nếu vượt ngưỡng, hệ thống will xem xét scale out 
      * Statistic: Average. 
    * **Memory scale-out threshold (%)**(required): Ngưỡng phần trăm sử dụng RAM trung bình of node. 
      * Default: 80%. 
      * Nếu vượt ngưỡng, hệ thống will kích hoạt scale out. 
      * Statistic: Average. 
      * Operator: greater than. 
[![Hình ảnh](/img/migrated/SCR-20250924-nogx-60a8a374.png)](/img/migrated/SCR-20250924-nogx-60a8a374.png)
    * **Etcd:** Self-managed ETCD: Cho phép user lựa chọn tự cài đặt ETCD or sử dụng ETCD is hệ thống quản lý. 
...
[![Hình ảnh](/img/migrated/SCR-20250924-nonz-76855a0c.png)](/img/migrated/SCR-20250924-nonz-76855a0c.png)
      * Khi **Checked** : 
        * Hiển thị the trường to nhập thông tin ETCD thủ công: 
...
**Step 7** : Check thông tin nhập sau that nhấn **Create** to hoàn thành việc khởi tạo **API Gateway**
