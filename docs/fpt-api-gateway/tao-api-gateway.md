...
**Step 2:** Click **Create an API Gateway cluster** > hiển thị màn hình **Create API Gateway**
...
**Step 4:** Click **Next Step** để chuyển sang màn nhập thông tin **Details**
Nhập thông tin sau: 
...
**Step 5:** Click **Next Step** để chuyển sang màn **Service Configuration**
...
**Step 6:** Click **Next Step** để chuyển sang màn **Review and Create**
...
**Step 7** : Check thông tin nhập sau đó nhấn **Create** để hoàn thành việc khởi tạo **API Gateway**
