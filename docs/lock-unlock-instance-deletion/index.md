...
FPT Storage 
  ...
  * [ ![](/img/migrated/settings-2-d6cac700.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/documents/lock-unlock-instance-deletion/?doc=initial-setup "Initial Setup")
  * [ ![](/img/migrated/icon-networking-2-7937c00e.png) Hướng dẫn nhanh (Quick Starts) ](javascript: "Hướng dẫn nhanh \(Quick Starts\)")
    * [ Lock Instance Deletion ](https://fptcloud.com/documents/lock-unlock-instance-deletion/?doc=lock-instance-deletion "Lock Instance Deletion")
    * [ Unlock Instance Deletion ](https://fptcloud.com/documents/lock-unlock-instance-deletion/?doc=unlock-instance-deletion "Unlock Instance Deletion")
