...
This guide explains how to connect VPNaaS between the VMware and OPS platforms on the Unify portal.
  * [Step 1: Configure VPN on OpenStack](/docs/fpt-network/vpn-site-to-site/)/
  * [Step 2: Configure VPN on VMware Cloud](/docs/fpt-network/vpn-site-to-site/)/
  * [Step 3: Verify the connection](/docs/fpt-network/vpn-site-to-site/)/
