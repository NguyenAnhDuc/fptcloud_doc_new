...
**This guide explains how to connect VPNaaS between the AWS and OPS platforms on the Unify portal.**
  * [I. Configure VPN Site-to-Site on FCI Cloud](/docs/fpt-network/vpn-site-to-site/)/
  * [II. Configure VPN Site-to-Site on AWS](/docs/fpt-network/vpn-site-to-site/)/
  * [III. Update VPN Site-to-Site configuration on FCI Cloud with the new AWS VPN IP](/docs/fpt-network/vpn-site-to-site/)/
