...
FPT Container 
  ...
  * [ ![](/img/migrated/image-16-c528386f.png) Overview ](javascript: "Overview")
    * [ About FPT Smart Cloud ](https://fptcloud.com/en/documents/model-serving/?doc=about-fci " About FPT Smart Cloud")
    * [ General introduction Model serving ](https://fptcloud.com/en/documents/model-serving/?doc=general-intro-model-serving "General introduction Model serving")
    * [ Terms & Definitions ](https://fptcloud.com/en/documents/model-serving/?doc=terms-definitions "Terms & Definitions")
  * [ ![](/img/migrated/Getting-started-2-75ad1c66.png) Server deployment ](javascript: "Server deployment")
    * [ Initial Setup ](https://fptcloud.com/en/documents/model-serving/?doc=initial-set-up "Initial Setup")
    * [ Create a New Model Serving Deployment ](https://fptcloud.com/en/documents/model-serving/?doc=create-a-new-model-serving-deployment "Create a New Model Serving Deployment")
  * [ ![](/img/migrated/server-c9407840.png) Deployment Management ](javascript: "Deployment Management")
    * [ Deployment List ](https://fptcloud.com/en/documents/model-serving/?doc=deployment-list "Deployment List")
    * [ Status and Actions for a Deployment ](https://fptcloud.com/en/documents/model-serving/?doc=status-actions-deployment "Status and Actions for a Deployment")
    * [ Detailed Configuration Information for a Deployment ](https://fptcloud.com/en/documents/model-serving/?doc=detailed-configuration-information "Detailed Configuration Information for a Deployment")
    * [ Deployment Configuration Information ](https://fptcloud.com/en/documents/model-serving/?doc=deployment-configuration-information "Deployment Configuration Information")
    * [ Traffic Setting Configuration Information ](https://fptcloud.com/en/documents/model-serving/?doc=traffic-setting-configuration-information "Traffic Setting Configuration Information")
    * [ Delete a deployment ](https://fptcloud.com/en/documents/model-serving/?doc=delete-a-deployment "Delete a deployment")
