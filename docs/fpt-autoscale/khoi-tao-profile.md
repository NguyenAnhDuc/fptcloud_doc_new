...
##  **Step 1** : Truy cập trang **Autoscaling > Autoscale Profile**. Chọn **Create profile**.
...
##  **Step 2** : Cấu hình các thông số kỹ thuật.
...
Example: Với đoạn script mẫu này, các node trong group sẽ cài đặt các gói cần thiết, sau đó clone một static website từ github và khởi động máy chủ nginx. Để xem kết quả, người dùng có thể thực hiện allocate Floating IP cho node và thực hiện truy cập vào website thông qua Floating IP đó.
...
##  **Step 3** : Chọn **Create profile** để xác nhận.
