...
##  **Step 1:** Truy cập trang **Autoscaling > Autoscale Group**. Select **Create group**.
...
**Group name** : Enter tên group sao for dễ quản lý nhất. Tên phải from 6 to 20 kí tự, chỉ includes kí tự chữ cái latin, số, and dấu gạch dưới.
**Group profile** : Chọn profile has been tạo trước that làm tham chiếu cơ sở for group.
**Desired capacity** : Số node mong muốn khởi tạo in group, bắt buộc phải lớn hơn or bằng **Min size** and nhỏ hơn or bằng **Max size** of group. Đây là số lượng node will is khởi tạo dựa trên profile has been chọn when group is khởi tạo.
...
System will thực hiện kiểm tra lại thông tin về hạn ngạch tài nguyên còn lại in VPC and tạo group. Group is tạo will displayed in trang danh sách groups with status **Creating**.
...
Có thể xem thông tin chi tiết of group bằng theh click ando tên group corresponding trên danh sách:
