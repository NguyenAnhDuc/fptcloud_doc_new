...
##  **Step 1:** Truy cập trang **Autoscaling > Autoscale Policy**. Trên dòng corresponding with policy cần xóa, chọn biểu tượng **delete**.
...
##  **Step 2:** Một hộp thoại will appears. Nếu tên policy cần xóa là chính xác, chọn **Delete policy** to xác nhận. Ngược lại, chọn **Cancel** to hủy thao tác.
