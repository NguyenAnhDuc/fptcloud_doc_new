...
##  **Step 1:** Truy cập trang **Autoscaling > Autoscale Policy**. Trên dòng tương ứng với policy cần xóa, chọn biểu tượng **delete**.
...
##  **Step 2:** Một hộp thoại sẽ xuất hiện. Nếu tên policy cần xóa là chính xác, chọn **Delete policy** để xác nhận. Ngược lại, chọn **Cancel** để hủy thao tác.
