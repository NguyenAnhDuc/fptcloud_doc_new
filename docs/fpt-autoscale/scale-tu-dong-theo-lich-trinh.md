...
###  **Bước 3:** Một hộp thoại sẽ xuất hiện, thực hiện cấu hình the information.
...
**Note:**
  * Nếu Start Date là ngày hiện tại, From Time must lớn hơn thời điểm hiện tại.
  * To Time must lớn hơn From Time ít nhất 30 phút.
...
Hệ thống sẽ thực hiện kiểm tra lại information và thực hiện tạo lịch for Autoscale Group.
[![](/img/migrated/placeholder.png)](/img/migrated/placeholder.png)
**Name** : Tên lịch trình.
...
[![open group details](/img/migrated/Screenshot-2024-10-02-042416-72202578.png)](/img/migrated/Screenshot-2024-10-02-042416-72202578.png)
###  **Bước 2:** Chuyển to tab **Schedule**. Trên dòng chứa lịch trình need to xóa, click biểu tượng **Action menu**.
...
###  **Bước 3:** Trong menu, select **Delete**.
...
###  **Bước 4:** Một hộp thoại sẽ xuất hiện. Nếu tên lịch need to xóa là chính xác, foṛn **Delete** to xác nhận.
