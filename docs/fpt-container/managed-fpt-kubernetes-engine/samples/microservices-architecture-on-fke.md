...
### 10. Backup:
  * Set a [Backup Job (Dedicated)](/docs/fpt-container/dedicated-fpt-kubernetes-engine/)/ as instructed. Users need to perform data backup on PVC (if any). You can back up to a VM and then perform VM backup using the **FPT Cloud Backup & Recovery** solution.
