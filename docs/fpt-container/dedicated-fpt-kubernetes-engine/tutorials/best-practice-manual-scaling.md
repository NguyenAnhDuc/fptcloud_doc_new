...
D-FKE supports manual scale-in and scale-out of worker nodes. For portal console instructions, see the [user guide](/docs/fpt-container/dedicated-fpt-kubernetes-engine/)/.
...
- Press the retry action to re-run the process. See [here](/docs/fpt-container/dedicated-fpt-kubernetes-engine/)/ for details.
