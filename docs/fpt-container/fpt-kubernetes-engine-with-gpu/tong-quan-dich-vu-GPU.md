...
title: "GPU Service Overview on Kubernetes FPT Cloud"
description: "FPT Cloud provides Kubernetes with NVIDIA GPU support with the following key features:"
sidebar_label: "GPU Service Overview on Kubernetes FPT Cloud"
sidebar_position: 1
---

# GPU Service Overview on Kubernetes FPT Cloud
...
This guide covers the main features of the GPU service on Kubernetes FPT Cloud, including:
  1. Installing and initializing a Kubernetes cluster with GPU
  2. Adding a worker group with GPU
  3. Modifying a worker group with GPU
  4. Deploying applications using GPU
  5. Using GPU Telemetry
  6. Installing and using drivers
  7. Configuring Auto Scale using GPU Custom Metric
  8. Configuring Auto Scale using KEDA and Prometheus
  9. Using GPU Sharing modes
