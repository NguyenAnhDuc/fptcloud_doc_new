...
**Step 1:** Cấu hình **Firewall Address** (định nghĩa các IP Address sử dụng):  
...
[![Userguide Fortigate FPT NGFW 2022 10](/img/migrated/Userguide-Fortigate-FPT-NGFW-2022-10-102-cfc82ca1.png)](/img/migrated/Userguide-Fortigate-FPT-NGFW-2022-10-102-cfc82ca1.png)
  ...
  * **Source:** Select **Address** đã tạo ở bước 1.
  * **Destination:** Select **ALL** (hoặc có thể giới hạn các destionation bằng cách chọn nhiều destination đã tạo).
  * **Service:** Select **ALL**.
