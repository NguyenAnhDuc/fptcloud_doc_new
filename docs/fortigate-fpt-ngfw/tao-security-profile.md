...
**Step 2:** Tạo mới một Profile hoặc có thể dùng Profile có sẵn của **Fortigate**.  
...
**Step 2:** Tạo mới một Profile hoặc có thể dùng Profile có sẵn của Fortigate để chặn truy cập các trang mạng xã hội.
...
**Step 3:** Sử dụng các signature có sẵn hoặc tạo mới **Create New** > **Custom Application Signature**.
...
**Step 2:** Tạo mới một Profile hoặc có thể dùng Profile có sẵn của Fortigate để chặn truy cập đến các C&C server (Botnet).
...
**Step 3:** Sử dụng các IPS signature có sẵn hoặc tạo mới **IPS Signature and Filter** > **Create New.**
...
**Step 2:** Tạo mới một Profile hoặc có thể dùng Profile có sẵn của Fortigate để chặn các cuộc tấn công đến webserver (Sql Injection, Cross Site Scripting)
![Userguide Fortigate FPT NGFW 2022 29](/img/migrated/Userguide-Fortigate-FPT-NGFW-2022-29-102-2ec3dddd.png)
**Step 3:** Bật các signatures **Edit** > **Sql Injection** (Extended), **Cross Site** (Extended)  
