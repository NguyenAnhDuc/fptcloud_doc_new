...
Sau when edit NIC, IP NIC là 132.0.0.70 
...
**Step 2:** Vào file ifcfg-eth0, and sửa thông số: 
...
**Step 5** : Check lại cấu hình ando ping test 
