...
**Step 3:** Phải chuột vào card mạng cần thay đổi Config, chọn propertise 
...
**Step 4** : Thay đổi các thông số theo cấu hình mới – OK 
...
**Step 5:** Check lại các thay đổi và ping thử 
