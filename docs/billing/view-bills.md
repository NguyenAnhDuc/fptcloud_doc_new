...
:::note
To view bills, you must be logged in with the Tenant Owner role or a role that has **view billing** permission. See [Billing permissions](billing-permission.md) for setup instructions.
:::
...
3. Select the [Charges by service](view-bill-charges-by-service.md) tab to view a service-level breakdown, or the [Charges by resource](view-bill-charges-by-resource.md) tab to view a resource-level breakdown.
