...
FPT Storage 
  ...
  * [ ![](/img/migrated/icon-networking-1-2d28802b.png) Hướng dẫn nhanh (Quick Starts) ](javascript: "Hướng dẫn nhanh \(Quick Starts\)")
    * [ Xem đối soát theo kỳ hóa đơn ](https://fptcloud.com/documents/billing/?doc=view-bills "Xem đối soát theo kỳ hóa đơn")
      * [ Xem đối soát theo tên dịch vụ (Charges by service) ](https://fptcloud.com/documents/billing/?doc=view-bill-charges-by-service "Xem đối soát theo tên dịch vụ \(Charges by service\)")
      * [ Xem đối soát theo tài nguyên sử dụng (Charges by resource) ](https://fptcloud.com/documents/billing/?doc=view-bill-charges-by-resource "Xem đối soát theo tài nguyên sử dụng \(Charges by resource\)")
    * [ Tải file đối soát chi tiết ](https://fptcloud.com/documents/billing/?doc=download-bills "Tải file đối soát chi tiết")
    * [ Phân quyền xem billing ](https://fptcloud.com/documents/billing/?doc=billing-permission "Phân quyền xem billing")
  * [ ![](/img/migrated/question-94737ec1.png) FAQs ](javascript: "FAQs")
    * [ Vì sao tôi không xem được Bill? ](https://fptcloud.com/documents/billing/?doc=question-1 "Vì sao tôi không xem được Bill?")
    * [ Với bill ở kỳ hóa đơn hiện tại, dữ liệu được cập nhật lần gần nhất là lúc nào? ](https://fptcloud.com/documents/billing/?doc=fqas-2 "Với bill ở kỳ hóa đơn hiện tại, dữ liệu được cập nhật lần gần nhất là lúc nào? ")
    * [ Vì sao tôi có nhiều đối soát trong cùng 1 kỳ hóa đơn? ](https://fptcloud.com/documents/billing/?doc=fqas-3 "Vì sao tôi có nhiều đối soát trong cùng 1 kỳ hóa đơn?")
