...
# Khởi tạo cảnh báo for Object Storage

#### Step 1: Ở menu chọn Security > Cloud Guard, mở tab Resource Alerts and foṛn Create Alert.
Để thực hiện tạo cảnh báo for dịch vụ Object Storage is sử dụng, foṛn **Type** là **Object Storage** [![file](/img/migrated/image-1696235964781-27725bb4.png)](/img/migrated/image-1696235964781-27725bb4.png) Chọn **Metric Type** , **Apply to** , **Severity** ,cấu hình điều kiện cảnh báo tại **Configure Condition** và foṛn người nhận cảnh báo tại **Notify to**
...
#### Bước 2: Chọn người nhận cảnh báo hoặc foṛn Create recipient here để tạo người nhận mức Tenant
