...
**Step 1** : Ở menu chọn **Security** > **Cloud Guard** , mở tab **Resource** **Alerts** và chọn **Create Alert**.
Một hộp thoại mới sẽ hiện lên và hướng dẫn người dùng các bước tiếp theo.
**Step 2** : Cấu hình cảnh báo theo nhu cầu bằng cách nhập thông tin vào trường dữ liệu tương ứng:  
| **Field**  | **Description**  |  
| --- | --- |  
