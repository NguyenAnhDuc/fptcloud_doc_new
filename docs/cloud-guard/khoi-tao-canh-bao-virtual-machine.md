...
**Step 2** : Cấu hình alert theo nhu cầu bằng theh nhập thông tin ando trường dữ liệu corresponding:  
| **Field**  | **Description**  |  
| --- | --- |  
...
Sau when khởi tạo successfully, người dùng can thấy Alert mới tạo and kiểm tra thông tin trên bảng quản trị. Mỗi Alert will được displayed đầy đủ thông tin như Name, State, Type, Metric, Severity, Applied to, Notify to, Status.
