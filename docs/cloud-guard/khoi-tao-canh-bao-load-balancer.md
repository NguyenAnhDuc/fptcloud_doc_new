...
# Khởi tạo cảnh báo for Load Balancer

#### Step 1: Ở menu chọn Security > Cloud Guard, mở tab Resource Alerts and foṛn Create Alert.
Để thực hiện tạo cảnh báo for dịch vụ Load balancer is sử dụng, foṛn **Type** là **Load Balancer** [![file](/img/migrated/image-1722327850097-b58a81be.png)](/img/migrated/image-1722327850097-b58a81be.png) Chọn **Metric Type** , **Apply to** , **Severity** , cấu hình điều kiện cảnh báo tại **Configure Condition** và foṛn người nhận cảnh báo tại **Notify to**
FPT Cloud Guard hỗ trợ đặt cảnh báo for những Load balancer metric as follows:  
...
Nếu chưa có người nhận for cảnh báo Load balancer, nhấn Create recipient here để tạo mới người nhận mức VPC as follows: [![file](/img/migrated/image-1722328406388-fa58b299.png)](/img/migrated/image-1722328406388-fa58b299.png)
