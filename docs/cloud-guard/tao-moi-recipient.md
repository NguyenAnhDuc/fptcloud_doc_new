...
**Step 1** : Ở menu chọn **Cloud Guard** > **Alert** , mở tab **Recipients** và chọn **Create Recipient**.
...
**Step 2** : Nhập các thông tin theo yêu cầu**:**
...
**Step 3:** Khai báo **Address** nhận cảnh báo tương ứng với Type đã chọn, đây là địa chỉ hệ thống sẽ gửi thông báo đến khi mức sử dụng của tài nguyên vượt ngưỡng mà người dùng tùy chỉnh khi tạo mới Alert.
...
**Step 4** : Khi đã nhập đầy đủ thông tin, chọn **Create**.
