...
Sử dụng to setup the policy and rule nhằm lựa chọn the event to chặn or ghi lại ando in log tại phần View Logs – Detection Logs [![file](/img/migrated/image-1714115314016-153567a2.png)](/img/migrated/image-1714115314016-153567a2.png)
...
Policy List: Thực hiện chặn or ghi lại the event dựa trên policy. Wapples có 7 policies cơ bản includes:
  ...
  4. **Advanced & PCI-DSS Security Policy:**
     * Thực hiện hành động ứng phó dựa trên setup
     * Cho phép kiểm tra a rule cụ thể bằng theh nhấp ando policy corresponding
     * Phản hồi lại dựa trên counter measure is setup
  5. **Block All Traffic**
...
[![file](/img/migrated/image-1714115330781-fdfd7e91.png)](/img/migrated/image-1714115330781-fdfd7e91.png)
  ...
  * Upload rule has been is setup in [Security Settings] - [Pattern Storage] - [Snort].
  ...
  * Upload rule has been is setup in [Security Settings] - [Security Patch] - [Threat Protection Profile].
