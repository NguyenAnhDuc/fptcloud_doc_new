...
FPT Container 
  ...
  * [ ![](/img/migrated/settings-1-6a78d6d4.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=initial-setup "Initial Setup")
  * [ ![](/img/migrated/icon-networking-1-ee48cba8.png) Tutorials ](javascript: "Tutorials")
    * [ Managing K8s Cluster ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=managing-k8s-cluster "Managing K8s Cluster")
      * [ Create a new K8s Cluster ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=create-new-k8s-cluster "Create a new K8s Cluster")
      * [ List Created Clusters ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=list-created-clusters "List Created Clusters")
      * [ Access Cluster’s Detail Informations ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=access-clusters-detail-information "Access Cluster’s Detail Informations")
      * [ Get Cluster's Access Information ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=get-cluster-access-information "Get Cluster's Access Information")
      * [ Delete a K8s Cluster ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=delete-k8s-cluster "Delete a K8s Cluster")
      * [ Stop a K8s Cluster ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=stop-k8s-cluster "Stop a K8s Cluster")
      * [ Start a K8s Cluster ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=start-k8s-cluster "Start a K8s Cluster")
    * [ Changing Cluster's Configuration ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=changing-cluster-configuration "Changing Cluster's Configuration")
      * [ Scale Worker Nodes ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=scale-worker-nodes "Scale Worker Nodes")
      * [ Change Nodes' Configuration ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=change-nodes-configuration "Change Nodes' Configuration")
      * [ Change NFS Server's Configuration ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=change-nfs-server-configuration "Change NFS Server's Configuration")
      * [ Increase Storage Size of Nodes ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=increase-storage-size-of-nodes "Increase Storage Size of Nodes")
      * [ Increase Storage Size of NFS Server ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=increase-storage-size-of-nfs-server "Increase Storage Size of NFS Server")
      * [ Upgrading K8s Version ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=upgrading-k8s-version "Upgrading K8s Version")
      * [ Add NFS Storage ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=add-nfs-storage "Add NFS Storage")
    * [ AutoScale ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=auto-scale "AutoScale")
    * [ Persistent Storage ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=persistent-storage "Persistent Storage")
    * [ Load Balancer Services ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=load-balancer-services "Load Balancer Services")
    * [ Advanced Firewall ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=advanced-firewall "Advanced Firewall")
    * [ Backup & Restore Cluster ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=backup-restore-cluster "Backup & Restore Cluster")
  * [ ![](/img/migrated/Group-c740146b.png) Notes when using FKE ](javascript: "Notes when using FKE")
    * [ Notes when using D-FKE ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=notes-when-using-dfke "Notes when using D-FKE")
  * [ ![](/img/migrated/question-488d89e6.png) FAQs ](javascript: "FAQs")
    * [ FAQs ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=faqs "FAQs")
...
Changing Cluster's Configuration
  * 
  * [ ](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ffptcloud.com%2Fen%2Fdocuments%2Fdedicated-fpt-kubernetes-engine-2%2F "Dedicated – FPT Kubernetes Engine")
  * [ ](https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ffptcloud.com%2Fen%2Fdocuments%2Fdedicated-fpt-kubernetes-engine-2%2F "Dedicated – FPT Kubernetes Engine")
  * [ ](https://twitter.com/share?text=&url=https%3A%2F%2Ffptcloud.com%2Fen%2Fdocuments%2Fdedicated-fpt-kubernetes-engine-2%2F "Dedicated – FPT Kubernetes Engine")

* * *
[ Previous Start a K8s Cluster ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=start-k8s-cluster "Start a K8s Cluster") [ Next Scale Worker Nodes ](https://fptcloud.com/en/documents/dedicated-fpt-kubernetes-engine-2/?doc=scale-worker-nodes "Scale Worker Nodes")
