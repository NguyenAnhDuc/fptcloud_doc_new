...
FPT Container 
  ...
  * [ ![](/img/migrated/settings-131ed42a.png) Initial Setup ](javascript: "Initial Setup")
    * [ Initial Setup ](https://fptcloud.com/en/documents/fpt-cloud-waf-2/?doc=Initial%20Setup "Initial Setup")
  * [ ![](/img/migrated/icon-networking-419c349e.png) Quick Starts ](javascript: "Quick Starts")
    * [ Create a new WAF server ](https://fptcloud.com/en/documents/fpt-cloud-waf-2/?doc=create-a-new-waf-server "Create a new WAF server")
    * [ Log in to WAF Dashboard ](https://fptcloud.com/en/documents/fpt-cloud-waf-2/?doc=log-in-to-waf-dashboard "Log in to WAF Dashboard")
    * [ Configure WAF server connection ](https://fptcloud.com/en/documents/fpt-cloud-waf-2/?doc=configure-waf-server-connection "Configure WAF server connection")
  * [ ![](/img/migrated/icon-networking-1-2d28802b.png) Tutorials ](javascript: "Tutorials")
    * [ Create a new WAF server ](https://fptcloud.com/en/documents/fpt-cloud-waf-2/?doc=tutorials-create-a-new-waf-server "Create a new WAF server")
    * [ Update information of the WAF server ](https://fptcloud.com/en/documents/fpt-cloud-waf-2/?doc=update-information-of-the-WAF-server "Update information of the WAF server")
    * [ Delete WAF server ](https://fptcloud.com/en/documents/fpt-cloud-waf-2/?doc=delete-waf-server "Delete WAF server")
    * [ Manage WAF server with WAF Dashboard ](https://fptcloud.com/en/documents/fpt-cloud-waf-2/?doc=manage-waf-server-with-waf-dashboard "Manage WAF server with WAF Dashboard")
      * [ Log in to WAF dashboard ](https://fptcloud.com/en/documents/fpt-cloud-waf-2/?doc=tutorials-log-in-to-waf-dashboard "Log in to WAF dashboard")
      * [ Monitor WAF server with Dashboard Overview ](https://fptcloud.com/en/documents/fpt-cloud-waf-2/?doc=monitor-waf-server-with-dashboard-overview "Monitor WAF server with Dashboard Overview")
      * [ Manage Proxy Host ](https://fptcloud.com/en/documents/fpt-cloud-waf-2/?doc=manage-proxy-host "Manage Proxy Host")
      * [ Manage Redirection Host ](https://fptcloud.com/en/documents/fpt-cloud-waf-2/?doc=manage-redirection-host "Manage Redirection Host")
      * [ Manage Stream Host ](https://fptcloud.com/en/documents/fpt-cloud-waf-2/?doc=manage-stream-host "Manage Stream Host")
      * [ Manage 404 Host ](https://fptcloud.com/en/documents/fpt-cloud-waf-2/?doc=manage-404-host "Manage 404 Host")
      * [ Manage Access List ](https://fptcloud.com/en/documents/fpt-cloud-waf-2/?doc=manage-access-list "Manage Access List")
      * [ Manage SSL Certificates ](https://fptcloud.com/en/documents/fpt-cloud-waf-2/?doc=manage-ssl-certificate "Manage SSL Certificates")
      * [ Manage Security Rule Sets ](https://fptcloud.com/en/documents/fpt-cloud-waf-2/?doc=manage-security-rule-set "Manage Security Rule Sets")
  * [ ![](/img/migrated/question-94737ec1.png) Frequently Asked Questions (FAQs) ](javascript: "Frequently Asked Questions \(FAQs\)")
  * [ ![](/img/migrated/suggestion-6f5abc73.png) Samples ](javascript: "Samples")
...
Manage WAF server with WAF Dashboard
  * 
  * [ ](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ffptcloud.com%2Fen%2Fdocuments%2Ffpt-cloud-waf-2%2F "FPT Cloud WAF")
  * [ ](https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ffptcloud.com%2Fen%2Fdocuments%2Ffpt-cloud-waf-2%2F "FPT Cloud WAF")
  * [ ](https://twitter.com/share?text=&url=https%3A%2F%2Ffptcloud.com%2Fen%2Fdocuments%2Ffpt-cloud-waf-2%2F "FPT Cloud WAF")

* * *
[ Previous Delete WAF server ](https://fptcloud.com/en/documents/fpt-cloud-waf-2/?doc=delete-waf-server "Delete WAF server") [ Next Log in to WAF dashboard ](https://fptcloud.com/en/documents/fpt-cloud-waf-2/?doc=tutorials-log-in-to-waf-dashboard "Log in to WAF dashboard")
