...
FPT Container 
  ...
  * [ ![](/img/migrated/icon-compute-87851b09.png) Elastic Compute ](javascript: "Elastic Compute")
    * [ Overview ](https://fptcloud.com/en/documents/fpt-cloud-portal-2/ "Overview")
    * [ Virtual Instance ](https://fptcloud.com/en/documents/fpt-cloud-portal-2/ "Virtual Instance")
    * [ High Capacity Storage ](https://fptcloud.com/en/documents/fpt-cloud-portal-2/ "High Capacity Storage")
    * [ Virtual Private Cloud ](https://fptcloud.com/en/documents/fpt-cloud-portal-2/ "Virtual Private Cloud")
    * [ Custom Image ](https://fptcloud.com/en/documents/fpt-cloud-portal-2/ "Custom Image")
  * [ ![](/img/migrated/icon-networking-0257e14b.png) Networking Service ](javascript: "Networking Service")
  * [ ![](/img/migrated/icon-activity-log-47b7c27a.png) Activity Log ](javascript: "Activity Log")
  * [ ![](/img/migrated/icon-database-service-e898bf33.png) Database Service ](javascript: "Database Service")
  * [ ![](/img/migrated/icon-kubenetes-e0566ae1.png) Kubenetes Engine ](javascript: "Kubenetes Engine")
  * [ ![](/img/migrated/icon-glossary-46e0a6e7.png) Glossary ](javascript: "Glossary")
