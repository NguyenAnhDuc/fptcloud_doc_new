...
**Step 1** : Sau khi chọn Team, nhấn **Add Asset**
...
_Note: Pop-up add asset chỉ hiện lên khi loại asset source (GitHub/GitLab/GitLab) được tích hợp tại màn**Integration**. Trường hợp ấn vào 1 souce chưa được tích hợp, màn hình sẽ chuyển sang tab **Integration** của loại source đó _.
**Step 3** : Chọn **project/repo** chứa source cần scan
...
**Step 4** : Chọn repo và bracnh bạn muốn và ấn **Add**
...
**Step 1** : Tại màn hình Asset Management > All , chọn 1 asset bất kỳ bằng cách click vào textlink Asset Name
[a0](https://fptcloud.com/wp-content/uploads/2025/05/a0.jpg)
**Step 2** : Tại màn hình Asset Overview, người dùng có thể xem các thông tin tổng quan:
...
**Step 3**. Bên cạnh đó, tại tab **History** , người dùng có thể theo dõi lịch sử scan của asset và thực hiện filter theo **Scan type** và **Khoảng thời gian** thực hiện scan.
...
_Note:_ _Danh sách mặc định được sắp xếp theo Score giảm dần và mỗi trang hiển thị tối đa 10 issue._
...
**Step 1** : Chọn Details tại một issue card bất kỳ (thuộc Code Analysis/Secret Scanning/IaC Scanning) để mở popup Issue Detail.
[![Alt text](/img/migrated/a7-1c9151c8.jpg)](/img/migrated/a7-1c9151c8.jpg)
**Step 2** : Tại màn hình Issue Detail, người dùng có thể xem thông tin chi tiết của issue:
...
**Step 1** : Tại màn hình All Assets, chọn asset hoặc scan type cần quét lại bằng cách ấn vào biểu tượng **⋮** ở góc phải của asset hoặc scan type
[![Alt text](/img/migrated/a10.1-b7dd8b2b.jpg)](/img/migrated/a10.1-b7dd8b2b.jpg)
**Step 2** : Chọn action "Rescan", hệ thống sẽ thực hiện scan lại asset hoặc scan type tương ứng và hiện thông báo _"Rescan requested successfully"_
...
**Step 1** : Tại màn hình Asset List, nhấp vào tên asset để vào chi tiết. 
**Step 2** : Chọn tab Issue → Chọn sub-tab tương ứng (Code Analysis, Secret Scanning, IaC Scanning).
[![Alt text](/img/migrated/a11-cbb7ee44.png)](/img/migrated/a11-cbb7ee44.png)
**Step 3** : Nhấn Rescan now ở góc trên bên phải màn hình. Nếu thành công, hệ thống hiển thị thông báo: "Rescan requested successfully".
...
### 5.1. Disable Asset
**Step 1** : Đi tới menu Workspace → Tab **All Assets** để xem danh sách asset.
**Step 2** : Chọn asset cần disable bằng cách nhấn biểu tượng menu **⋮** ở góc phải asset. Chọn Disable từ danh sách action.
[![Alt text](/img/migrated/a13-f93bcda0.jpg)](/img/migrated/a13-f93bcda0.jpg)
**Step 3** : Nhập chính xác từ khóa **disable** vào ô xác nhận rồi nhấn Confirm. Nếu nhập sai, hệ thống hiển thị thông báo lỗi: _"Type correct phrase to confirm your action."_
...
### 5.2. Enable Asset
**Step 1** : Chọn Asset cần Enable bằng cách nhấn biểu tượng menu **⋮** ở góc phải asset đang ở trạng thái **Disabled**. Chọn **Enable** từ danh sách action.
[![Alt text](/img/migrated/a15-c6184f8c.jpg)](/img/migrated/a15-c6184f8c.jpg)
**Step 2** : Nếu bạn có quyền, popup Enable Asset sẽ hiển thị. Nhấn Confirm để kích hoạt lại asset.
...
**Step 1** : Đi tới menu Workspace → Tab All Assets để xem danh sách asset.
**Step 2** : Chọn Asset cần xóa bằng cách nhấn biểu tượng menu (⋮) ở góc phải asset. Chọn **Delete** từ danh sách action. 
[![Alt text](/img/migrated/a17-62e36a0d.jpg)](/img/migrated/a17-62e36a0d.jpg)
_Note_ : Chỉ Org Admin có quyền xóa asset
**Step 3** : Nhập chính xác từ khóa delete vào ô xác nhận. Nhấn Confirm để tiến hành xóa asset.
