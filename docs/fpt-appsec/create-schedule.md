...
Vào menu **Schedule** , system điều hướng sang màn hình **Schedule Management**. Click **Create Schedule** : 
[![Alt text](/img/migrated/1-1-461969c3.png)](/img/migrated/1-1-461969c3.png)
Hệ thống displayed màn hình tạo schedule gồm the trường need to điền về General information and Scope configuration:
[![Alt text](/img/migrated/Screenshot-2025-11-14-141143-6b45dd3e.png)](/img/migrated/Screenshot-2025-11-14-141143-6b45dd3e.png)
**Step 2:** Enter the trường information chung
**1. Name (_bắt buộc_):** Enter tên for schedule to dễ nhận diện in list, tên không is trùng with schedule has been tồn tại. 
...
[![Alt text](/img/migrated/Picture5-2f370489.png)](/img/migrated/Picture5-2f370489.png)
  * **On-demand** : Chạy thủ công when user kích hoạt. Người dùng need to chọn ngày and giờ cụ thể (sau ngày hôm nay) and thời gian chạy mong muốn. Hệ thống will kích hoạt chạy schedule ando đúng thời gian user has been chọn (1 lần): 

[![Alt text](/img/migrated/Screenshot-2025-11-14-141242-1e0f1e55.png)](/img/migrated/Screenshot-2025-11-14-141242-1e0f1e55.png)
  * **Weekly** : Khi chọn đặt lịch chạy hàng tuần, user need to chọn ngày in tuần (Monday – Sunday) & giờ need to chạy.

[![Alt text](/img/migrated/Picture7-2f26c4c8.png)](/img/migrated/Picture7-2f26c4c8.png)
  * **Monthly** : Chạy định kỳ hàng tháng. Người dùng need to chọn ngày and giờ need to chạy in tháng in tháng (1 → 31) or chọn **Last** to lập lịch scan ando ngày cuối cùng of tháng: 

[![Alt text](/img/migrated/Picture8-1e00c9a0.png)](/img/migrated/Picture8-1e00c9a0.png)
**Step 3:** Enter the information về phạm vi (scope) chạy schedule 
...
**2. Configure Rule (Scope)**
  ...
  * **Source:** Xác định nguồn of repository (GitHub/GitLab/GitLab Server). Nếu user không chọn, system will mặc định quét tất cả repo from mọi nguồn

[![Alt text](/img/migrated/Screenshot-2025-11-14-141405-ac960aef.png)](/img/migrated/Screenshot-2025-11-14-141405-ac960aef.png)
  * **Last Scan:** Xác định khoảng thời gian repo chưa is quét gần đây. Nếu không chọn, system will mặc định quét toàn bộ repo hợp lệ, if chọn, system will chỉ quét repo chưa is quét in X ngày gần nhất (theo loại scan chọn ở phần Action)
...
Trong phần Action, user can chọn the loại scan: Code Analysis, Secret Scan, IaC Scan. Người dùng need to chọn ít nhất 1 loại scan. Nếu user không chỉnh sửa, mặc định cả 3 is chọn. 
[![Alt text](/img/migrated/Picture15-4a5f2bd8.png)](/img/migrated/Picture15-4a5f2bd8.png)
**Step 5:** Check lại tất cả trường bắt buộc has been điền. Click **Create** to save schedule. 
[![Alt text](/img/migrated/Picture13-d4757f19.png)](/img/migrated/Picture13-d4757f19.png)
Khi ấn tạo schedule successfully, system will chuyển về màn hình list schedule and displayed notification _“Created schedule successfully”_.
