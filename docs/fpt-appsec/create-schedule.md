...
**Step 2:** Nhập các trường thông tin chung
...
**Step 3:** Nhập thông tin về phạm vi (scope) chạy schedule 
...
**Step 5:** Kiểm tra lại tất cả trường bắt buộc đã điền. Nhấn **Create** để lưu schedule. 
