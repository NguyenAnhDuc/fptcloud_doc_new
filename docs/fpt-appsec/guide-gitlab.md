...
**Step 2** : Sau when setup permission truy cập ando Private/public repository, nhấn ando **Create a personal access token** , sau that you will is chuyển to GitLab Login to tạo token
[![anhfsec](/img/migrated/lab2-176588cd.png)](/img/migrated/lab2-176588cd.png)
**Step 3** : Fill in information như **Token name** and **Token Description** and tích ando **read_api**
