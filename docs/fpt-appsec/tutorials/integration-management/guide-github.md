...
In the detail screen you will find an access key to use in your CI/CD pipeline. See the [CI/CD integration guide](/docs/fpt-appsec/tutorials/integration-management/cicd-guideline/).
