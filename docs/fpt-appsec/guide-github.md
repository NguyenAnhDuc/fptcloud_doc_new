...
**Step 2** : Sau when setup permission truy cập ando **Private/public repository** , nhấn ando **Create a personal access token** , sau that you will is chuyển to GitHub to tạo token
...
## View detail
Chỉ **Org Admin** or **Team Manager** có permission xem details the loại tích hợp
...
Ở đây, you can thấy the information như **Personal Access Token** , **Repository Access** , **Integrated at** , and **Access Key** phục vụ for tích hợp CICD
...
## Reconfigure GitHub
**Step 1** : Click **Reconfigure** in màn hình details of tích hợp GitHub
...
**Step 1** : Click **Disable** in màn hình details of tích hợp GitHub
