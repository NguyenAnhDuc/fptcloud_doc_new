...
**Step 2** : Nhấn ando **Add VPC** to thêm VPC mới ando list tích hợp
[![anhfsec](/img/migrated/fcr2-1-53c9d4c2.png)](/img/migrated/fcr2-1-53c9d4c2.png)
**Step 3** : Chọn VPC need to tích hợp
[![anhfsec](/img/migrated/infcr3-ddd75d32.png)](/img/migrated/infcr3-ddd75d32.png)
**Step 4** : Sau when chọn VPC, if you has been có Robot Account, điền **Robot Account Name** , if you chưa có Robot Account, hãy xem phần guide [here](../fpt-container-registry/index.md).
...
**Step 6** : Sau when điền hết information, nhấn **Test Connection**. System will kiểm tra information the trường bắt buộc, if information hợp lệ, system notification **Connected successfully** and nút **Integrate** is enabled
[![anhfsec](/img/migrated/lala3-08073379.png)](/img/migrated/lala3-08073379.png)
Trường hợp the information không hợp lệ (sai Robot Account, secret), system notification "Connected failed".
**Step 7** : Sau when system notification test kết nốt successfully, nhấn **Integrate**
[![anhfsec](/img/migrated/infcr8-c753c69c.png)](/img/migrated/infcr8-c753c69c.png)
VPC is kết nối successfully will is thêm ando list **Integrated VPCs**
...
Sau when has been chọn org/team, nhấn ando **Configured FPT Container Registry** to xem details
[![anhfsec](/img/migrated/fcr1-2-c3f2a38c.png)](/img/migrated/fcr1-2-c3f2a38c.png)
...
**Step 1** : Để **reconfigure** FPT Container Registry VPC, ấn ando màn hình details of tích hợp FPT Container Registry. Select **Reconfigure** ở mục Action of 1 VPC
