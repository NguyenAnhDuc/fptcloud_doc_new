...
Tính năng Global Search trên FPT Cloud for phép user tìm kiếm nhanh the tài nguyên (resources) in system trên phạm vi of 1 Tenant, includes the loại tài nguyên như **Instances, IP Addresses, Subnets, Security Groups, Database**... Tính năng this giúp tiết kiệm thời gian and tăng hiệu quả quản lý tài nguyên trên nền tảng FPT Cloud.
**Bước 1.** Enter from khoá ando ô tìm kiếm ở phía trên cùng of interface FPT Cloud. 
[![](/img/migrated/gsdb-1024x535-32afb917.png)](/img/migrated/gsdb-1024x535-32afb917.png)
**Bước 2.** Chọn a in the tab Instances, IP Addresses, Subnets, Security Groups, Database to xem kết quả gom nhóm theo fromng loại tài nguyên.
  ...
  * Bấm ando fromng kết quả will đến interface information details of tài nguyên that. (Note: Nếu tài nguyên không có interface information details, system will dẫn đến màn hình list of loại tài nguyên that)

**Bước 3.** Nếu muốn xem toàn bộ kết quả, bấm **View all result**
**Bước 4.** Hệ thống will mở ra màn hình with toàn bộ kết quả tìm kiếm is 
...
**Bước 5.** Giới hạn lại kết quả tìm bằng bộ lọc VPC, Region or ô tìm kiếm "Search by resource name"
**Bước 6.** Bấm **Download** to tải xuống file list kết quả theo the kết quả mà system displayed trên màn hình
