...
User Groupは同じ役割を持つユーザーグループを表します。同じUser Group内の全IAM userに、そのUser GroupのRoles & Permissionが共通で割り当てられます。

- 権限管理の時間を節約できます。各IAM userに個別に権限を付与・更新する代わりに、User Groupに一度更新するだけで済みます。
