...
If the user **accesses via a URL that already contains a valid authentication code** (example of a URL with a valid code: pil783454741.pilotfcd.online):
...
If the user accesses from the default service URL:
