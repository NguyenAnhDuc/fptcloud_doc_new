...
**3. Mở and thao tác with ứng dụng FCDClient trên máy tính** Log in to Authenticator (Server) phù hợp
...
2.Enter the information account/password
...
[![file](/img/migrated/image-1767955938951-3aac0b75.png)](/img/migrated/image-1767955938951-3aac0b75.png)
  * Ứng dụng thực hiện đồng bộ and displayed OTP to thực hiện Log in to FCD. 
  * Enter mã OTP and select Submit => Log in Authenticator (Server) successfully
