...
title: "Truy cập qua FCDClient mới"
...
#### **Step 1: Cài đặt FCDClient mới**
  ...
  * Nếu đã cài đặt FCDClient mới từ trước đó, vui lòng bỏ qua bước này, chuyển sang [Step 2: Truy cập máy ảo qua FCDClient mới](https://fptcloud.com/documents/fpt-cloud-desktop/?doc=SSO-qua-FCDClient-moi#contentify_1 "Step 2: Truy cập máy ảo qua FCDClient mới")
...
#### **Step 2: Truy cập máy ảo qua FCDClient mới**
**3. Mở và thao tác với ứng dụng FCDClient trên máy tính** Đăng nhập vào Authenticator (Server) phù hợp
1.Người dùng mở ứng dụng FCDClient đã cài đặt xong tại [Step 1: Cài đặt FCDClient mới](https://fptcloud.com/documents/fpt-cloud-desktop/?doc=SSO-qua-FCDClient-moi#contentify_0 "Step 1: Cài đặt FCDClient mới")
