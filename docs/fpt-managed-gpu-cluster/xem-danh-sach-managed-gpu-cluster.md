...
**Step 1** : Ở menu chọn **Managed GPU Cluster** , hệ thống sẽ hiển thị trang **Managed GPU Management**. Chọn Cluster muốn xem thông tin chi tiết.
[![](/img/migrated/9-1-1670bae1.png)](/img/migrated/9-1-1670bae1.png)
**Step 2** : Tab **Essential Properties** sẽ hiển thị các thông tin của Cluster.
...
**Step 3** : Tab **Node Pools** sẽ hiển thị toàn bộ Worker Group thuộc cụm Cluster và thông tin cấu hình của từng Worker Group.
