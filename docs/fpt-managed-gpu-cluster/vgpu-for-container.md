...
**Hướng dẫn cài đặt**
**Step 1** : Cài đặt vGPU scheduler tại phần cài đặt GPU software & chờ cho đến khi trạng thái ready. [![](/img/migrated/Picture1.1-a0959517.png)](/img/migrated/Picture1.1-a0959517.png)
**Step 2** : Tại tab worker group GPU, bạn có quyền lựa chọn enable thành phần elastic GPU scheduler trên từng worker group hoặc không. [![](/img/migrated/vgpu01-681f58cd.png)](/img/migrated/vgpu01-681f58cd.png)
Note: 
...
**Step 3:** kiểm tra trạng thái vGPU scheduler trên các node chỉ định
