...
Managed GPU Cluster for phép user add thêm worker group ando cụm cluster theo nhu cầu sử dụng. Để add thêm worker customer can thao tác trên portal as follows: 
...
**Step 4** : Enter the trường information as required and nhấn **Save**.
...
**• Container Runtime** : Chọn container runtime, hiện tại, system mới chỉ hỗ trợ container runtime Containerd 
