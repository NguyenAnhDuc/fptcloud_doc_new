...
**Step 2** : Nhập thông tin tại tab General Information của cụm Cluster sau đó click button 
...
**Step 3** : Nhập thông tin tại tab Nodes Pool của cụm Cluster sau đó click button 
...
**Step 4** : Phần **Advanced** là các cài đặt nâng cao
...
Step 5: Màn hình Review & Create sẽ hiển thị các thông tin cụm Cluster người dùng đã cấu hình trước đó và hệ thống tự động kiểm tra quota Bare Metal GPU server có đủ để khởi tạo Cluster hay không 
