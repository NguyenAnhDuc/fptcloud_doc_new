...
**Step 2** : Nhập tên mong muốn đặt cho subnet 
[![](/img/migrated/2-1-e7e458f5.png)](/img/migrated/2-1-e7e458f5.png)
**Step 3:** Nhập tên cho Network ACL ứng với subnet
**Step 4** : Nhấn [Create Subnet] để hoàn tất quá trình tạo subnet cho Bare Metal GPU 
...
**Step 2** : Chọn **Create Subnet** ở trang **Subnets Management**
