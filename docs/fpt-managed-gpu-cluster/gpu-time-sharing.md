...
**2.Hướng dẫn cài đặt**
**Step 1** : Cài đặt GPU operator tại phần cài đặt GPU software & chờ cho đến khi trạng thái GPU operator ở trạng thái ready. [![](/img/migrated/Picture1.3-7829b757.png)](/img/migrated/Picture1.3-7829b757.png)
...
**Step 4:** deploy workload mẫu trên kubernetes sử dụng tính năng timeslicing
