...
**Step 1** : Ở menu chọn **AI Infrastructure** > **Managed GPU Cluster** , hệ thống sẽ hiển thị trang Managed GPU Cluster Management. Chọn Cluster muốn thay đổi cấu hình Worker Group.
...
**Step 3** : Chọn Worker Group muốn thay đổi và click button **Save**.
