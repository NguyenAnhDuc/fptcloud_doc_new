...
FPT Container 
  ...
  * [ ![](/img/migrated/cropped-FPT-Cloud-1@2x-8-69f71686.png) Quick Guide  ](javascript: "Quick Guide ")
    * [ Site to Site VPN Initialization ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=create-vpn "Site to Site VPN Initialization ")
    * [ View VPN Info ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=view-vpn- "View VPN Info ")
  * [ ![](/img/migrated/Favicon@2x-8-1561f749.png) Detailed Instructions ](javascript: "Detailed Instructions")
    * [ Disable VPN-Site-to-Site ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=disable-VPN-Site-to-Site "Disable VPN-Site-to-Site")
    * [ Enable VPN-Site-to-Site ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=enable-vpn-s2S "Enable VPN-Site-to-Site")
    * [ Edit VPN Information ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=edit-vpn "Edit VPN Information")
    * [ Edit Security Profile ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=edit-security-profile "Edit Security Profile")
    * [ Download Config VPN Site-to-Site ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=download-config- "Download Config VPN Site-to-Site")
    * [ Delete VPN Site-to-Site ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=delete-vpn "Delete VPN Site-to-Site")
    * [ VPN-Activity ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=VPN-Activity "VPN-Activity")
  * [ ![](/img/migrated/images-7a6e2cc1.webp) FAQs ](javascript: "FAQs")
    * [ Authenticate-Certificate mode ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=Authenticate-Certificate%20mode-1 "Authenticate-Certificate mode")
  * [ ![](/img/migrated/icon-1-32fd67e6.jpg) VPN Site-to-Site (new version) ](javascript: "VPN Site-to-Site \(new version\)")
    * [ Common VPN Device Configuration ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=common-vpn-device-configuration "Common VPN Device Configuration")
      * [ VPN Site-to-Site Configuration with Palo Alto ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=VPN-Site-to-Site-Configuration-with-Palo-Alto-guide "VPN Site-to-Site Configuration with Palo Alto")
      * [ VPN Site-to-Site Configuration with Fortigate ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=VPN-Site-to-Site-Configuration-with-Fortigate-guide "VPN Site-to-Site Configuration with Fortigate")
      * [ VPN Site-to-Site Configuration between FCI and AWS (Virtual private gateways) ](../vpn-site-to-site/index.md)-guide "VPN Site-to-Site Configuration between FCI and AWS \(Virtual private gateways\)")
      * [ VPN Site-to-Site Configuration between FCI and AWS (Transit-Gateway) ](../vpn-site-to-site/index.md)-guide "VPN Site-to-Site Configuration between FCI and AWS \(Transit-Gateway\)")
      * [ VPN Site-to-Site Configuration between Openstack portal and VMW ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=openstack-portal-to-VMW "VPN Site-to-Site Configuration between Openstack portal and VMW")
    * [ VPN Connection Management ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=vpn-connection-management "VPN Connection Management")
      * [ Create a VPN Connection ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=create-a-vpn-connection "Create a VPN Connection")
      * [ Edit VPN Connection ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=edit-vpn-connection "Edit VPN Connection")
      * [ Enable/Disable VPN Connection ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=enable-disable-vpn-connection "Enable/Disable VPN Connection")
      * [ Delete VPN Connection ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=delete-vpn-connection "Delete VPN Connection")
      * [ Create Customer gateway ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=create-customer-gateway "Create Customer gateway")
      * [ Edit Customer gateway ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=edit-customer-gateway "Edit Customer gateway")
      * [ Delete Customer gateway ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=delete-customer-gateway "Delete Customer gateway")
      * [ Service Authorization Management ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=permission-access-guide "Service Authorization Management")
      * [ Setting up alerts via the Cloud Guard service ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=setting-up-alerts-via-the-cloud-guard-service-guide "Setting up alerts via the Cloud Guard service")
      * [ Service monitoring via the Monitoring feature ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=monitoring-service-through-monitoring-feature-guide "Service monitoring via the Monitoring feature")
      * [ Monitoring service through Logging feature ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=monitoring-service-through-logging-feature-guide "Monitoring service through Logging feature")
    * [ FAQs ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=frequently-asked-question "FAQs")
...
Common VPN Device Configuration
  * 
  * [ ](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ffptcloud.com%2Fen%2Fdocuments%2Fvpn-site-to-site%2F "VPN Site-to-Site")
  * [ ](https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ffptcloud.com%2Fen%2Fdocuments%2Fvpn-site-to-site%2F "VPN Site-to-Site")
  * [ ](https://twitter.com/share?text=&url=https%3A%2F%2Ffptcloud.com%2Fen%2Fdocuments%2Fvpn-site-to-site%2F "VPN Site-to-Site")

* * *
[ Next VPN Site-to-Site Configuration with Palo Alto ](https://fptcloud.com/en/documents/vpn-site-to-site/?doc=VPN-Site-to-Site-Configuration-with-Palo-Alto-guide "VPN Site-to-Site Configuration with Palo Alto")
