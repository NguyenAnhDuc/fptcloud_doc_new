...
**Step 2:** Trên Menu chọn **NAT** > tích **Add automatic address translation rules** > tích **Hide behind IP address** > điền IP muốn SNAT > chọn gateway để apply
...
**Step 3:** Trên Menu chọn **Security Policies** (**Ctrl + 2**) > chọn **Access Control** > chọn **NAT** > Kiểm tra rule đã được tạo.
...
**Step 2:** Chọn **Add rule above/ to top/ to bottom** để thêm rule vào vị trí phù hợp.
...
**Step 4:** Tạo Firewall rule cho phép kết nối DNAT đã tạo.
