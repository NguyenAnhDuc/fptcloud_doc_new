...
**Step 1:** Trên **Menu** chọn **Gateway and Servers**(**Ctrl + 1**) > chọn **Gateway** > chọn **Edit.**
...
**Step 2:** Trên **Menu** chọn **General Properties** > Tích chọn the Blade muốn bật > chọn **OK.**
...
**Step 1:** Các Blade thuộc **Network Security** (Mobile Access, Application Control, URL Filtering, Monitoring,…)
...
**Step 4:** Tích chọn the Blade has been bật ở **Step 1** > chọn **OK.**
...
**Step 5:** Create **Rule/ Access** sử dụng the Blades mới:
...
**Step 1:** Các Blade thuộc Threat Prevention (IPS, Anti-Bot, Anti-Virus, Threat Emulation, Threat Extraction)
...
**Step 2:** Trên Menu chọn **Security Policies** (Ctrl + 2) > chọn **Threat Prevention** > chọn **Policy**.  
Có thể sử dụng cấu hình mặc định or sửa theo nhu cầu.
...
**Step 2:** Bỏ tích the Blade không sử dụng.
