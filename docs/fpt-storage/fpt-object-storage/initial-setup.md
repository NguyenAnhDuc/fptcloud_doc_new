...
To get started with FPT Object Storage, users need to complete the following tasks:
  1. [Create an FPT Cloud account and log in.](/docs/fpt-storage/fpt-object-storage/)/
  2. [Request Object Storage service quota.](/docs/fpt-storage/fpt-object-storage/)/
