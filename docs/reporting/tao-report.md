...
**Step 2** : Chọn thông tin phần **Select Dashboard**
  ...
  * Select **Time Range** (optional): Phạm vi thời gian mà report sẽ lấy dữ liệu. 
...
**Note: Nếu không chọn thiết lập nâng cao, hệ thống sẽ tự động gửi báo cáo hàng ngày (daily) theo lịch trình đã thiết lập.**
...
**Step 8** : Select **Create** để tạo báo cáo
