...
Để tạo report, you thực hiện theo guide sau: 
**Step 1:** Click **Home** > **Apps** > **Reporting** > **Create a new report**
**Step 2:** Chọn information phần **Select Dashboard**
...
**Step 4:** Cung cấp information phần **Format report**
...
**Note: Nếu không chọn setup nâng cao, system will tự động gửi report hàng ngày (daily) theo lịch trình has been setup.**
Tính năng đặt lịch report for phép user setup lịch trình, tự động tạo and gửi report định kỳ. Thay vì must tạo and gửi report thủ công mỗi lần need to thiết, feature đặt lịch report giúp tiết kiệm thời gian and năng lực user. 
Hệ thống for phép user tuỳ chỉnh thời gian and tần suất of report theo giờ, ngày, tuần, tháng. Sau when setup lịch, phần mềm tự động tạo and gửi report theo lịch trình has been cài đặt giúp user duy trì theo dõi tiến độ công việc and information quan trọng a theh tự động and định kỳ. 
Để thực hiện chức năng nâng cao, user click ando nút **Advanced** and điền the trường information: 
  ...
  * **Checkbox Send right after create report** : Giá trị mặc định là unchecked. Nếu checked thì system tự động gửi 1 report ngay when tạo xong (không theo lịch trình has been set up).
...
2, Enter **End date**
3, **Repeating Cycle**
Nếu tick chọn **Send from Monday to Friday** : Báo cáo will is gửi hàng ngày from thứ 2 đến thứ 6 
...
Trong trường hợp this report will is gửi **chỉ 1 lần duy nhất** theo thời gian has been setup. Sau when gửi mail status lịch trình chuyển thành **Expired**
**Step 7:** Click nút 
Hiển thị màn hình **Confirm** includes the information phần Select Dashboard, Format Report, Schedule for user kiểm tra lại.
[![Alt text](/img/migrated/Picture9-58d335a3.png)](/img/migrated/Picture9-58d335a3.png)
**Step 8:** Select **Create** to create report
