...
![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-001.png)

**Step 2**: Click **Create snapshot** to display the **Create instance snapshot** modal.

![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-002.png)
...
![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-003.png)
...
![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-004.png)

**Step 2**: The **Create instance** modal from snapshot will appear.

![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-005.png)
...
![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-006.png)
...
![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-007.png)
...
![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-008.png)
...
![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-009.png)

**Step 2**: Click **Create volume snapshot** to create.

![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-010.png)

**Step 3**: The snapshot is created successfully and displayed on the **Snapshots** screen under the **Storage snapshot** section.

![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-011.png)
...
![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-012.png)

**Step 2**: Click **Create storage disk** to create.

![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-013.png)
...
![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-014.png)

**Step 2**: Click **Delete snapshot** to proceed with deletion.

![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-015.png)
...
![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-016.png)

**Step 2**: Click **Create** in the confirmation popup to proceed with the snapshot creation.

![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-017.png)
...
![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-018.png)

**Step 2**: Click **Restore instance** in the confirmation popup to proceed with the restoration.

![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-019.png)
...
![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-020.png)

**Step 2:** Click **Delete snapshot**.

![file](/img/migrated/docs-cloud-server/tutorials-backup-may-chu-voi-snapshot/img-021.png)
