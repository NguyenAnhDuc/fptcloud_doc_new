...
![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-001.png)
...
![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-002.png)
...
![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-003.png)

## View Subnet Details
![](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-004.png)
...
![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-005.png)

**Step 2**: The **Rename subnet** modal appears. Enter the new name and click **Rename subnet** to save the change.

![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-006.png)
...
![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-007.png)

**Step 2**: A dialog box appears. Confirm and click **Change to routed** to apply the change.

![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-008.png)
...
![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-009.png)
...
![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-010.png)

**Step 2**: Enter the new DNS server information and click **Edit DNS** to update.

![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-011.png)

## Manage Tags for a Subnet
**Step 1**: In the menu, select **Subnets**. For the subnet to tag, select **Actions** > **Manage tags**.

![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-012.png)

**Step 2**: Select a tag from the list and click **Save** to update.

![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-013.png)
...
![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-014.png)

**Step 2**: Click on the details of a subnet. Click **Create private IP**.

![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-015.png)
...
![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-016.png)
...
![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-017.png)
...
![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-018.png)
...
![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-019.png)
...
![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-020.png)
...
![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-021.png)
...
![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-022.png)

**Step 2**: Click **Delete**. A warning dialog box appears to confirm the action. Confirm by clicking **Yes, delete it**.

![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-023.png)
...
![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-024.png)

__

_Figure: 172.26.166.145 is currently attached to an allow address pair_

![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-025.png)
...
![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-026.png)

**Step 2**: The system will display a confirmation popup. To confirm deletion, select **Delete network**.

![file](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-027.png)
...
![](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-028.png)
...
![](/img/migrated/docs-cloud-server/Qu%E1%BA%A3n%20l%C3%BD%20Subnets/img-029.png)
