...
![Userguide FPT Cloud Server 2022 62](/img/migrated/docs-cloud-server/cau-hinh-o-dia-cho-may-ao-chay-windows/img-001.png)
...
![Userguide FPT Cloud Server 2022 63](/img/migrated/docs-cloud-server/cau-hinh-o-dia-cho-may-ao-chay-windows/img-002.png)

**Step 4:** Select **Online** from the **Disk** menu by right-clicking the disk icon.

![Userguide FPT Cloud Server 2022 64](/img/migrated/docs-cloud-server/cau-hinh-o-dia-cho-may-ao-chay-windows/img-003.png)

**Step 5:** The disk will switch to **Online** and **Not Initialized** status. Right-click the disk icon and select **Initialize Disk**.

![Userguide FPT Cloud Server 2022 65](/img/migrated/docs-cloud-server/cau-hinh-o-dia-cho-may-ao-chay-windows/img-004.png)

**Step 6**: Select the appropriate **Partition style** and click **OK**.

![Userguide FPT Cloud Server 2022 66](/img/migrated/docs-cloud-server/cau-hinh-o-dia-cho-may-ao-chay-windows/img-005.png)

**Step 7:** Right-click on the unallocated space of the disk and select **New Simple Volume**.

![Userguide FPT Cloud Server 2022 67](/img/migrated/docs-cloud-server/cau-hinh-o-dia-cho-may-ao-chay-windows/img-006.png)

**Step 8:** Click **Next** in the **New Simple Volume Wizard** that appears.

![Userguide FPT Cloud Server 2022 68](/img/migrated/docs-cloud-server/cau-hinh-o-dia-cho-may-ao-chay-windows/img-007.png)

**Step 9:** Enter the desired disk size in the **Simple volume size in MB** field and click **Next**.

![Userguide FPT Cloud Server 2022 69](/img/migrated/docs-cloud-server/cau-hinh-o-dia-cho-may-ao-chay-windows/img-008.png)

**Step 10:** Select a drive letter in the **Assign the following drive letter** section and click **Next**.

![Userguide FPT Cloud Server 2022 70](/img/migrated/docs-cloud-server/cau-hinh-o-dia-cho-may-ao-chay-windows/img-009.png)
...
![Userguide FPT Cloud Server 2022 71](/img/migrated/docs-cloud-server/cau-hinh-o-dia-cho-may-ao-chay-windows/img-010.png)

**Step 12:** Click **Finish** to complete.

![Userguide FPT Cloud Server 2022 72](/img/migrated/docs-cloud-server/cau-hinh-o-dia-cho-may-ao-chay-windows/img-011.png)

The new disk has been successfully configured for the Windows virtual machine from the attached storage.

![Userguide FPT Cloud Server 2022 73](/img/migrated/docs-cloud-server/cau-hinh-o-dia-cho-may-ao-chay-windows/img-012.png)
