...
**Step 1:** Trên server linux gõ lệnh veeam để khởi mở giao diện quản trị backup.
...
**Step 3:** Cấu hình lại network nếu cần
...
**Step 4:** Nhấn phím I để mount phân vùng chưa dữ liệu cần restore vào server. Dữ liệu sẽ được mount vào đường dẫn /mnt/backup
...
**Step 6:** Sau khi đã toàn thành việc restore file hoặc folder
