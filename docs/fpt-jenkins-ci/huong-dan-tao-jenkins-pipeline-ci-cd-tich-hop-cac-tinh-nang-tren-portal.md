...
description: "Hướng dẫn tạo Jenkins pipline CI/CD tích hợp các tính năng trên Portal on FPT Jenkins CI."
...
Hướng dẫn tạo Jenkins pipline CI/CD tích hợp các tính năng trên Portal on FPT Jenkins CI.
