...
Hiện tại, trên FPT Cloud Portal chỉ for phép user tạo Jenkins Agent loại Cloud. Để can thêm mới a Agent do customer quản lý,can thực hiện as follows:
...
**Đối with Linux:** VM trên FPT Cloud is support ubuntu, in guide user cài java trên ubuntu. Tuỳ nhu cầu sử dụng of user can cài the version java khác nhau. Ví dụ user muốn cài java 11, thực hiện cài đặt as follows:
**sudo apt update**
...
**Step 3.** Thực hiện tạo mới a Node as follows: [![](/img/migrated/Picture120-0c00ad8a.png)](/img/migrated/Picture120-0c00ad8a.png) [![](/img/migrated/Picture121-8e302013.png)](/img/migrated/Picture121-8e302013.png) Tiếp tục cấu hình the information: [![](/img/migrated/Picture122-83cc3c7d.png)](/img/migrated/Picture122-83cc3c7d.png)
**Step 4.** Sau when tạo nodes lấy information to kết nối tới nodes as follows [![](/img/migrated/Picture123-fbb1d582.png)](/img/migrated/Picture123-fbb1d582.png) Information to connect agent: [![](/img/migrated/Picture124-91fc45b1.png)](/img/migrated/Picture124-91fc45b1.png)
**Step 5.** Chỉnh sửa commad to connect Agent as follows:
FPT Cloud sử dụng websocket to connect Agent Jenkins. Vì vậy, to can connect tới Agent Jenkins need to thêm options **“-webSocket”** to can kết nối to Agent:
